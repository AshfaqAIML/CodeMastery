...
// ============================================================
// JavaScript - imported by scripts/import-course/pipeline.py
...
const subject = {
  ...
  name: "JavaScript",
  tagline: "JavaScript in depth — fundamentals to advanced patterns, with exercises and MCQs.",
  ...
  modules: [
    {
      ...
      summary: "Chapters 1 to 12 of JavaScript.",
      order: 1,
      ...
      tutorials: [
    {
      ...
      summary: "Before learning JavaScript, you must first understand what programming actually is. Many beginners think programming means writing strange symbols on a screen. Others believe programmers are people who memorize thousands of commands. Neither is true.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 0,
      ...
      selfAssessment: ["What is hardware? (Answer: B)", "What is software? (Answer: B)", "What does JavaScript control? (Answer: C)", "What is an algorithm? (Answer: B)"],
...
### Computer│├── Monitor├── Keyboard├── Mouse├── CPU├── RAM└── Storage
...
### Take first numberTake second numberAdd numbersDisplay result

### Music App:

### Open songRead audio dataSend audio to speakersPlay sound
...
### Programmer ↓Writes Code ↓Program ↓Computer Executes ↓Output
...
### User ↓Browser ↓Server ↓Files Returned ↓Browser Displays Website
...
### PaintFurnitureDecoration

### JavaScript:

### ElectricitySwitchesAutomatic DoorsSecurity System
...
### Boil waterAdd teaAdd sugarMixServe
...
### Compare 5 and 8Keep larger valueCompare result with 2Keep larger value
...
### Understand Problem ↓Plan Solution ↓Write Code ↓Test Results
...
This foundation will help you understand every topic that follows.
...
\`\`\`js
console.log("Kamraan");console.log("Srinagar");console.log("Welcome to JavaScript");
\`\`\`
...
## PART 1 — Programming Foundations`,
    },
    {
      ...
      summary: "In the previous chapter, you learned what programming is and how computers execute instructions. Now it is time to learn about the programming language that powers most of the modern web: JavaScript. Every time you: Click a button on a website Open a dropdown…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 1,
      ...
      prerequisites: [],
      whereItFits: "Imagine learning how to drive a car.",
      ...
      selfAssessment: ["Who created JavaScript? (Answer: B)", "JavaScript was created in: (Answer: C)", "What defines JavaScript standards? (Answer: C)", "Which technology controls website behavior? (Answer: C)", "JavaScript can run on: (Answer: D)"],
...
### AppearanceColorsDesign

JavaScript is the brain and nervous system.

### MovementActionsDecisionsBehavior
...
### ECMAScript ↓Defines Rules ↓JavaScript Engines ↓Follow Rules
...
JavaScript │ ┌───────────────────┼───────────────────┐ │ │ │Browser Server Mobile │ │ │Websites APIs Apps │Desktop Apps │Games
...
### HTML │Structure │ ▼CSS │Appearance │ ▼JavaScript │Behavior │ ▼Complete Website
...
\`\`\`js
JavaScript Engine ↓Read Statement ↓Execute console.log() ↓Display Message ↓Done
\`\`\`
...
### Code ↓JavaScript Engine ↓Execution ↓Console Output
...
Detect Click ↓Find Product ↓Update Cart ↓Update Total Price ↓Display New Cart Count
...
**What defines JavaScript standards?**
...
**Which technology controls website behavior?**
...
\`\`\`js
console.log("Kamraan");console.log("Data Analyst");console.log("I am learning JavaScript");
\`\`\`
...
### ⏳ Next: Chapter 3 — Setting Up the Development Environment
...
## PART 1 — Programming Foundations`,
    },
    {
      ...
      summary: "Before we start writing real JavaScript programs, we need to prepare our development environment. A development environment is the collection of tools programmers use to write, run, test, and debug code. Think of a carpenter. Before building furniture, the…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 2,
      ...
      prerequisites: [],
      whereItFits: "Imagine learning to drive.",
      ...
      selfAssessment: ["Which browser tool runs JavaScript commands immediately? (Answer: B)", "What is VS Code? (Answer: C)", "Which extension automatically formats code? (Answer: B)", "JavaScript files usually use which extension? (Answer: C)"],
...
### Computer↓Browser↓Code Editor↓Programming Language↓Development Tools
...
### Kitchen↓Stove↓Utensils↓Ingredients↓Recipes

### Similarly, developers need:

### Computer↓Browser↓Editor↓JavaScript↓Projects
...
### Website FilesHTMLCSSJavaScript ↓Browser ↓Rendered Website
...
### JavaScript Code ↓Browser ↓JavaScript Engine ↓Execution ↓Output
...
### Website↓Elements Tab↓HTML Structure↓CSS Styles
...
\`\`\`js
JavaScript Engine↓Read Statement↓Call console.log()↓Display Output↓Continue Execution
\`\`\`
...
### Activity BarExplorerEditorTerminalStatus Bar

### Visual Diagram:

+--------------------------+| Activity Bar |+--------------------------+| Explorer | Editor || | |+--------------------------+| Terminal |+--------------------------+| Status Bar |+--------------------------+
...
### Developer↓Terminal↓Command Execution
...
### MyFirstProject│├── index.html└── script.js
...
<!DOCTYPE html><html><head> <title>My First Project</title></head><body><h1>Hello JavaScript</h1><script src="script.js"></script></body></html>
...
Browser Opens HTML↓HTML Loads↓script.js Loads↓JavaScript Executes↓Message Appears in Console
...
### PracticeProject│├── index.html└── script.js
...
VS Code ↓Write CodeChrome ↓Test WebsiteDevTools ↓Debug ProblemsExtensions ↓Increase Productivity
...
You now have a professional JavaScript development environment ready.
...
**Which browser tool runs JavaScript commands immediately?**
...
**Which extension automatically formats code?**
...
**JavaScript files usually use which extension?**
...
\`\`\`js
console.log("Hello World");console.log("Kamraan");console.log("Srinagar");
\`\`\`

## PART 2 — JavaScript Fundamentals`,
    },
    {
      slug: "chapter-4-variables",
      title: "Variables",
      summary: "Imagine you have a notebook. Whenever someone tells you an important phone number, you write it down so you can use it later. A computer works in a similar way. Sometimes a program needs to remember: A user's name A user's age A product price A score in a…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 3,
      ...
      prerequisites: [],
      whereItFits: "Imagine trying to build an online shopping website without remembering:",
      ...
      selfAssessment: ["Which keyword creates a constant? (Answer: C)", "Which keyword is preferred for changing values? (Answer: A)", "Which is a valid variable name? (Answer: C)", "What naming convention is commonly used in JavaScript? (Answer: B)", "Variables are used to: (Answer: B)"],
      content: `# Variables
...
### name → Kamraanage → 24city → Srinagar
...
### No memoryNo stored informationNo dynamic behavior
...
\`\`\`js
let age = 24;age = 25;console.log(age);
\`\`\`
...
\`\`\`js
const country = "India";country = "Pakistan";
\`\`\`
...
### Birth DateCountry CodePI ValueTax Rate (Sometimes)
...
\`\`\`js
let firstName;let user_1;let $price;
\`\`\`
...
\`\`\`js
let firstName;let userAge;let totalPrice;
\`\`\`
...
\`\`\`js
let firstName;let age;let city;let totalPrice;let accountBalance;
\`\`\`
...
\`\`\`js
let name = "Kamraan";let age = 24;let city = "Srinagar";
\`\`\`

## Output Example

\`\`\`js
let name = "Kamraan";let age = 24;console.log(name);console.log(age);
\`\`\`
...
\`\`\`js
let studentName = "Ali";let studentAge = 20;let course = "JavaScript";console.log(studentName);console.log(studentAge);console.log(course);
\`\`\`
...
Creation Phase↓Memory Allocated↓Variable Created↓Value Stored↓Execution Continues
...
### NameAgeCountryFavorite Language
...
**Which keyword is preferred for changing values?**
...
\`\`\``,
    ...
    {
      slug: "chapter-5-data-types",
      title: "Data Types",
      summary: "Imagine you have several containers. One container stores water. Another stores sugar. Another stores rice. Although all of them are containers, the type of content inside them is different. Similarly, variables store data, but not all data is the same.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 4,
      ...
      prerequisites: [],
      whereItFits: "Imagine a bank application.",
      ...
      selfAssessment: ["Which data type stores text? (Answer: C)", "Which value represents \"intentionally empty\"? (Answer: B)", "What does typeof 10 return? (Answer: C)", "Which Boolean values exist? (Answer: C)", "What is type coercion? (Answer: B)"],
      content: `# Data Types
...
\`\`\`js
let name = "Kamraan";let age = 24;let isStudent = true;
\`\`\`
...
Customer NameAccount BalanceAccount StatusAccount Number
...
\`\`\`js
let customerName = "Ali";let balance = 25000;let isActive = true;
\`\`\`
...
### Variable → ageData Type → NumberValue → 24
...
\`\`\`js
let name = "Kamraan";let city = "Srinagar";let course = "JavaScript";
\`\`\`
...
\`\`\`js
let age = 24;let marks = 95;let price = 999.99;
\`\`\`
...
\`\`\`js
let marks = 95;console.log(marks);
\`\`\`
...
### User Logged In?Payment Successful?Email Verified?Form Submitted?
...
\`\`\`js
let isStudent = true;console.log(isStudent);
\`\`\`
...
### Variable existsBut no value assigned
...
### ObjectsArraysFunctions

We will study these in later chapters.

### For now remember:

### Primitive → Stores ValueReference → Stores Reference

## Visual Diagram

### Primitiveage → 24Referenceuser → Memory Address
...
\`\`\`js
let name = "Kamraan";console.log(typeof name);
\`\`\`
...
\`\`\`js
let age = 24;console.log(typeof age);
\`\`\`
...
\`\`\`js
let age = "25";console.log(Number(age));
\`\`\`
...
\`\`\`js
let age = 25;console.log(String(age));
\`\`\`
...
### Variable Created↓Memory Allocated↓Number Stored↓Type Recorded
...
\`\`\`js
let studentName = "Ali";let age = 20;let isEnrolled = true;console.log(studentName);console.log(age);console.log(isEnrolled);
\`\`\`
...
### undefined → no value assignednull → intentionally empty
...
\`\`\`js
let fullName = "Ali Khan";let age = 22;let isVerified = true;
\`\`\`
...
\`\`\`js
let age = Number("20");console.log(age + 5);
\`\`\`
...
**Which value represents "intentionally empty"?**
...
\`\`\`js
console.log(typeof name);console.log(typeof marks);console.log(typeof isPassed);
\`\`\``,
    },
    {
      slug: "chapter-6-operators",
      title: "Operators",
      summary: "Imagine you have two numbers: and 5 You want to: Add them Subtract them Compare them Check conditions Assign values How can JavaScript perform these tasks? The answer is Operators. Operators are special symbols that perform operations on values and variables.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 5,
      ...
      selfAssessment: ["Which operator performs exponentiation? (Answer: C)", "What does === compare? (Answer: C)", "What does && represent? (Answer: B)", "What does % return? (Answer: C)", "Which operator is a shortcut for if-else? (Answer: D)"],
      content: `# Operators
...
+ 520 - 10age >= 18isLoggedIn && isVerified
...
### Operand↓Operator↓Operation↓Result
...
\`\`\`js
let result = 5 * 4;console.log(result);
\`\`\`
...
\`\`\`js
let result = 20 / 4;console.log(result);
\`\`\`
...
\`\`\`js
let price = 1000;let quantity = 3;let total = price * quantity;console.log(total);
\`\`\`
...
\`\`\`js
let balance = 100;balance -= 20;console.log(balance);
\`\`\`
...
\`\`\`js
let value = 5;value *= 3;console.log(value);
\`\`\`
...
\`\`\`js
let value = 20;value /= 4;console.log(value);
\`\`\`
...
\`\`\`js
let isLoggedIn = true;let isVerified = true;console.log(isLoggedIn && isVerified);
\`\`\`
...
\`\`\`js
let usernameCorrect = true;let passwordCorrect = true;console.log(usernameCorrect && passwordCorrect);
\`\`\`
...
### Condition↓True ? Adult↓False ? Minor
...
### Read Operands↓Apply Operator↓Calculate Result↓Store Value↓Continue Execution
...
\`\`\`js
let math = 80;let science = 90;let total = math + science;console.log(total);
\`\`\`
...
### && → Both True|| → At Least One True! → Reverse Value
...
\`\`\`js
let price = 500;let quantity = 3;let total = price * quantity;let discount = total > 1000;console.log(total);console.log(discount);
\`\`\`
...
**Which operator is a shortcut for if-else?**
...
\`\`\``,
    ...
    {
      slug: "chapter-7-user-input-and-output",
      title: "User Input and Output",
      summary: "So far, our programs have worked with fixed values. Example: This program always displays the same message. But real-world applications are different. A calculator asks users for numbers. A login form asks for a username and password. An ATM asks for a PIN.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 6,
      tags: "input,output,console-log,alert,prompt,confirm,user-interaction,type-conversion,string,number",
      learningObjectives: ["Understand user input and output", "Display output using console.log()", "Display messages using alert()", "Receive input using prompt()", "Receive confirmation using confirm()", "Build interactive JavaScript programs", "Convert user input into useful data", "Avoid common beginner mistakes"],
      prerequisites: [],
      whereItFits: "Imagine a website that never accepts user input.",
      keyTakeaways: ["Input is information provided by users.", "Output is information displayed by programs.", "console.log() displays output in the console.", "alert() displays popup messages.", "prompt() collects user input.", "confirm() collects yes/no decisions.", "prompt() returns Strings.", "Number() converts Strings into Numbers.", "Input and output form the basis of user interaction."],
      selfAssessment: ["Which function displays output in the console? (Answer: C)", "Which function collects user input? (Answer: A)", "What does confirm() return? (Answer: D)", "prompt() usually returns: (Answer: B)", "Which function displays a popup message? (Answer: C)"],
      content: `# User Input and Output
...
Instagram → User InputAmazon → User InputYouTube → User InputGoogle Search → User Input
...
### User↓Input↓Program↓Processing↓Output↓User
...
### MessagesResultsErrorsNotifications
...
\`\`\`js
console.log("JavaScript");console.log("HTML");console.log("CSS");
\`\`\`
...
### Payment SuccessfulWrong PasswordRegistration Complete
...
+-------------------------+| Enter your name || || [______________] || || OK Cancel |+-------------------------+
...
\`\`\`js
User↓Enter Name↓prompt()↓Variable↓console.log()↓Output
\`\`\`

## Practical Example

\`\`\`js
let city = prompt("Enter your city");console.log(city);
\`\`\`
...
\`\`\`js
let age = prompt("Enter age");console.log(typeof age);
\`\`\`
...
\`\`\`js
let age = Number(prompt("Enter age"));console.log(typeof age);
\`\`\`
...
\`\`\`js
let num1 = Number(prompt("Enter first number"));let num2 = Number(prompt("Enter second number"));let result = num1 + num2;console.log(result);
\`\`\`
...
\`\`\`js
let num1 = prompt("Enter first number");let num2 = prompt("Enter second number");console.log(num1 + num2);
\`\`\`
...
\`\`\`js
let result = confirm("Are you a student?");console.log(result);
\`\`\`
...
\`\`\`js
let name = prompt("Enter your name");alert("Welcome " + name);
\`\`\`
...
\`\`\`js
let firstName = prompt("Enter your first name");let city = prompt("Enter your city");console.log("Name: " + firstName);console.log("City: " + city);
\`\`\`
...
Prompt Appears↓User Enters Value↓JavaScript Receives Value↓Value Stored In Variable↓Program Continues
...
### Login FormsRegistration FormsSearch BoxesContact FormsShopping Carts
...
\`\`\`js
let age = Number(prompt("Enter age"));console.log(age + 5);
\`\`\`
...
**Which function displays output in the console?**
...
**Which function displays a popup message?**
...
\`\`\`js
let likesJavaScript = confirm("Do you like JavaScript?");console.log(likesJavaScript);
\`\`\``,
    },
    {
      slug: "chapter-8-conditional-statements",
      title: "Conditional Statements",
      summary: "Imagine you are standing at a traffic signal. You follow different actions depending on the color of the light. Green Light → GoYellow Light → Slow DownRed Light → Stop You make decisions based on conditions. Computers also need to make decisions. For…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 7,
      tags: "conditional-statement,if,else,else-if,nested-condition,switch,case,break,default,truthy,falsy",
      learningObjectives: ["Understand conditional statements", "Use the if statement", "Use if-else statements", "Use else-if ladders", "Use nested conditions", "Use switch statements", "Understand truthy and falsy values", "Build decision-making programs", "Avoid common beginner mistakes"],
      prerequisites: [],
      whereItFits: "Imagine a login system.",
      keyTakeaways: ["Conditional statements allow programs to make decisions.", "if executes code when a condition is true.", "else handles alternative outcomes.", "else-if handles multiple conditions.", "Nested conditions place one condition inside another.", "switch simplifies multiple comparisons.", "break prevents unwanted execution.", "default executes when no case matches.", "Truthy values act like true.", "Falsy values act like false."],
      selfAssessment: ["Which statement handles alternative execution? (Answer: C)", "Which keyword is used for multiple conditions? (Answer: B)", "Which statement is used for many value comparisons? (Answer: C)", "Which value is falsy? (Answer: D)", "What does break do? (Answer: B)"],
...
Green Light → GoYellow Light → Slow DownRed Light → Stop
...
Password Correct?↓Yes → LoginNo → Reject Access

Or an online store:

Product Available?↓Yes → Buy ProductNo → Show Out of Stock
...
### Condition↓True ?↓Execute Code↓Otherwise Skip

## Real-Life Analogy

Imagine an ATM.

### Correct PIN?↓Yes → ContinueNo → Reject Access
...
### age = 20↓20 >= 18↓true↓Display Message
...
\`\`\`js
if (true) { console.log("Line 1"); console.log("Line 2");}
\`\`\`
...
### age = 16↓16 >= 18↓false↓else Block Executes↓Minor

## Another Example

\`\`\`js
let password = "12345";if (password === "12345") { console.log("Login Successful");}else { console.log("Wrong Password");}
\`\`\`
...
\`\`\`js
let marks = 85;if (marks >= 90) { console.log("Grade A");}else if (marks >= 80) { console.log("Grade B");}else if (marks >= 70) { console.log("Grade C");}else { console.log("Grade D");}
\`\`\`
...
### marks = 85↓85 >= 90 ?↓No↓85 >= 80 ?↓Yes↓Grade B
...
\`\`\`js
let age = 20;let hasID = true;if (age >= 18) { if (hasID) { console.log("Entry Allowed"); }}
\`\`\`
...
### Age Check↓Passed↓ID Check↓Passed↓Entry Allowed

## Real-Life Example

### Movie Theater:

### Age ≥ 18 ?↓Yes↓Ticket Available ?↓Yes↓Allow Entry
...
\`\`\`js
switch (value) { case option1: code; break; case option2: code; break; default: code;}
\`\`\`

## Example

\`\`\`js
let day = "Monday";switch (day) { case "Monday": console.log("Start of Week"); break; case "Friday": console.log("Weekend Coming"); break; default: console.log("Regular Day");}
\`\`\`
...
\`\`\`js
switch (day) { case "Monday": console.log("Monday"); case "Friday": console.log("Friday");}
\`\`\`
...
\`\`\`js
if ("JavaScript") { console.log("Learning");}
\`\`\`
...
\`\`\`js
let username = "Kamraan";if (username) { console.log("Username Entered");}else { console.log("Username Missing");}
\`\`\`
...
### Evaluate Condition↓true ?↓Execute Block↓Continue Program
...
\`\`\`js
if (age >= 18)console.log("Adult");console.log("Allowed");
\`\`\`
...
\`\`\`js
let stock = 10;if (stock > 0) { console.log("Product Available");}else { console.log("Out of Stock");}
\`\`\`
...
**Which statement handles alternative execution?**
...
**Which statement is used for many value comparisons?**
...
\`\`\`js
let number = 10;if (number > 0) { console.log("Positive");}
\`\`\`

### Exercise 2

\`\`\`js
let age = 20;if (age >= 18) { console.log("Eligible to Vote");}else { console.log("Not Eligible");}
\`\`\`
...
\`\`\`js
let day = "Monday";switch(day) { case "Monday": console.log("Start of Week"); break; default: console.log("Another Day");}
\`\`\``,
    },
    {
      slug: "chapter-9-scope",
      title: "Scope",
      summary: "Imagine you have a house with several rooms. Some items are available to everyone in the house. For example: TelevisionLiving Room SofaDining Table Everyone can access them. But some items belong only to a specific room. Example: Bedroom KeyPersonal…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 8,
      tags: "global-scope,local-scope,function-scope,block-scope,scope-chain,variable-shadowing,let,const,var",
      ...
      selfAssessment: ["Which scope is accessible everywhere? (Answer: C)", "Which keyword supports block scope? (Answer: B)", "What is the process of searching outward for variables called? (Answer: B)", "What happens when a local variable has the same name as a global variable? (Answer: C)", "Which keyword does NOT provide block scope? (Answer: C)"],
      content: `# Scope
...
TelevisionLiving Room SofaDining Table
...
Bedroom KeyPersonal DiaryWardrobe
...
Every Variable↓Accessible Everywhere
...
### Variable↓Scope Rules↓Accessible Area
...
### CEO↓Entire Company Access

### Department Manager↓Department Access Only

### Employee↓Specific Work Area
...
### Organize Variables↓Prevent Conflicts↓Improve Security↓Improve Maintainability

## Types of Scope

### JavaScript mainly provides:

### Global ScopeLocal ScopeBlock ScopeFunction Scope
...
### Global Scope│├── country│├── Function A├── Function B└── Function C
...
\`\`\`js
let country = "India";function showCountry() { console.log(country);}showCountry();
\`\`\`
...
### Unexpected Changes↓Bugs↓Difficult Debugging
...
\`\`\`js
function greet() { let name = "Kamraan";}
\`\`\`
...
\`\`\`js
function greet() { let name = "Kamraan"; console.log(name);}greet();
\`\`\`
...
\`\`\`js
function greet() { let name = "Kamraan";}console.log(name);
\`\`\`
...
### name↓Only Exists Inside Function

## Visual Diagram

### Function Scope└── nameOutside❌ Cannot Access
...
\`\`\`js
function displayAge() { let age = 24; console.log(age);}displayAge();
\`\`\`
...
\`\`\`js
{ var city = "Srinagar";}console.log(city);
\`\`\`
...
### Function Scope↓Not Found↓Global Scope↓Found
...
\`\`\`js
let country = "India";function outer() { function inner() { console.log(country); } inner();}outer();
\`\`\`
...
### inner()↓outer()↓Global↓Variable Found
...
\`\`\`js
let name = "Ali";function test() { let name = "Kamraan"; console.log(name);}test();
\`\`\`
...
### Globalname → Ali↓Localname → Kamraan↓Local Wins

## Example

\`\`\`js
let score = 100;function game() { let score = 50; console.log(score);}game();
\`\`\`
...
\`\`\`js
let bankName = "ABC Bank";function showBank() { console.log(bankName);}
\`\`\`
...
\`\`\`js
let city = "Srinagar";function showCity() { console.log(city);}
\`\`\`

### Process:

Function Executes↓Search Current Scope↓Not Found↓Search Global Scope↓Found↓Display Value
...
\`\`\`js
function test(){ let age = 20;}console.log(age);
\`\`\`
...
\`\`\`js
function login() { let password = "12345";}
\`\`\`
...
\`\`\`js
function test(){ let city = "Srinagar";}console.log(city);
\`\`\`
...
**Which scope is accessible everywhere?**
...
**Which keyword supports block scope?**
...
**What is the process of searching outward for variables called?**
...
**Which keyword does NOT provide block scope?**
...
\`\`\`js
function test() { let age = 24; console.log(age);}test();
\`\`\`
...
\`\`\``,
    ...
    {
      slug: "chapter-10-arrays",
      title: "Arrays",
      summary: "Imagine a teacher wants to store the names of 30 students. One way is: This quickly becomes difficult to manage. For 30 students, you would need: student1student2student3...student30 For 1,000 students, it becomes almost impossible. JavaScript provides a…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 9,
      ...
      selfAssessment: ["What is the first index of an array? (Answer: C)", "Which method adds an element to the end? (Answer: B)", "Which method removes the last element? (Answer: D)", "What does length return? (Answer: C)", "What happens when an invalid index is accessed? (Answer: C)"],
      content: `# Arrays
...
\`\`\`js
let student1 = "Ali";let student2 = "Kamraan";let student3 = "Aisha";let student4 = "Zara";
\`\`\`
...
student1student2student3...student30
...
\`\`\`js
let fruit1 = "Apple";let fruit2 = "Banana";let fruit3 = "Orange";let fruit4 = "Mango";let fruit5 = "Grapes";
\`\`\`
...
### Bookshelf├── Book 1├── Book 2├── Book 3├── Book 4└── Book 5
...
### fruitsIndex 0 → AppleIndex 1 → BananaIndex 2 → Mango
...
\`\`\`js
let fruits = ["Apple", "Banana"];console.log(fruits[10]);
\`\`\`
...
### → Apple1 → Banana2 → Mango

### After:

### → Apple1 → Orange2 → Mango
...
\`\`\`js
let cartItems = ["Laptop", "Phone", "Mouse"];console.log(cartItems.length);
\`\`\`
...
\`\`\`js
let fruits = ["Apple", "Banana", "Mango"];fruits.shift();console.log(fruits);
\`\`\`
...
\`\`\`js
let fruits = ["Apple", "Banana", "Mango"];fruits.splice(1, 1);console.log(fruits);
\`\`\`
...
### Start at Index 1Remove 1 Element
...
### OriginalApple Banana Mango Orange ↑ ↑ Start End
...
### i = 0↓Apple↓i = 1↓Banana↓i = 2↓Mango↓Stop
...
\`\`\`js
let marks = [80, 90, 70, 95];let total = 0;for(let i = 0; i < marks.length; i++){ total += marks[i];}console.log(total);
\`\`\`
...
### fruitsIndex 0 → AppleIndex 1 → Banana
...
\`\`\`js
let products = [ "Laptop", "Phone", "Tablet", "Keyboard"];
\`\`\`
...
\`\`\`js
let fruits = ["Apple", "Banana"];console.log(fruits[2]);
\`\`\`
...
\`\`\``,
    ...
    {
      slug: "chapter-11-objects",
      title: "Objects",
      summary: "In the previous chapter, we learned that arrays help store multiple values. Example: Arrays are excellent when values belong to the same category. But what if we want to store information about a student? A student has: NameAgeCityCourseMarks Using an array:…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 10,
      ...
      selfAssessment: ["What is an object? (Answer: B)", "What is a property? (Answer: C)", "What is a method? (Answer: A)", "Which notation is most commonly used? (Answer: B)", "Which keyword removes a property? (Answer: B)"],
      content: `# Objects
...
What is Index 0?What is Index 1?What is Index 2?
...
\`\`\`js
let studentName = "Kamraan";let studentAge = 24;let studentCity = "Srinagar";let studentCourse = "MSc IT";
\`\`\`
...
### Hundreds of Variables↓Messy Code↓Difficult Maintenance
...
### Student ObjectName → KamraanAge → 24City → Srinagar
...
### Name : KamraanAge : 24City : SrinagarCourse : MSc IT
...
\`\`\`js
let student = { name: "Kamraan", age: 24, city: "Srinagar"};
\`\`\`
...
### student├── name → Kamraan├── age → 24└── city → Srinagar

## Output Example

\`\`\`js
let student = { name: "Kamraan", age: 24, city: "Srinagar"};console.log(student);
\`\`\`

### Output:

\`\`\`js
{ name: "Kamraan", age: 24, city: "Srinagar"}
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan", age: 24};console.log(student.name);
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan"};console.log(student["name"]);
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan", age: 24};student.age = 25;console.log(student);
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan"};student.city = "Srinagar";console.log(student);
\`\`\`

### Output:

\`\`\`js
{ name: "Kamraan", city: "Srinagar"}
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan", age: 24};delete student.age;console.log(student);
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan", greet: function() { console.log("Hello"); }};
\`\`\`
...
### CarProperties:ColorBrandSpeedMethods:Start()Stop()Accelerate()

## Real-Life Example

\`\`\`js
let car = { brand: "Toyota", start: function(){ console.log("Car Started"); }};
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan", address: { city: "Srinagar", country: "India" }};
\`\`\`

## Visual Diagram

### student├── name└── address ├── city └── country
...
\`\`\`js
let user = { name: "Kamraan", address: { city: "Srinagar", state: "J&K" }};
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan"};
\`\`\`

### Memory:

### student↓Object↓name → Kamraan
...
\`\`\`js
let student = { name: "Kamraan", age: 24, course: "MSc IT"};console.log(student.name);console.log(student.course);
\`\`\`
...
\`\`\`js
let user = { username: "kamraan", followers: 500, verified: true};
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan"};console.log(student.age);
\`\`\`
...
**Which keyword removes a property?**
...
\`\`\`js
let student = { name: "Kamraan", age: 24};
\`\`\`
...
\`\`\`js
student.greet = function(){ console.log("Hello");};student.greet();
\`\`\`

## PART 3 — Modern JavaScript`,
    },
    {
      slug: "chapter-12-template-literals",
      title: "Template Literals",
      summary: "In previous chapters, we learned how to work with strings. Example: Output: Hello Kamraan This works perfectly. However, when programs become larger, combining strings using: + can become difficult to read and maintain. Modern JavaScript introduced a better…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 11,
      ...
      selfAssessment: ["Which symbol is used for template literals? (Answer: C)", "What is used to insert variables? (Answer: D)", "What is string interpolation? (Answer: B)", "Template literals support: (Answer: A)", "Which is correct?", "\"Hello ${name}\"", "`Hello ${name}`", "'Hello ${name}'", "Hello ${name} (Answer: B)"],
...
\`\`\`js
let name = "Kamraan";console.log("Hello " + name);
\`\`\`
...
\`\`\`js
let name = "Kamraan";let city = "Srinagar";console.log("My name is " + name + " and I live in " + city);
\`\`\`
...
### Traditional String"Hello"↓Template Literal\`Hello\`
...
\`\`\`js
TemplateHello \${name}↓Replace Variable↓Hello Kamraan
\`\`\`
...
\`\`\`js
let price = 500;let quantity = 3;console.log(\`Total = \${price * quantity}\`);
\`\`\`
...
\`\`\`js
let message = \`HelloWelcomeJavaScript\`;console.log(message);
\`\`\`

### Output:

### HelloWelcomeJavaScript

## Visual Diagram

### Backticks↓Allow Multiple Lines↓Preserve Formatting
...
\`\`\`js
let username = "Kamraan";let message = \`Welcome \${username}Thank you for joining our platform.\`;console.log(message);
\`\`\`

### Output:

Welcome KamraanThank you for joining our platform.
...
\`\`\`js
let product = "Laptop";let price = 50000;console.log(\`\${product} costs ₹\${price}\`);
\`\`\`
...
\`\`\`js
let item = "Phone";let quantity = 2;let price = 25000;console.log(\`Item: \${item}Quantity: \${quantity}Total: ₹\${quantity * price}\`);
\`\`\`

### Output:

### Item: PhoneQuantity: 2Total: ₹50000
...
\`\`\`js
let name = "Kamraan";\`Hello \${name}\`
\`\`\`

### Process:

\`\`\`js
Template Literal↓Find \${}↓Evaluate Expression↓Replace Value↓Create Final String
\`\`\`
...
### Student InformationName: ___Course: ___College: ___
...
\`\`\`js
let username = "Kamraan";let greeting = \`Welcome \${username}\`;
\`\`\`
...
**What is used to insert variables?**
...
\`\`\`js
let city = "Srinagar";let country = "India";console.log(\`\${city}, \${country}\`);
\`\`\`

### Exercise 3

\`\`\`js
let message = \`HelloJavaScript\`;console.log(message);
\`\`\`
...
\`\`\``,
    ...
    },
    {
      ...
      summary: "Chapters 13 to 24 of JavaScript.",
      order: 2,
      difficulty: "intermediate",
      estimatedMinutes: 360,
      tutorials: [
    {
      slug: "chapter-13-destructuring",
      title: "Destructuring",
      summary: "In the previous chapters, we learned about arrays and objects. Suppose we have an array: To access values: This works. But what if the array contains: 102030405060 and we need many values? Writing: repeatedly becomes tedious. The same problem exists with…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 12,
      tags: "array-destructuring,object-destructuring,nested-destructuring,default-values,property-extraction,variable-renaming,pattern-matching",
      ...
      selfAssessment: ["Which brackets are used for array destructuring? (Answer: C)", "Which brackets are used for object destructuring? (Answer: A)", "Array destructuring depends on: (Answer: B)", "Object destructuring depends on: (Answer: C)", "What is used to avoid undefined values? (Answer: C)"],
...
\`\`\`js
let firstFruit = fruits[0];let secondFruit = fruits[1];let thirdFruit = fruits[2];
\`\`\`
...
\`\`\`js
let name = student.name;let age = student.age;let city = student.city;
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan", age: 24, city: "Srinagar"};let name = student.name;let age = student.age;let city = student.city;
\`\`\`
...
### Array/Object↓Destructuring↓Individual Variables

## Real-Life Analogy

Imagine a shopping bag.

### Shopping Bag↓AppleBananaMango

### Normally:

### Take Item 1Take Item 2Take Item 3
...
\`\`\`js
let fruits = ["Apple", "Banana", "Mango"];let first = fruits[0];let second = fruits[1];let third = fruits[2];
\`\`\`
...
\`\`\`js
let fruits = ["Apple", "Banana", "Mango"];let [first, second, third] = fruits;console.log(first);console.log(second);console.log(third);
\`\`\`
...
Array["Apple", "Banana", "Mango"]↓[first, second, third]↓first → Applesecond → Bananathird → Mango
...
\`\`\`js
let fruits = ["Apple", "Banana", "Mango"];let [first, , third] = fruits;console.log(first);console.log(third);
\`\`\`
...
\`\`\`js
let numbers = [10, 20, 30];let [a, b] = numbers;
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan", age: 24, city: "Srinagar"};let { name, age, city } = student;console.log(name);console.log(age);console.log(city);
\`\`\`
...
### Objectname → Kamraanage → 24city → Srinagar↓Destructuring↓Variables
...
\`\`\`js
let student = { name: "Kamraan", age: 24};let { age, name } = student;
\`\`\`
...
\`\`\`js
let { name: studentName } = student;console.log(studentName);
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan"};let { name, age = 24 } = student;console.log(age);
\`\`\`
...
\`\`\`js
let { address: { city }} = student;console.log(city);
\`\`\`
...
\`\`\`js
let [a, [b, c]] = numbers;console.log(a);console.log(b);console.log(c);
\`\`\`
...
\`\`\`js
let user = { username: "kamraan", email: "kamraan@gmail.com", city: "Srinagar"};let { username, email } = user;console.log(username);console.log(email);
\`\`\`

### Output:

### kamraankamraan@gmail.com
...
\`\`\`js
function Profile({ name, age }) { console.log(name); console.log(age);}
\`\`\`
...
### Array↓Position Matching↓a → 10b → 20
...
### Object↓Find Property↓Extract Value↓Store In Variable
...
\`\`\`js
let user = { id: 1, username: "kamraan", email: "kamraan@gmail.com"};
\`\`\`

### Instead of:

### user.usernameuser.email
...
\`\`\`js
let student = { name: "Kamraan"};let { age } = student;console.log(age);
\`\`\`
...
**Which brackets are used for array destructuring?**
...
**Which brackets are used for object destructuring?**
...
**Array destructuring depends on:**
...
**Object destructuring depends on:**
...
**What is used to avoid undefined values?**
...
\`\`\`js
let colors = ["Red", "Blue", "Green"];let [a, b, c] = colors;
\`\`\`

### Exercise 2

\`\`\`js
let student = { name: "Kamraan", age: 24};let { name, age } = student;
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan"};let { name: studentName } = student;console.log(studentName);
\`\`\``,
    },
    {
      slug: "chapter-14-spread-operator",
      title: "Spread Operator",
      summary: "Imagine you have two baskets of fruits. Basket 1: AppleBanana Basket 2: MangoOrange You want to create a new basket containing all fruits. One way is: AppleBananaMangoOrange Modern JavaScript provides a simple feature that makes this easy: ... This is called…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 13,
      tags: "copy,merge,array-expansion,object-expansion,shallow-copy,iterable,reference-type",
      ...
      selfAssessment: ["Which symbol represents the spread operator? (Answer: C)", "What is a common use of spread? (Answer: B)", "Spread creates: (Answer: C)", "Spread can merge: (Answer: C)", "Spread is heavily used in: (Answer: D)"],
...
\`\`\`js
let numbers = [10, 20, 30];let copy = numbers;
\`\`\`
...
\`\`\`js
let numbers = [10, 20, 30];let copy = numbers;copy.push(40);console.log(numbers);
\`\`\`
...
### Open Box↓Take Everything Out↓Apple Banana Mango
...
### Array[10, 20, 30]↓Spread↓10 20 30
...
\`\`\`js
let fruits = ["Apple", "Banana"];let copy = fruits;
\`\`\`
...
\`\`\`js
let fruits = ["Apple", "Banana"];let copy = [...fruits];console.log(copy);
\`\`\`
...
### fruits ──┐ │copy ────┘ Same Array

### With spread:

### fruits → Array 1copy → Array 2
...
\`\`\`js
let fruits = ["Apple", "Banana"];let copy = [...fruits];copy.push("Mango");console.log(fruits);console.log(copy);
\`\`\`
...
\`\`\`js
let arr1 = [1, 2];let arr2 = [3, 4];let result = [...arr1, ...arr2];console.log(result);
\`\`\`
...
### Array 11 2+Array 23 4↓Merge↓1 2 3 4
...
\`\`\`js
let numbers = [20, 30];let result = [10, ...numbers, 40];console.log(result);
\`\`\`
...
\`\`\`js
let semester1 = [80, 90];let semester2 = [85, 95];let allMarks = [...semester1, ...semester2];console.log(allMarks);
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan", age: 24};let copy = { ...student };console.log(copy);
\`\`\`
...
\`\`\`js
let student = { name: "Kamraan"};let copy = { ...student };copy.name = "Ali";console.log(student.name);console.log(copy.name);
\`\`\`
...
\`\`\`js
let personal = { name: "Kamraan"};let address = { city: "Srinagar"};let profile = { ...personal, ...address};console.log(profile);
\`\`\`
...
### Object 1name+Object 2city↓Combined Object
...
\`\`\`js
let user = { name: "Kamraan", age: 24};let updated = { ...user, age: 25};console.log(updated);
\`\`\`
...
\`\`\`js
function add(a, b, c){ return a + b + c;}let numbers = [10, 20, 30];console.log(add(...numbers));
\`\`\`
...
### Array[10,20,30]↓Spread↓10,20,30↓Function Parameters
...
\`\`\`js
let student = { name: "Kamraan", address: { city: "Srinagar" }};let copy = { ...student };
\`\`\`
...
\`\`\`js
let cart1 = ["Phone", "Laptop"];let cart2 = [...cart1];cart2.push("Tablet");console.log(cart1);console.log(cart2);
\`\`\`
...
\`\`\`js
let user = { name: "Kamraan", age: 24};let updatedUser = { ...user, age: 25};
\`\`\`
...
### Original Array↓Read Elements↓Create New Array↓Copy Values↓Done
...
### Spread↓Copies Everything Deeply
...
\`\`\`js
let frontend = ["HTML", "CSS"];let javascript = ["JavaScript"];
\`\`\`
...
\`\`\`js
let profile = { username: "kamraan", email: "kamraan@gmail.com"};
\`\`\`

### When updating only one field:

\`\`\`js
let updatedProfile = { ...profile, email: "new@gmail.com"};
\`\`\`
...
\`\`\`js
let arr = [1,2,3];let copy = arr;copy.push(4);console.log(arr);
\`\`\`
...
**Which symbol represents the spread operator?**
...
**What is a common use of spread?**
...
\`\`\`js
let arr = [1, 2, 3];let copy = [...arr];
\`\`\`

### Exercise 2

\`\`\`js
let a = [1, 2];let b = [3, 4];let result = [...a, ...b];
\`\`\`

### Exercise 3

\`\`\`js
let student = { name: "Kamraan"};let copy = { ...student };
\`\`\`

### Exercise 4

\`\`\`js
let a = { name: "Kamraan"};let b = { city: "Srinagar"};let result = { ...a, ...b};
\`\`\``,
    },
    {
      slug: "chapter-15-rest-parameters",
      title: "Rest Parameters",
      summary: "In the previous chapter, we learned about the Spread Operator (...). Now we will learn another feature that uses the same symbol: ... called: Many beginners get confused because: ... is used for both Spread and Rest. However, they serve different purposes.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 14,
      tags: "javascript",
...
### Numbers5 Numbers10 Numbers100 Numbers
...
### 10203040↓Rest Parameter↓[10,20,30,40]
...
\`\`\`js
function collect(...numbers){ console.log(numbers);}collect(10, 20, 30);
\`\`\`
...
### Function Call102030↓Rest Parameter↓[10,20,30]

## Line-by-Line Explanation

\`\`\`js
function collect(...numbers){ console.log(numbers);}
\`\`\`
...
\`\`\`js
function add(...numbers){ let total = 0; for(let number of numbers){ total += number; } return total;}console.log(add(10,20,30));
\`\`\`
...
### 102030↓numbers Array↓Loop↓Calculate Total↓60
...
\`\`\`js
function test(...values){ console.log(Array.isArray(values));}test(1,2,3);
\`\`\`
...
\`\`\`js
function show(...names){ console.log(names.length);}show("Ali", "Kamraan", "Aisha");
\`\`\`
...
\`\`\`js
function introduce(name, ...skills){ console.log(name); console.log(skills);}introduce("Kamraan", "HTML", "
\`\`\``,
    },
    {
      slug: "chapter-16-arrow-functions",
      title: "Arrow Functions",
      summary: "In previous chapters, we learned how to create functions using: keyword. Example: This works perfectly and is still widely used. However, modern JavaScript introduced a shorter and cleaner way to write functions: Arrow functions are one of the most frequently…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 15,
      tags: "javascript",
      learningObjectives: ["Understand arrow functions", "Learn arrow function syntax", "Convert regular functions to arrow functions", "Understand differences from regular functions", "Know when to use arrow functions", "Know when not to use arrow functions", "Follow best practices", "Avoid common beginner mistakes"],
      prerequisites: [],
      whereItFits: "",
      keyTakeaways: [],
      selfAssessment: [],
...
### Regular Function↓Shorter Syntax↓Arrow Function

## Real-Life Analogy

### Imagine writing a full address:

### Mohammad KamraanSrinagarJammu & KashmirIndia
...
### Function Name↓Arrow Function↓Execute
...
\`\`\`js
const add = (a, b) => { console.log(a + b);};add(10, 20);
\`\`\`
...
### 1020↓Parameters↓Arrow Function↓30
...
### Expression↓Automatically Returned↓Result
...
\`\`\`js
let products = ["Laptop", "Phone", "Tablet"];products.forEach(product => { console.log(product);});
\`\`\`
...
### Arrow Function↓Uses Parent this
...
### CallbacksArray MethodsReact ComponentsShort FunctionsFunctional Programming
...
### Creating ConstructorsObject Methods Requiring thisComplex Functions
...
\`\`\`js
const calculateDiscount = (price) => { return price * 0.10;};console.log(calculateDiscount(1000));
\`\`\`
...
\`\`\`js
const Header = () => { return <h1>Welcome</h1>;};
\`\`\`
...
### Arguments↓Parameters↓Expression↓Automatic Return↓Result
...
\`\`\``,
    ...
    {
      slug: "chapter-17-default-parameters",
      title: "Default Parameters",
      summary: "Imagine you are ordering a pizza. The restaurant asks: Pizza Size? If you don't choose a size, they automatically select: Medium Size This default choice ensures the order can still be processed. JavaScript functions often face a similar situation. Sometimes…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 16,
      tags: "default-parameter,argument,parameter,optional-parameter,fallback-value,undefined,null,expression,function-parameter",
      learningObjectives: ["Understand default parameters", "Understand why default parameters exist", "Create functions with default values", "Use multiple default parameters", "Use expressions as default values", "Understand real-world usage", "Avoid common beginner mistakes"],
      prerequisites: [],
      whereItFits: "",
      ...
      selfAssessment: ["Default parameters provide: (Answer: C)", "Which value activates default parameters? (Answer: D)", "Can multiple parameters have default values? (Answer: B)", "Can expressions be used as defaults? (Answer: C)", "Which value does NOT activate defaults? (Answer: B)"],
...
### Parameter↓No Value Received↓undefined
...
### Function Call↓Argument Provided?↓Yes → Use ArgumentNo → Use Default Value
...
\`\`\`js
function greet(name = "Guest"){ console.log(\`Hello \${name}\`);}greet("Kamraan");
\`\`\`
...
### Argument Exists↓Kamraan↓Use Kamraan
...
\`\`\`js
function createUser( name = "Guest", city = "Srinagar"){ console.log(name); console.log(city);}createUser();
\`\`\`
...
### name↓Kamraan Provided↓Use Kamraancity↓Missing↓Use Srinagar

## Example With All Arguments

\`\`\`js
createUser( "Kamraan", "Delhi");
\`\`\`
...
\`\`\`js
function multiply( number, multiplier = 2){ return number * multiplier;}console.log(multiply(10));
\`\`\`
...
### multiplier↓Not Supplied↓2 Used
...
\`\`\`js
function multiply(number, multiplier){ if(multiplier === undefined){ multiplier = 2; } return number * multiplier;}
\`\`\`
...
\`\`\`js
function multiply( number, multiplier = 2){ return number * multiplier;}
\`\`\`
...
\`\`\`js
function calculate( number, tax = number * 0.10){ return tax;}console.log(calculate(1000));
\`\`\`
...
\`\`\`js
function getDefaultCity(){ return "Srinagar";}
\`\`\`

\`\`\`js
function createUser( name, city = getDefaultCity()){ console.log(city);}createUser("Kamraan");
\`\`\`
...
\`\`\`js
function greet(name = "Guest"){ console.log(name);}greet(undefined);
\`\`\`
...
### undefined↓Default Activated

### null↓Default Not Activated
...
\`\`\`js
function addItem( item, quantity = 1){ console.log(\`\${item} x \${quantity}\`);}addItem("Laptop");
\`\`\`
...
\`\`\`js
function registerUser( username, role = "User"){ console.log(\`\${username} - \${role}\`);}
\`\`\`
...
### Function Called↓Argument Present?↓No↓Use Default Value↓Display Guest
...
\`\`\`js
function greet(name = "Guest"){ console.log(name);}greet("Kamraan");
\`\`\`
...
### namecourse = "MSc IT"city = "Srinagar"
...
\`\`\`js
function greet(name = "Guest"){ console.log(name);}greet(null);
\`\`\`
...
### null↓Actual Value↓Default Not Used
...
**Which value activates default parameters?**
...
**Can multiple parameters have default values?**
...
**Which value does NOT activate defaults?**
...
\`\`\`js
function createUser( name = "Guest", city = "Srinagar"){ console.log(name); console.log(city);}
\`\`\`
...
\`\`\`js
function calculate( amount, tax = amount * 0.10){ return tax;}
\`\`\``,
    },
    {
      slug: "chapter-18-modules",
      title: "Modules",
      summary: "Imagine a large company. The company has different departments: Human ResourcesFinanceMarketingIT Department Each department has a specific responsibility. Instead of putting everything into one department, work is divided into smaller manageable sections.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 17,
      ...
      selfAssessment: ["What is a module? (Answer: C)", "Which keyword shares code? (Answer: B)", "Which keyword receives code? (Answer: C)", "Named exports require: (Answer: C)", "Default exports require: (Answer: B)"],
      content: `# Modules
...
Human ResourcesFinanceMarketingIT Department
...
### LoginShopping CartPaymentsProductsOrdersUser Profiles

### Without modules:

### Everything↓One Huge File

### Problems:

### Difficult To ReadDifficult To DebugDifficult To Maintain
...
### math.js↓Export Functions↓app.js↓Import Functions↓Use Functions

## Real-Life Analogy

Imagine a toolbox.

### HammerScrewdriverWrench
...
### Thousands Of Lines↓Messy Code↓Maintenance Problems

## Modern Solution

### Separate files:

### math.jsuser.jscart.jsapp.js

Each file handles one responsibility.

## Visual Diagram

### Project├── math.js├── user.js├── cart.js└── app.js
...
### math.jsPI↓Export↓Available To Other Files
...
\`\`\`js
app.jsimport { PI } from "./math.js";console.log(PI);
\`\`\`
...
### math.js↓Export PI↓app.js↓Import PI↓Use PI
...
\`\`\`js
import { greet } from "./math.js";greet();
\`\`\`
...
\`\`\`js
math.jsexport const PI = 3.14;export const E = 2.71;export function add(a, b){ return a + b;}
\`\`\`

## Importing Multiple Values

\`\`\`js
import { PI, E, add} from "./math.js";console.log(PI);console.log(E);console.log(add(10,20));
\`\`\`
...
### math.jsPIEadd()↓Export↓app.js↓Import↓Use
...
\`\`\`js
math.jsexport default function greet(){ console.log("Hello");}
\`\`\`
...
### User ComponentProduct ComponentLogin Component
...
### PIAlready Exists↓Rename During Import
...
### math.js↓Everything Imported↓MathUtils↓Access Properties
...
\`\`\`js
export function calculateTax(price){ return price * 0.10;}
\`\`\`
...
\`\`\`js
discount.jsexport function getDiscount(price){ return price * 0.20;}
\`\`\`

### File:

\`\`\`js
app.jsimport { getDiscount }from "./discount.js";console.log(getDiscount(1000));
\`\`\`
...
project├── api│ └── users.js├── components│ └── navbar.js├── utilities│ └── helpers.js└── app.js
...
### Browser Loads File↓Find Import↓Load Module↓Receive Export↓Execute Code
...
### 200+Components100+Utility Files50+API Files
...
\`\`\``,
    ...
    {
      slug: "chapter-19-classes-and-oop",
      title: "Classes and OOP",
      summary: "Imagine a car manufacturing company. The company produces thousands of cars. Examples: Car 1Car 2Car 3Car 4 All cars share common characteristics: BrandColorSpeedFuel Type And common actions: Start()Stop()Accelerate() Instead of designing each car from…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 18,
      ...
      selfAssessment: ["A class is: (Answer: B)", "Objects are created using: (Answer: C)", "Which method initializes an object? (Answer: C)", "Which keyword creates inheritance? (Answer: B)", "What does polymorphism mean? (Answer: B)"],
      content: `# Classes and OOP
...
\`\`\`js
let student1Name = "Ali";let student1Age = 20;let student2Name = "Kamraan";let student2Age = 24;let student3Name = "Aisha";let student3Age = 22;
\`\`\`
...
### ObjectsClassesPropertiesMethods

## Visual Diagram

### Class↓Create Object↓Use Object
...
### Class↓Object 1Object 2Object 3
...
\`\`\`py
class Student {}let student1 = new Student();console.log(student1);
\`\`\`
...
### Student Class↓new Student()↓Student Object
...
\`\`\`py
class Student { constructor(){ console.log("Student Created"); }}let student1 = new Student();
\`\`\`
...
### Arguments↓Constructor↓Object Properties
...
### Current Object↓name Property↓Store Value

## Complete Example

\`\`\`py
class Student { constructor(name, age){ this.name = name; this.age = age; }}let student1 = new Student("Kamraan", 24);console.log(student1);
\`\`\`
...
\`\`\`py
class Student { constructor(name){ this.name = name; } greet(){ console.log(\`Hello \${this.name}\`); }}
\`\`\`

## Creating Object

\`\`\`js
let student1 = new Student("Kamraan");student1.greet();
\`\`\`
...
### Student Object↓greet()↓Hello Kamraan
...
\`\`\`js
let student1 = new Student("Kamraan");let student2 = new Student("Ali");let student3 = new Student("Aisha");
\`\`\`
...
### Student Class↓student1student2student3
...
\`\`\`js
let student1 = { name: "Kamraan"};let student2 = { name: "Ali"};
\`\`\`
...
### Data+Methods↓Grouped Together

## Example

\`\`\`py
class BankAccount { constructor(balance){ this.balance = balance; } deposit(amount){ this.balance += amount; }}
\`\`\`
...
### Better OrganizationBetter SecurityEasier Maintenance
...
### Animal↓speak()↓Dog↓Can Use speak()
...
\`\`\`js
let dog = new Dog();dog.speak();dog.bark();
\`\`\`
...
\`\`\`js
let laptop = new Product("Laptop", 50000);let phone = new Product("Phone", 25000);
\`\`\`
...
\`\`\`py
class Car { constructor(brand){ this.brand = brand; } start(){ console.log(\`\${this.brand} Started\`); }}
\`\`\`

\`\`\`js
let car1 = new Car("Toyota");car1.start();
\`\`\`
...
Class Found↓Constructor Called↓Object Created↓Properties Assigned↓Object Returned
...
### UsersProductsOrdersPaymentsVehiclesEmployees
...
\`\`\`py
class Student { constructor(name){ this.name = name; }}let student = Student("Kamraan");
\`\`\`
...
## PART 4 — DOM Manipulation`,
    ...
    {
      slug: "chapter-20-understanding-the-dom",
      title: "Understanding the DOM",
      summary: "Until now, our JavaScript programs mainly worked with: VariablesArraysObjectsFunctions and displayed results using: Example: Output: Kamraan This is useful for learning JavaScript. However, real websites do much more. When a user clicks a button: Button…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 19,
      ...
      selfAssessment: ["DOM stands for: (Answer: B)", "The DOM is created from: (Answer: C)", "Which object represents the webpage? (Answer: D)", "The DOM structure resembles: (Answer: C)", "JavaScript uses the DOM to: (Answer: B)"],
...
VariablesArraysObjectsFunctions
...
Button Click↓Page Changes↓New Content Appears

When a user submits a form:

Form Submitted↓Validation Runs↓Result Displayed

When a user adds an item to a cart:

Cart Updates↓Price Updates↓UI Changes
...
\`\`\`html
<h1>Welcome</h1><p>Hello World</p><button>Click Me</button>
\`\`\`
...
### Change TextRespond To ClicksUpdate ContentHide ElementsCreate New Elements
...
### HTML↓Browser↓DOM↓JavaScript Access
...
\`\`\`html
<html><head> <title>Website</title></head><body> <h1>Welcome</h1> <p>Hello World</p></body></html>
\`\`\`

## DOM Tree Representation

html├── head│ └── title│ └── Website│└── body ├── h1 │ └── Welcome │ └── p └── Hello World
...
### HTML↓Parse HTML↓Create DOM Nodes↓Build DOM Tree

## Visual Diagram

### HTML File↓Browser Parser↓DOM Tree↓Rendered Page

## What Is Parsing?

### Parsing means:

### ReadingUnderstandingConverting
...
### Change ContentModify StylesHandle EventsCreate Elements
...
### JavaScript↓Access Elements↓Modify Elements↓Update Page
...
### Click Like↓JavaScript Executes↓DOM Updates↓Like Count Changes
...
### NetflixAmazonFacebookInstagramYouTube

All constantly update the DOM.

### Examples:

### New PostsNotificationsCommentsSearch Results
...
### HTML↓Browser Reads HTML↓Creates DOM Node↓Adds Node To Tree↓Displays Element
...
### HTML↓Creates DOM↓Different Things
...
\`\`\`html
<body> <div> <h1>Title</h1> <p>Paragraph</p> </div></body>
\`\`\`
...
### Product CountCart TotalNotificationsUser Information
...
### document↓DOM Object↓Not Raw HTML
...
### HTML↓Browser Parser↓DOM Nodes↓DOM Tree↓Rendered Page`,
    },
    {
      slug: "chapter-21-selecting-elements",
      title: "Selecting Elements",
      summary: "In the previous chapter, we learned that JavaScript interacts with webpages through the DOM. However, before JavaScript can change an element, it must first find that element. Imagine a webpage containing: If JavaScript wants to change the heading:…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 20,
      ...
      selfAssessment: ["Which method selects by ID? (Answer: B)", "querySelector returns: (Answer: B)", "querySelectorAll returns: (Answer: C)", "Which symbol selects a class? (Answer: C)", "Which symbol selects an ID? (Answer: A)"],
...
\`\`\`html
<h1 id="title">Welcome</h1><p class="message">Hello World</p><button>Click Me</button>
\`\`\`
...
### JavaScript↓Cannot Know↓Which Element To Modify

## Visual Diagram

### Webpage↓Find Element↓Store Element↓Modify Element
...
### HTML Element↓ID = title↓getElementById("title")↓Element Returned
...
### Student ID↓Find Student

### Similarly:

### Element ID↓Find Element
...
\`\`\`html
<p class="message">First</p><p class="message">Second</p><p class="message">Third</p>
\`\`\`
...
\`\`\`js
let messages = document.getElementsByClassName("message");console.log(messages);
\`\`\`
...
### message↓Element 1Element 2Element 3↓Collection Returned
...
\`\`\`js
let messages = document.getElementsByClassName("message");console.log(messages[0]);
\`\`\`
...
### .message↓Find Class↓Return First Match
...
\`\`\`js
let messages = document.querySelectorAll(".message");console.log(messages);
\`\`\`
...
### .message↓FirstSecondThird↓NodeList Returned
...
\`\`\`js
let messages = document.querySelectorAll(".message");messages.forEach(function(item){ console.log(item);});
\`\`\`
...
\`\`\`js
let button = document.getElementById("btn");console.log(button);
\`\`\`
...
### Search DOM Tree↓Find Matching ID↓Return Element↓Store Reference
...
### querySelectorAll↓Single Element
...
\`\`\`html
<h1 id="title">Welcome</h1><p class="message">One</p><p class="message">Two</p>
\`\`\`
...
\`\`\`html
<h2 id="temperature"></h2><p id="city"></p>
\`\`\`
...
### Wrong IDTyping MistakeElement MissingJavaScript Runs Before HTML Loads
...
\`\`\``,
    ...
    {
      slug: "chapter-22-changing-content",
      title: "Changing Content",
      summary: "In the previous chapter, we learned how to select elements from the DOM. Example: JavaScript: Now JavaScript knows which element we want to work with. The next step is: Modern websites constantly update content. Examples: Login MessagesShopping Cart…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 21,
      ...
      selfAssessment: ["Which property changes plain text? (Answer: B)", "Which property understands HTML tags? (Answer: C)", "UI stands for: (Answer: A)", "Which displays HTML as text? (Answer: B)", "Which can create HTML elements from strings? (Answer: C)"],
...
Login MessagesShopping Cart TotalsNotificationsWeather InformationSocial Media Posts
...
### User Action↓JavaScript↓Update DOM↓New Content Appears
...
### h1 Element↓textContent↓Welcome
...
\`\`\`js
let heading = document.getElementById("title");heading.textContent = "Hello Kamraan";
\`\`\`
...
### Select Element↓Change textContent↓DOM Updated↓UI Updated
...
\`\`\`js
let message = document.getElementById("message");message.textContent = "Data Loaded Successfully";
\`\`\`
...
\`\`\`js
let box = document.getElementById("box");console.log(box.innerHTML);
\`\`\`
...
\`\`\`html
<div id="box"> <h2>Welcome</h2></div>
\`\`\`

## Visual Diagram

### innerHTML↓Reads HTML↓Creates Elements↓Displays Content
...
\`\`\`js
let content = document.getElementById("content");content.innerHTML = \`<h2>Welcome</h2><p>Hello Kamraan</p>\`;
\`\`\`

### Result:

\`\`\`html
<h2>Welcome</h2><p>Hello Kamraan</p>
\`\`\`
...
### ButtonsHeadingsFormsImagesCards
...
\`\`\`js
let count = document.getElementById("count");count.textContent = "1";
\`\`\`
...
\`\`\`js
let counter = document.getElementById("counter");counter.textContent = 10;
\`\`\`
...
\`\`\`html
<h1 id="welcome">Guest</h1>
\`\`\`

### JavaScript:

\`\`\`js
let username = "Kamraan";document.getElementById("welcome").textContent =\`Welcome \${username}\`;
\`\`\`
...
\`\`\`js
let total = document.getElementById("total");total.textContent = "₹5000";
\`\`\`
...
### Select Element↓Find Text Node↓Replace Text↓Update DOM↓Update Screen
...
### Receive HTML String↓Parse HTML↓Create DOM Nodes↓Insert Into DOM↓Render Content
...
\`\`\`js
let title = document.getElementById("title");title.textContent = "Hello";
\`\`\`
...
\`\`\`html
<h1 id="title">Welcome</h1><div id="content"></div>
\`\`\`

### Use JavaScript to:

### Change HeadingAdd New HTML ContentDisplay Your Name

## Real-World Scenario

### An e-commerce website updates:

### Product CountCart TotalOrder StatusNotifications
...
**Which property changes plain text?**
...
**Which property understands HTML tags?**
...
**Which can create HTML elements from strings?**
...
\`\`\`js
let heading = document.getElementById("title");heading.textContent = "Hello";
\`\`\`
...
\`\`\`js
document.getElementById("card").innerHTML = \`<h2>JavaScript</h2><p>Learning DOM Manipulation</p>\`;
\`\`\``,
    },
    {
      slug: "chapter-23-modifying-styles",
      title: "Modifying Styles",
      summary: "In the previous chapter, we learned how to change webpage content using: textContentinnerHTML However, modern websites do more than update text. They also change appearance dynamically. Examples: Dark ModeLight ModeError MessagesSuccess MessagesTheme…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 22,
      ...
      selfAssessment: ["Which property changes CSS directly? (Answer: B)", "JavaScript uses: (Answer: C)", "Which method adds a class? (Answer: B)", "Which method removes a class? (Answer: A)", "Which method switches a class on/off? (Answer: C)"],
      content: `# Modifying Styles
...
Dark ModeLight ModeError MessagesSuccess MessagesTheme SwitchingInteractive Buttons
...
### User Action↓JavaScript↓Style Changes↓Updated Appearance
...
\`\`\`js
let heading = document.getElementById("title");heading.style.color = "red";
\`\`\`
...
\`\`\`js
let heading = document.getElementById("title");heading.style.color = "blue";
\`\`\`
...
### CSSbackground-color↓JavaScriptbackgroundColor
...
\`\`\`js
let box = document.getElementById("box");box.style.width = "300px";
\`\`\`
...
\`\`\`js
let box = document.getElementById("box");box.style.backgroundColor = "lightblue";box.style.color = "black";box.style.padding = "20px";box.style.border = "2px solid blue";
\`\`\`
...
### Element↓Background↓Color↓Padding↓Border↓Updated UI
...
### Wall ColorFurniture ColorLighting

without changing the room itself.

### Similarly:

### HTML Structure↓Same↓CSS Appearance Changes
...
### Red TextBold TextLarge TextBorder
...
\`\`\`html
<style>.highlight { color: red; font-size: 30px; font-weight: bold;}</style>
\`\`\`
...
\`\`\`js
let heading = document.getElementById("title");heading.classList.add("highlight");
\`\`\`

### Result:

### Class Applied↓Styles Activated

## Visual Diagram

### Element↓Add Class↓CSS Rules Applied
...
### Class Removed↓CSS No Longer Applies↓Original Appearance Returns
...
### Dark Mode Active?Error State Active?Menu Open?
...
\`\`\`js
let status = document.getElementById("status");status.style.color = "red";
\`\`\`
...
\`\`\`js
status.textContent = "Online";status.style.color = "green";
\`\`\`
...
\`\`\`js
let button = document.getElementById("btn");button.style.backgroundColor = "blue";
\`\`\`
...
Element Selected↓Style Property Updated↓DOM Updated↓Browser Repaints Element↓New Appearance Visible
...
### Element Selected↓Class Added↓CSS Rules Applied↓Browser Updates UI
...
\`\`\`js
.highlight { color: blue; font-size: 40px;}
\`\`\`

### Use JavaScript to:

### Add ClassRemove ClassToggle Class

## Real-World Scenario

### Social media websites constantly change styles:

### Liked PostsNotificationsDark ModeMessagesOnline Status
...
**Which property changes CSS directly?**
...
**Which method switches a class on/off?**
...
\`\`\``,
    ...
    {
      slug: "chapter-24-creating-elements",
      title: "Creating Elements",
      summary: "In previous chapters, we learned how to: Select ElementsChange ContentModify Styles However, modern websites do much more. They create entirely new elements while the page is running. Examples: New Chat MessagesNew CommentsNew NotificationsNew ProductsNew…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 23,
      ...
      selfAssessment: ["Which method creates a new element? (Answer: C)", "Which method adds an element to the end? (Answer: A)", "createElement() creates an element: (Answer: B)", "Which method inserts before another element? (Answer: C)", "Newly created elements become visible only after: (Answer: C)"],
...
Select ElementsChange ContentModify Styles
...
New Chat MessagesNew CommentsNew NotificationsNew ProductsNew To-Do Items

When a user adds a task:

Type Task↓Click Add↓New Task Appears
...
### User Action↓JavaScript↓Create Element↓Insert Into DOM↓Display On Screen
...
### Creates Element↓Does NOT Display It Yet
...
\`\`\`js
let heading = document.createElement("h1");console.log(heading);
\`\`\`
...
### createElement("h1")↓New h1 Created↓Not Yet Visible

## Real-Life Analogy

Imagine buying furniture.

### Buy Chair↓Chair Exists↓Still Outside House
...
\`\`\`js
let paragraph = document.createElement("p");console.log(paragraph);
\`\`\`
...
### Create p↓Add Text↓Ready To Insert
...
\`\`\`js
let heading = document.createElement("h1");heading.textContent = "Welcome";document.body.appendChild(heading);
\`\`\`
...
### Create Element↓Add Content↓appendChild()↓Added To DOM↓Visible
...
\`\`\`js
let item = document.createElement("li");item.textContent = "JavaScript";document.getElementById("list").appendChild(item);
\`\`\`
...
### ul↓appendChild()↓li Added↓Displayed
...
\`\`\`js
for(let i = 1; i <= 3; i++){ let item = document.createElement("li"); item.textContent = \`Item \${i}\`; document.getElementById("list") .appendChild(item);}
\`\`\`
...
\`\`\`js
let notification = document.createElement("p");notification.textContent ="New Message Received";document.body.appendChild(notification);
\`\`\`
...
\`\`\`js
let box = document.createElement("div");box.textContent = "Hello";box.style.backgroundColor = "lightblue";document.body.appendChild(box);
\`\`\`
...
### Create Element↓Add Class↓Insert↓CSS Applied
...
\`\`\`html
<ul id="list"> <li>Item 2</li></ul>
\`\`\`

## JavaScript

\`\`\`js
let newItem = document.createElement("li");newItem.textContent = "Item 1";let list = document.getElementById("list");let existingItem = list.firstElementChild;list.insertBefore( newItem, existingItem);
\`\`\`
...
### Item 2↓Insert Before↓Item 1Item 2
...
### Item 1Item 2↓New Item↓Last Position

### insertBefore

Adds before specific element.

### New Item↓Before Existing Item
...
\`\`\`html
<input id="task"><button id="addBtn">Add</button><ul id="tasks"></ul>
\`\`\`

### JavaScript:

\`\`\`js
let task = document.createElement("li");task.textContent = "Learn DOM";document.getElementById("tasks").appendChild(task);
\`\`\`

## Result

\`\`\`html
<ul> <li>Learn DOM</li></ul>
\`\`\`
...
### Server Sends Data↓JavaScript Creates Element↓Comment Inserted↓User Sees Comment
...
### Browser Creates DOM Node↓Stores In Memory↓Returns Reference
...
### Find Parent↓Attach Child↓Update DOM Tree↓Render Page
...
\`\`\`js
let p = document.createElement("p");p.textContent = "Hello";
\`\`\`
...
\`\`\`html
<li>Milk</li><li>Bread</li><li>Eggs</li>
\`\`\`
...
### Product CardsReviewsNotificationsRecommendationsMessages
...
\`\`\`js
let item = document.createElement("li");item.textContent = "JavaScript";
\`\`\`
...
### Element Created↓Not Added To DOM
...
**Which method inserts before another element?**
...
**Newly created elements become visible only after:**
...
\`\`\`js
let li = document.createElement("li");li.textContent = "JavaScript";
\`\`\`
...
\`\`\`js
let item = document.createElement("li");item.textContent = "Milk";document.getElementById("list").appendChild(item);
\`\`\`

### Problem 2

\`\`\`js
let notification =document.createElement("p");notification.textContent ="New Notification";document.body.appendChild(notification);
\`\`\`

### Problem 3

\`\`\`js
let comment =document.createElement("div");comment.textContent ="Great Post!";document.body.appendChild(comment);
\`\`\``,
    },
      ],
    },
    {
      ...
      summary: "Chapters 25 to 36 of JavaScript.",
      order: 3,
      difficulty: "intermediate",
      estimatedMinutes: 360,
      tutorials: [
    {
      slug: "chapter-25-removing-elements",
      title: "Removing Elements",
      summary: "In the previous chapter, we learned how to create and add elements to a webpage. Example: Result: appears on the page. However, modern websites also need to remove elements. Examples: Delete To-Do TasksRemove NotificationsDelete CommentsRemove MessagesClose…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 24,
      ...
      selfAssessment: ["Which method removes an element directly? (Answer: B)", "removeChild() requires: (Answer: A)", "Which method is simpler? (Answer: A)", "After remove(), the element: (Answer: C)", "Which is NOT removal? (Answer: C)"],
...
\`\`\`js
let item = document.createElement("li");item.textContent = "Learn JavaScript";document.getElementById("list").appendChild(item);
\`\`\`
...
Delete To-Do TasksRemove NotificationsDelete CommentsRemove MessagesClose Popups

When a user clicks:

Delete↓Element Disappears
...
### Learn HTMLLearn CSSLearn JavaScript
...
### User Clicks Delete↓JavaScript↓Remove Element↓DOM Updated↓Element Disappears
...
\`\`\`js
let message =document.getElementById("message");message.remove();
\`\`\`
...
### Paragraph Exists↓remove()↓Paragraph Deleted
...
### DOM Element↓remove()↓Element Removed
...
\`\`\`js
let notification =document.getElementById("notification");notification.remove();
\`\`\`
...
\`\`\`html
<div id="container"> <p id="message"> Hello </p></div>
\`\`\`

## JavaScript

\`\`\`js
let parent =document.getElementById("container");let child =document.getElementById("message");parent.removeChild(child);
\`\`\`
...
### Container↓Paragraph↓removeChild()↓Paragraph Removed
...
\`\`\`html
<ul id="list"> <li id="item"> JavaScript </li></ul>
\`\`\`

### JavaScript:

\`\`\`js
let list =document.getElementById("list");let item =document.getElementById("item");list.removeChild(item);
\`\`\`
...
### Less CodeEasier To ReadEasier To Maintain
...
\`\`\`html
<p id="task">Learn DOM</p><button id="deleteBtn">Delete</button>
\`\`\`

### JavaScript:

\`\`\`js
let task =document.getElementById("task");task.remove();
\`\`\`
...
\`\`\`html
<p class="message">One</p><p class="message">Two</p><p class="message">Three</p>
\`\`\`

### JavaScript:

\`\`\`js
let messages =document.querySelectorAll(".message");messages.forEach(function(item){ item.remove();});
\`\`\`
...
### Paragraph 1Paragraph 2Paragraph 3↓Loop↓remove()↓All Removed
...
\`\`\`html
<ul id="tasks"> <li>Learn HTML</li> <li>Learn CSS</li></ul>
\`\`\`

### JavaScript:

\`\`\`js
let firstTask =document.querySelector("li");firstTask.remove();
\`\`\`

## Result

\`\`\`html
<ul> <li>Learn CSS</li></ul>
\`\`\`
...
### User Clicks Delete↓Server Confirms↓JavaScript Removes Comment↓DOM Updates
...
Find Element↓Remove From DOM Tree↓Update DOM↓Browser Repaints UI↓Element Disappears
...
### Find Parent↓Find Child↓Detach Child↓Update DOM Tree↓Refresh Display
...
\`\`\`js
let item =document.getElementById("wrong");item.remove();
\`\`\`
...
\`\`\`js
parent.removeChild( unrelatedElement);
\`\`\`
...
### display:none↓Hidden↓Still Exists

### remove()↓Deleted↓No Longer Exists
...
\`\`\`html
<ul id="list"> <li id="task1"> Learn HTML </li></ul>
\`\`\`

### Use JavaScript to:

### Remove TaskDisplay Empty List

## Real-World Scenario

### E-commerce websites remove:

### Expired NotificationsDeleted ReviewsRemoved ProductsDismissed Alerts
...
\`\`\`js
let item =document.getElementById("task");if(item){ item.remove();}
\`\`\`
...
**Which method removes an element directly?**
...
\`\`\`js
let comment =document.getElementById("comment");comment.remove();
\`\`\``,
    },
    {
      slug: "chapter-26-event-handling",
      title: "Event Handling",
      summary: "So far, we have learned how to: Select ElementsChange ContentModify StylesCreate ElementsRemove Elements However, modern websites are interactive. Users constantly perform actions such as: Clicking ButtonsTyping TextMoving MousePressing KeysSubmitting Forms…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 25,
      tags: "event,event-listener,addeventlistener,click-event,keyboard-event,mouse-event,event-object,event-target,event-key",
      ...
      selfAssessment: ["Which method handles events? (Answer: B)", "Which event occurs when a button is clicked? (Answer: C)", "Which event occurs when a key is pressed? (Answer: B)", "event.key provides: (Answer: C)", "Which event occurs when the mouse enters an element? (Answer: B)"],
...
Select ElementsChange ContentModify StylesCreate ElementsRemove Elements

However, modern websites are interactive.

Users constantly perform actions such as:

Clicking ButtonsTyping TextMoving MousePressing KeysSubmitting Forms

When a user clicks:

Login Button↓Login Process Starts

When a user types:

Search Query↓Search Results Update
...
### User Clicks Button↓JavaScript Runs↓Page Responds
...
### ClickKey PressMouse MoveForm SubmitPage LoadScroll

## Visual Diagram

### User Action↓Event Occurs↓JavaScript Detects Event↓Code Executes↓Result Appears

## Real-Life Analogy

Imagine a doorbell.

### Person Presses Doorbell↓Bell Rings↓Homeowner Responds

### Similarly:

### User Clicks Button↓Event Occurs↓JavaScript Responds
...
### Wait For Event↓Respond To Event

## Visual Diagram

### Application Running↓Waiting↓Event Happens↓JavaScript Executes
...
### Button↓Listen For Click↓Click Happens↓Run Function
...
### User Clicks Button↓click Event↓Event Listener↓Function Executes↓Output Appears
...
\`\`\`html
<h1 id="title">Welcome</h1><button id="btn">Change</button>
\`\`\`

### JavaScript:

\`\`\`js
let button =document.getElementById("btn");button.addEventListener( "click", function(){ document.getElementById("title") .textContent = "Hello Kamraan"; });
\`\`\`
...
### Button Click↓JavaScript↓Change Text↓UI Updated
...
### Typing Search QueriesPassword InputChat MessagesForm Data
...
\`\`\`js
let input =document.getElementById("input");input.addEventListener( "keydown", function(){ console.log("Key Pressed"); });
\`\`\`
...
### User Presses Key↓keydown Event↓Function Executes
...
### Key Press↓Event Object↓event.key↓Pressed Key
...
### ClickHoverMoveDouble Click

## Common Mouse Events

### clickmouseovermouseoutdblclick
...
\`\`\`js
let box =document.getElementById("box");box.addEventListener( "mouseover", function(){ console.log("Mouse Entered"); });
\`\`\`
...
\`\`\`js
box.addEventListener( "mouseout", function(){ console.log("Mouse Left"); });
\`\`\`
...
\`\`\`js
button.addEventListener( "dblclick", function(){ console.log("Double Click"); });
\`\`\`

## Visual Diagram

### Double Click↓dblclick Event↓Function Runs
...
\`\`\`js
let button =document.getElementById("btn");button.addEventListener( "click", function(){ document.body.style .backgroundColor = "lightblue"; });
\`\`\`
...
### Add To Cart Click↓Event Fires↓Product Added↓Cart Updated
...
\`\`\`js
button.addEventListener( "click", function(){ console.log("Clicked"); });button.addEventListener( "mouseover", function(){ console.log("Hovered"); });
\`\`\`
...
Register Listener↓Wait↓User Clicks↓Browser Detects Event↓Function Executes↓Result Appears
...
\`\`\`html
<button id="btn">Click Me</button><h1 id="title">Welcome</h1>
\`\`\`

### Use JavaScript so that:

### Button Click↓Heading Changes

## Real-World Scenario

### Applications such as:

### YouTubeFacebookAmazonNetflixInstagram
...
**Which event occurs when the mouse enters an element?**
...
\`\`\`js
box.addEventListener( "mouseover", function(){ console.log("Hover"); });
\`\`\`
...
\`\`\`js
button.addEventListener( "click", function(){ document.body.style .backgroundColor = "lightgreen"; });
\`\`\`
...
\`\`\`js
box.addEventListener( "mouseover", function(){ box.style.color = "red"; });
\`\`\``,
    },
    {
      slug: "chapter-27-forms-and-validation",
      title: "Forms and Validation",
      summary: "Forms are one of the most important parts of web development. Almost every website uses forms. Examples: Login FormsRegistration FormsContact FormsSearch FormsCheckout FormsFeedback Forms When you log into a website: Enter Username↓Enter Password↓Click…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 26,
      ...
      selfAssessment: ["Which property stores user input? (Answer: C)", "Which event occurs when a form is submitted? (Answer: B)", "preventDefault() is used to: (Answer: C)", "Validation is used to: (Answer: B)", "Which property returns the length of a string? (Answer: D)"],
...
Login FormsRegistration FormsContact FormsSearch FormsCheckout FormsFeedback Forms

When you log into a website:

Enter Username↓Enter Password↓Click Login↓Form Submitted
...
Name: __________Email: __________Password: __________

What if a user enters:

Name: (empty)Email: abcPassword: 1
...
### NameEmailPasswordPhone NumberAddress
...
### User Input↓Form↓Data Collected↓Processing
...
Text InputsPassword InputsEmail InputsCheckboxesRadio ButtonsDropdown MenusButtons
...
\`\`\`html
<form> <input type="text" id="name" > <input type="email" id="email" > <button> Submit </button></form>
\`\`\`
...
\`\`\`js
let nameInput =document.getElementById("name");console.log( nameInput.value);
\`\`\`

## Visual Diagram

### Input Field↓User Types↓value Property↓JavaScript Reads Value
...
\`\`\`html
<form id="myForm"> <input type="text" id="name" > <button> Submit </button></form>
\`\`\`
...
\`\`\`js
let form =document.getElementById("myForm");form.addEventListener( "submit", function(){ console.log( "Form Submitted" ); });
\`\`\`
...
### User Clicks Submit↓submit Event↓JavaScript Executes↓Process Form Data

## Problem With Forms

### By default:

### Form Submitted↓Page Reloads
...
\`\`\`js
form.addEventListener( "submit", function(event){ event.preventDefault(); console.log( "Validation Running" ); });
\`\`\`

## Result

### Submit↓No Page Reload↓Validation Runs

## Visual Diagram

### Form Submission↓preventDefault()↓Stop Reload↓Run Validation
...
### Name: KamraanEmail: kamraan@gmail.com
...
### Better User ExperienceCleaner DataFewer ErrorsImproved Security
...
\`\`\`js
let name =document.getElementById("name");if(name.value === ""){ console.log( "Name Required" );}
\`\`\`

## Visual Diagram

### Input Empty?↓Yes↓Show Error
...
\`\`\`js
if( password.value.length < 6){ console.log( "Password Too Short" );}
\`\`\`

## Visual Diagram

### Password Length↓Less Than 6↓Invalid
...
\`\`\`js
if( email.value.includes("@")){ console.log( "Valid Email" );}
\`\`\`
...
\`\`\`js
let error =document.getElementById("error");error.style.color ="red";
\`\`\`
...
\`\`\`html
<form id="form"> <input type="text" id="name" > <p id="error"></p> <button> Submit </button></form>
\`\`\`

### JavaScript:

\`\`\`js
let form =document.getElementById("form");form.addEventListener( "submit", function(event){ event.preventDefault(); let name = document.getElementById( "name" ); let error = document.getElementById( "error" ); if(name.value === ""){ error.textContent = "Name Required"; } });
\`\`\`

## Execution Flow

Submit↓Prevent Reload↓Read Input↓Validate Input↓Display Error↓Wait For Correction
...
### Username RequiredPassword RequiredPassword ≥ 6 Characters
...
### FacebookInstagramLinkedInAmazon
...
### User Types↓Input Stores Text↓value Property Updated↓JavaScript Reads Value

## Form Validation Flow

User Submits Form↓JavaScript Reads Inputs↓Validation Rules Applied↓Valid?↓Yes → SubmitNo → Show Errors
...
### Page Reloads↓Validation Disappears
...
### Name RequiredEmail Must Contain @Password Minimum 6 Characters
...
### Shipping AddressPhone NumberEmailPayment Information
...
### Input Data↓Stored In value↓Not textContent
...
**Which property stores user input?**
...
\`\`\`js
let name =document.getElementById("name");console.log(name.value);
\`\`\`
...
\`\`\`js
if(name.value === ""){ console.log("Required");}
\`\`\`
...
\`\`\`js
if(username.value === ""){ error.textContent = "Username Required";}
\`\`\`

### Problem 2

\`\`\`js
if(password.value.length < 6){ error.textContent = "Password Too Short";}
\`\`\`

### Problem 3

\`\`\`js
if( name.value === "" || email.value === "" || password.value === ""){ error.textContent = "All Fields Required";}
\`\`\`

## PART 5 — Advanced JavaScript`,
    },
    {
      slug: "chapter-28-execution-context",
      title: "Execution Context",
      summary: "When you write JavaScript code, it may look simple: You might think JavaScript reads the first line, then the second line, then the third line, and so on. But internally, JavaScript does much more work before it starts executing code. Before any code runs,…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 27,
      tags: "global-execution-context,function-execution-context,creation-phase,execution-phase,memory-component,code-component,memory-allocation,javascript-engine",
...
\`\`\`js
let name = "Kamraan";function greet() { console.log("Hello");}greet();
\`\`\`
...
Which variable belongs whereWhich function is currently runningWhere to store dataWhat should execute next

Execution Context is one of the most important concepts in JavaScript because many advanced topics depend on it:

ScopeHoistingClosuresCall StackFunctionsMemory Management
...
Students must sitAttendance must be takenBooks must be arrangedBoard must be prepared
...
Execution Context=A container where JavaScript stores information needed to run code

## Visual Diagram

JavaScript Code ↓Execution Context Created ↓Memory Prepared ↓Code Executes ↓Result Produced
...
\`\`\`js
let username = "Kamraan";console.log(username);
\`\`\`
...
### username↓Memory Allocated↓Value Stored↓Output Displayed
...
### Global Execution Context↓Created Automatically

## Example

\`\`\`js
let name = "Kamraan";let age = 24;
\`\`\`
...
### Program Starts ↓Global Execution Context ↓Execute Global Code
...
### Global VariablesGlobal FunctionsGlobal ObjectsExecution Information
...
Global Context ↓greet() ↓Function Context Created ↓Execute Function ↓Function Context Destroyed
...
### Temporary Meeting Room↓Function Context
...
### Function Context↓Created↓Used↓Destroyed

## Phases of Execution Context

Every execution context has two phases.

### Creation Phase2. Execution Phase
...
### VariablesFunctionsMemory

## Example

\`\`\`js
let name = "Kamraan";function greet() {}
\`\`\`

### During Creation Phase:

### Variable CreatedFunction CreatedMemory Allocated

## Visual Diagram

### Creation Phase ↓Scan Code ↓Allocate Memory ↓Store Functions ↓Ready For Execution
...
### Variables↓Memory ReservedFunctions↓Entire Function Stored
...
### Line 1↓Store "Kamraan"↓Line 2↓Display "Kamraan"

## Visual Diagram

### Creation Phase ↓Execution Phase ↓Code Runs

## Complete Example

\`\`\`js
let a = 10;let b = 20;let total = a + b;console.log(total);
\`\`\`
...
\`\`\`js
function greet() { let message = "Hello"; console.log(message);}greet();
\`\`\`
...
Global Context ↓Call greet() ↓Function Context Created ↓Execute Function ↓Display Output ↓Context Destroyed
...
### Global Context↓first() Context↓Destroy↓second() Context↓Destroy
...
\`\`\`js
let x = 10;function test() { let y = 20;}test();
\`\`\`

### JavaScript process:

Create Global Context ↓Creation Phase ↓Execution Phase ↓Call test() ↓Create Function Context ↓Creation Phase ↓Execution Phase ↓Destroy Function Context ↓Program Continues
...
### ClosuresHoistingCall StackScope Chainthis Keyword
...
- Closures, hoisting, and call stack depend on execution contexts.`,
    ...
    {
      slug: "chapter-29-call-stack",
      title: "Call Stack",
      summary: "In the previous chapter, we learned about: Execution Context We learned that: Every Function Call↓Creates A New Execution Context But a very important question remains: If Multiple Functions Are Called,How Does JavaScript KnowWhich Function Should Run…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 28,
      tags: "stack,lifo,push,pop,execution-context,function-call,nested-function,recursion,stack-overflow",
...
If Multiple Functions Are Called,How Does JavaScript KnowWhich Function Should Run First?Which Function Should Finish First?Where Are Execution Contexts Stored?
...
Functions Could Not Execute ProperlyExecution Contexts Could Not Be ManagedJavaScript Would Not Know What To Execute Next

Understanding the Call Stack helps explain:

Function ExecutionNested FunctionsRecursionStack Overflow ErrorsJavaScript Program Flow
...
### Check AttendanceTeach LessonGive HomeworkEnd Class

The tasks must happen in order.

### The teacher needs a system to remember:

### Current TaskNext TaskCompleted Tasks

### Similarly, JavaScript needs a system to track:

### Currently Running FunctionWaiting FunctionsCompleted Functions
...
### Call Stack=A stack that keeps track of function execution

## Visual Diagram

### Function Calls↓Added To Stack↓Executed↓Removed From Stack
...
### TopPlate 3Plate 2Plate 1Bottom

### Removal:

### Plate 3 Removed First↓Plate 2↓Plate 1
...
### Execution Context Created↓Placed On Call Stack

### When the function finishes:

### Execution Context Removed↓Removed From Call Stack

## Visual Diagram

### Function Call↓Execution Context↓Push To Stack↓Execute↓Pop From Stack
...
### Global Context↓greet()↓Execute↓Remove greet()↓End Program
...
\`\`\`js
function first() { second();}function second() { console.log("Hello");}first();
\`\`\`
...
Global↓first()↓second()↓Execute second()↓Remove second()↓Remove first()↓Program Continues

## More Complex Example

\`\`\`js
function one() { two();}function two() { three();}function three() { console.log("JavaScript");}one();
\`\`\`
...
### three() Executes↓Removed↓two() Removed↓one() Removed↓Global Continues

## Real-Life Analogy

Imagine calling friends.

### You Call Friend A↓Friend A Calls Friend B↓Friend B Calls Friend C

Friend C finishes first.

### Then:

### Friend B Finishes↓Friend A Finishes
...
\`\`\`js
function calculate() { let result = add();}function add() { return 10 + 20;}calculate();
\`\`\`

## Stack Behavior

### Global↓calculate()↓add()↓Return 30↓Remove add()↓Remove calculate()

## Why the Call Stack Is Important

### Without the Call Stack:

JavaScript Would Not KnowWhich Function Is RunningWhich Function Called Another FunctionWhere To Return After Completion
...
### Loops≠New Execution Contexts

## Functions

### Functions=New Execution Contexts
...
### test()↓test()↓test()↓test()↓test()↓Forever
...
### Stack Full↓No Space Left↓Stack Overflow Error
...
\`\`\`js
function count(number){ if(number === 0){ return; } count(number - 1);}count(5);
\`\`\`

### Eventually:

### number becomes 0↓Function Stops↓Stack Empties
...
Global Context Created↓Push Global Context↓Call greet()↓Push greet()↓Execute greet()↓Pop greet()↓Pop Global Context↓Program Ends
...
### Call Stack ExecutesOne Context At A Time
...
\`\`\`js
function one(){ two();}function two(){ three();}function three(){ console.log("Done");}one();
\`\`\`

### Identify:

### Order Of Function CallsOrder Of Function Removal

## Real-World Scenario

### Applications such as:

### Google DocsFacebookYouTubeNetflixAmazon
...
\`\`\`js
function test(num){ if(num === 0){ return; } test(num - 1);}
\`\`\`
...
- Call Stack and Execution Context work together.`,
    ...
    {
      slug: "chapter-30-hoisting",
      title: "Hoisting",
      summary: "Have you ever seen code like this? Many beginners expect an error because: name is used before it is declared. But surprisingly, JavaScript outputs: undefined Why does this happen? The answer is: Hoisting is one of the most misunderstood concepts in…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 29,
      tags: "variable-hoisting,function-hoisting,creation-phase,execution-phase,temporal-dead-zone-tdz,function-declaration,function-expression,initialization,memory-allocation",
...
\`\`\`js
console.log(name);var name = "Kamraan";
\`\`\`
...
Execution ContextCreation PhaseMemory Allocation
...
### Variables Are RegisteredFunctions Are RegisteredMemory Is Allocated
...
Hoisting=JavaScript's behavior of moving declarations to memory before code execution.

### Important:

### Declarations Are HoistedAssignments Are Not

## Visual Diagram

### Creation Phase↓Variables Stored↓Functions Stored↓Execution Phase↓Code Runs
...
### Student Names Registered↓Seats Assigned↓Class Begins

### Similarly:

### Variables Registered↓Functions Registered↓Execution Begins
...
\`\`\`js
var name;console.log(name);name = "Kamraan";
\`\`\`

### Important:

### This Is A Conceptual ExplanationJavaScript Does Not Literally Rewrite Your Code

## Another Example

\`\`\`js
console.log(age);var age = 24;
\`\`\`
...
### Display undefined↓Assign 24

## Visual Flow

\`\`\`js
Creation Phase↓age = undefined↓Execution Phase↓console.log(age)↓undefined↓age = 24
\`\`\`
...
\`\`\`js
console.log(city);let city = "Srinagar";
\`\`\`
...
\`\`\`js
let Is HoistedBUTCannot Be Accessed Before Initialization
\`\`\`
...
\`\`\`js
console.log(country);const country = "India";
\`\`\`
...
\`\`\`js
const Is HoistedBUTCannot Be Used Before Initialization
\`\`\`
...
Creation Phase↓Store Entire Function↓Execution Phase↓Function Can Be Called Anywhere
...
\`\`\`js
startApplication();function startApplication(){ console.log("App Started");}
\`\`\`
...
### Creation Phasegreet → undefined

### Execution Phasegreet()↓undefined()↓Error
...
\`\`\`js
show();const show = () => { console.log("Hello");};
\`\`\`
...
### Variable CreationandVariable Initialization

during which the variable cannot be accessed.

## Visual Diagram

Program Starts↓Variable Created↓Temporal Dead Zone↓Initialization↓Variable Usable

## Example

\`\`\`js
console.log(name);let name = "Kamraan";
\`\`\`

## Timeline

\`\`\`js
Program Starts↓name Created↓TDZ↓console.log(name)↓Error↓name = "Kamraan"
\`\`\`
...
### Variables Could Accidentally Be UsedBefore Initialization
...
### Variables RegisteredFunctions RegisteredMemory Allocated

This is exactly where hoisting occurs.

## Visual Connection

### Execution Context↓Creation Phase↓Hoisting Happens↓Execution Phase↓Code Runs

## Practical Example

\`\`\`js
console.log(price);var price = 500;
\`\`\`
...
\`\`\`js
initializeStore();function initializeStore(){ console.log("Store Ready");}
\`\`\`
...
\`\`\`js
console.log(user);var user = "Kamraan";
\`\`\`

### Process:

\`\`\`js
Create Global Context↓Creation Phase↓user = undefined↓Execution Phase↓console.log(user)↓undefined↓user = "Kamraan"
\`\`\`
...
Debug FasterUnderstand Execution OrderAvoid Initialization BugsWrite Reliable Code
...
\`\`\`js
const show = () => { console.log("Hello");};show();
\`\`\`
...
- TDZ prevents accidental early access to variables.`,
    ...
    {
      slug: "chapter-31-closures",
      title: "Closures",
      summary: "Closures are one of the most powerful and important features of JavaScript. They are used extensively in: ReactNode.jsEvent HandlersCallbacksTimersModulesLibrariesFrameworks Many developers can write JavaScript for years without fully understanding closures.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 30,
...
ReactNode.jsEvent HandlersCallbacksTimersModulesLibrariesFrameworks
...
Execution ContextFunction ExecutionScopeLexical Environment
...
\`\`\`js
function test() { let message = "Hello";}
\`\`\`

### Normally, when the function finishes:

### Execution Context Destroyed↓Variables Removed
...
A Closure Allows A Function To Remember VariablesFrom Its Outer Scope Even After The Outer Function Has Finished Executing.
...
### School Closed↓Information Lost

But suppose the student carries a notebook.

### School Closed↓Notebook Still Exists↓Information Preserved

Closures work similarly.

### Even when the outer function finishes:

### Variables Remain Available↓Through The Closure
...
\`\`\`js
let globalVariable = "Global";function outer() { let outerVariable = "Outer"; function inner() { let innerVariable = "Inner"; }}
\`\`\`

## Visual Diagram

Global Scope│├── globalVariable│└── outer() │ ├── outerVariable │ └── inner() │ └── innerVariable
...
\`\`\`js
let name = "Kamraan";function greet() { console.log(name);}greet();
\`\`\`
...
greet()↓Cannot Find name Inside Function↓Looks In Outer Scope↓Finds name↓Uses Value
...
\`\`\`js
function outer() { let message = "Hello"; function inner() { console.log(message); } return inner;}let myFunction = outer();myFunction();
\`\`\`
...
### outer()↓Finishes Execution↓Execution Context Removed
...
outer()↓message = "Hello"↓return inner↓outer() Ends↓Closure Preserves message↓inner()↓Hello

## Important Rule

### A closure remembers:

### VariablesFunctionsParameters
...
\`\`\`js
function createUser() { let username = "Kamraan"; return function() { console.log(username); };}let user = createUser();
\`\`\`
...
### username↓Still Exists In Memory

because the closure needs it.

## Visual Diagram

### Outer Function Ends↓Closure Exists↓Memory Retained↓Variables Still Accessible
...
\`\`\`js
function counter() { let count = 0; return function() { count++; console.log(count); };}let increment = counter();
\`\`\`
...
### Closure↓Remembers count↓Even After counter() Ends

## Visual Diagram

counter()↓count = 0↓Return Function↓Closure Created↓count Preserved↓increment()↓count Increases
...
\`\`\`js
function bankAccount() { let balance = 1000; return function() { console.log(balance); };}let account = bankAccount();
\`\`\`
...
\`\`\`js
function createCounter() { let clicks = 0; return function() { clicks++; console.log( \`Clicks: \${clicks}\` ); };}
\`\`\`

### Usage:

\`\`\`js
let buttonCounter =createCounter();buttonCounter();buttonCounter();buttonCounter();
\`\`\`

### Output:

### Clicks: 1Clicks: 2Clicks: 3
...
\`\`\`js
function setupButton() { let clicks = 0; return function() { clicks++; console.log(clicks); };}
\`\`\`
...
\`\`\`js
function timerMessage() { let message = "Time Finished"; setTimeout(function(){ console.log(message); }, 3000);}timerMessage();
\`\`\`
...
Create outer()↓x = 10↓Create Inner Function↓Return Inner Function↓Outer Finishes↓Closure Stores x↓Inner Function Executes↓Uses x

## Visual Diagram

Outer Function↓Variable Created↓Inner Function Created↓Closure Formed↓Outer Ends↓Variable Preserved↓Inner Uses Variable
...
### Outer Function Ends↓Variables Gone

### Reality:

### Closure Exists↓Variables Stay In Memory
...
### Function+Remembered Environment
...
React HooksEvent HandlersAPI WrappersAuthentication SystemsState ManagementCaching SystemsModules
...
\`\`\`js
function outer() { let count = 5; return function() { console.log(count); };}let show = outer();show();
\`\`\`
...
\`\`\`js
function test() { let value = 100; return function() { console.log(value); };}
\`\`\`
...
### Closure Created↓value Retained In Memory↓Inner Function Still Needs It
...
- Understanding closures is essential for advanced JavaScript development.`,
    ...
    {
      slug: "chapter-32-higher-order-functions",
      title: "Higher Order Functions",
      summary: "So far, we have learned that JavaScript functions are very powerful. A function can: Accept InputReturn OutputCall Other FunctionsCreate Closures But JavaScript takes functions one step further. In JavaScript: Functions Can Be Stored In VariablesFunctions Can…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 31,
...
Accept InputReturn OutputCall Other FunctionsCreate Closures

But JavaScript takes functions one step further.

In JavaScript:

Functions Can Be Stored In VariablesFunctions Can Be Passed To Other FunctionsFunctions Can Be Returned From Functions
...
ReactNode.jsArray MethodsFunctional ProgrammingLibrariesFrameworks

Understanding Higher Order Functions is essential before learning:

CallbacksPromisesAsync ProgrammingReact Hooks
...
\`\`\`js
function greet() { console.log("Hello");}function goodbye() { console.log("Goodbye");}
\`\`\`
...
### Stored In VariablesPassed As ArgumentsReturned From Functions

## Example

\`\`\`js
function greet() { console.log("Hello");}let sayHello = greet;
\`\`\`

## What Happens?

### sayHello↓References greet Function
...
### greet()↓Stored In Variable↓sayHello↓Function Executed

## What Is a Higher Order Function?

### A Higher Order Function is a function that:

### Accepts Another Function As An ArgumentORReturns Another Function

Even one of these conditions is enough.

## Visual Diagram

### Function↓Receives FunctionORReturns Function↓Higher Order Function

## Example 1 — Function As Argument

\`\`\`js
function greet() { console.log("Hello");}function execute(func) { func();}execute(greet);
\`\`\`
...
### execute()↓Receives Another Function

## Visual Diagram

### greet↓Passed To execute()↓execute() Runs greet()↓Hello
...
### greet()↓Execute Function Immediately
...
\`\`\`js
function createGreeting() { return function() { console.log("Hello"); };}
\`\`\`
...
### createGreeting()↓Returns Function↓Stored In Variable↓Function Executed
...
\`\`\`js
calculate(function(){ console.log(10+20);});
\`\`\`
...
\`\`\`js
execute(function(){ console.log("Hello");});
\`\`\`
...
### Higher Order Function↓Receives Different Functions↓Performs Different Actions
...
### Functions Are CentralFunctions Are ReusedFunctions Are Combined
...
### forEach()↓Receives Another Function

## Visual Diagram

### Array↓forEach()↓Function Passed↓Function Executes For Every Element

## Example — map()

\`\`\`js
let numbers = [1,2,3];let doubled = numbers.map(function(num){ return num * 2;});
\`\`\`
...
### Reusable CodeCleaner CodeLess RepetitionBetter Readability

## Practical Example

\`\`\`js
function repeat(action){ action(); action();}
\`\`\`
...
### addEventListener()↓Receives Function↓Higher Order Function
...
### Pass Function↓Store Reference↓Call Function↓Execute Code↓Return Result
...
\`\`\`js
function greet(){ console.log("Hello");}function run(func){ func();}run(greet);
\`\`\`
...
- Understanding Higher Order Functions is important before learning callbacks and promises.`,
    ...
    {
      slug: "chapter-33-callbacks",
      title: "Callbacks",
      summary: "In the previous chapter, we learned about: Higher Order Functions We learned that functions can: Be Stored In VariablesBe Passed As ArgumentsBe Returned From Functions Now we will learn one of the most important applications of Higher Order Functions:…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 32,
...
Be Stored In VariablesBe Passed As ArgumentsBe Returned From Functions
...
Event HandlingTimersAPI CallsPromisesAsync/AwaitReactNode.js
...
A Callback Is A Function Passed As An ArgumentTo Another Function.

## Visual Diagram

### Function A↓Receives Function B↓Function B Executes Later↓Callback
...
\`\`\`js
function greet() { console.log("Hello");}function execute(callback) { callback();}execute(greet);
\`\`\`
...
### greet↓Passed To Another Function↓Executed Later

## Visual Diagram

### greet↓Passed To execute()↓Stored As callback↓callback()↓Hello
...
### Create Function↓Pass Function↓Receive Function↓Execute Function↓Output Produced
...
\`\`\`js
function showGreeting() { console.log("Hello");}
\`\`\`
...
\`\`\`js
execute(function(){ console.log("Good Morning");});
\`\`\`
...
### execute()↓callback()↓Immediate Execution↓Output
...
### forEach()↓Immediately Executes Callback

for every element.

## Visual Diagram

### → callback()2 → callback()3 → callback()
...
### Program Starts↓Wait 3 Seconds↓Execute Callback↓Display Hello
...
### setTimeout()↓Store Callback↓Wait↓Execute Callback Later

## Another Example

\`\`\`js
console.log("Start");setTimeout(function(){ console.log("Middle");}, 2000);console.log("End");
\`\`\`
...
### setTimeout Callback↓Scheduled↓Runs Later

## Execution Flow

### Display Start↓Register Callback↓Display End↓Wait 2 Seconds↓Display Middle

## Real-Life Analogy

Imagine ordering pizza.

### Order Pizza↓Continue Watching TV↓Pizza Arrives Later↓Receive Pizza

You do not stop everything and wait.

### Similarly:

### JavaScript Continues Running↓Callback Executes Later
...
### Callback Waits↓User Clicks↓Callback Executes

## Visual Diagram

### Register Callback↓Wait For Click↓Click Happens↓Run Callback
...
\`\`\`js
function execute(first, second){ first(); second();}
\`\`\`

### Usage:

\`\`\`js
execute( function(){ console.log("One"); }, function(){ console.log("Two"); });
\`\`\`
...
### Hard To ReadHard To DebugHard To Maintain
...
Register Callback↓Wait 3 Seconds↓Move Callback To Call Stack↓Execute Callback↓Display Hello
...
Button Click EventsForm SubmissionsAPI RequestsDatabase OperationsTimersAnimations
...
- Modern JavaScript relies heavily on callback patterns.`,
    ...
    {
      slug: "chapter-34-promises",
      title: "Promises",
      summary: "In the previous chapter, we learned about: Callbacks Callbacks allow functions to execute later. Example: Callbacks are useful, but when applications become larger, they can create a problem called: Callback Hell Example: This code becomes: Difficult To…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 33,
...
\`\`\`js
login(function(){ getUser(function(){ getOrders(function(){ processPayment(function(){ sendEmail(function(){ }); }); }); });});
\`\`\`

This code becomes:

Difficult To ReadDifficult To MaintainDifficult To Debug
...
API CallsDatabase OperationsFile HandlingAuthenticationModern FrameworksReact Applications
...
### Order Placed↓Wait↓Food Arrives
...
A Promise Is An Object That RepresentsThe Eventual Completion Or FailureOf An Asynchronous Operation.

### Beginner-friendly definition:

A Promise Is A PlaceholderFor A Future Result.

## Visual Diagram

### Start Task↓Waiting↓Success OR Failure↓Result Returned
...
### Delivered SuccessfullyORDelivery Failed
...
### Pending↓Fulfilled↓Result Available
...
### Pending↓Rejected↓Error Returned

## Complete Promise Lifecycle

### Promise Created↓Pending↓Success → FulfilledORFailure → Rejected
...
### Promise Created↓resolve() Called↓Promise Fulfilled↓Result = "Success"
...
\`\`\`js
let promise = new Promise( function(resolve, reject){ resolve("Data Loaded"); });promise.then(function(result){ console.log(result);});
\`\`\`
...
### Create Promise↓resolve()↓Promise Fulfilled↓then() Executes↓Display Result
...
\`\`\`js
let promise = new Promise( function(resolve, reject){ reject("Something Went Wrong"); });
\`\`\`

## What Happens?

### Promise Created↓reject()↓Promise Rejected
...
\`\`\`js
let promise = new Promise( function(resolve, reject){ reject("Error"); });promise.catch(function(error){ console.log(error);});
\`\`\`
...
### Promise↓reject()↓Rejected↓catch()↓Display Error
...
\`\`\`js
let promise = new Promise( function(resolve, reject){ resolve("Success"); });promise.then(function(result){ console.log(result);}).catch(function(error){ console.log(error);});
\`\`\`
...
\`\`\`js
let promise = new Promise( function(resolve, reject){ resolve("Done"); });promise.then(function(result){ console.log(result);}).finally(function(){ console.log("Finished");});
\`\`\`
...
Hide Loading SpinnerClose Database ConnectionCleanup ResourcesStop Loading Animation

## Visual Diagram

### Promise↓Success OR Failure↓finally()↓Cleanup
...
\`\`\`js
let download = new Promise( function(resolve){ setTimeout(function(){ resolve("File Downloaded"); }, 3000); });
\`\`\`

## Handling Result

\`\`\`js
download.then(function(result){ console.log(result);});
\`\`\`
...
### Create Promise↓Pending↓Wait 3 Seconds↓resolve()↓Fulfilled↓then()↓Display Result
...
\`\`\`js
Promise.resolve(10).then(function(num){ return num * 2;}).then(function(result){ console.log(result);});
\`\`\`
...
### 10↓Multiply By 2↓20↓Display

## Why Promise Chaining Is Useful

### Instead of:

### Callback Inside CallbackInside CallbackInside Callback
...
\`\`\`js
login(function(){ getUser(function(){ getOrders(function(){ }); });});
\`\`\`

### Promise Style:

\`\`\`js
login().then(getUser).then(getOrders).catch(handleError);
\`\`\`

## Comparison

### Callbacks↓Nested↓Harder To Read

### Promises↓Linear↓Easier To Read
...
### Promise Created↓Pending↓resolve()↓Fulfilled↓Store Data↓then()↓Use Data
...
\`\`\`js
let promise = new Promise( function(resolve){ resolve("JavaScript"); });promise.then(function(result){ console.log(result);});
\`\`\`
...
### Send Login Request↓Wait For Server↓Receive Response↓Show Dashboard
...
- Promises improve asynchronous code structure and readability.`,
    ...
    {
      slug: "chapter-35-async-await",
      title: "Async/Await",
      summary: "In the previous chapter, we learned about: Promises Promises improved asynchronous programming and helped solve callback hell. Example: This is much better than deeply nested callbacks. However, when applications become larger, even Promise chains can become…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 34,
...
\`\`\`js
fetchData().then(function(data){ return processData(data);}).then(function(result){ console.log(result);}).catch(function(error){ console.log(error);});
\`\`\`
...
APIsDatabasesFile OperationsAuthenticationNetwork Requests
...
\`\`\`js
getUser().then(function(user){ return getOrders(user);}).then(function(orders){ return processOrders(orders);}).then(function(result){ console.log(result);});
\`\`\`
...
### Code Becomes LongerCode Becomes Harder To Follow
...
\`\`\`js
let data = await fetchData();console.log(data);
\`\`\`
...
### awaitCan Only Be UsedInside Async Functions
...
### Async Function↓Returns Promise↓Result Available Later
...
### Promise Starts↓await↓Wait↓Promise Finishes↓Continue Execution

## Example Using Promise

\`\`\`js
let promise =Promise.resolve("JavaScript");
\`\`\`

\`\`\`js
async function show(){ let result = await promise; console.log(result);}show();
\`\`\`
...
### Place Order↓Keep Checking Constantly

### With await:

### Place Order↓Wait↓Food Arrives↓Continue
...
\`\`\`js
function getData(){ return new Promise( function(resolve){ setTimeout(function(){ resolve("Data Loaded"); }, 3000); } );}
\`\`\`

## Using await

\`\`\`js
async function loadData(){ let data = await getData(); console.log(data);}loadData();
\`\`\`
...
Call getData()↓Promise Pending↓await↓Wait 3 Seconds↓Promise Fulfilled↓Continue Execution
...
\`\`\`js
async function process(){ let user = await getUser(); let orders = await getOrders(); console.log(user); console.log(orders);}
\`\`\`

## Execution Flow

### Wait For User↓User Received↓Wait For Orders↓Orders Received↓Display Results
...
\`\`\`js
getUser().then(function(user){ return getOrders(user);}).then(function(orders){ console.log(orders);});
\`\`\`

### Async/Await Version:

\`\`\`js
async function run(){ let user = await getUser(); let orders = await getOrders(user); console.log(orders);}
\`\`\`
...
### Async/Await↓Step-By-Step Style
...
\`\`\`js
async function test(){ try{ let result = await Promise.reject( "Error" ); } catch(error){ console.log(error); }}test();
\`\`\`
...
### Promise Rejected↓catch Error↓Display Error
...
### Error Controlled↓Application Continues

## Complete Example

\`\`\`js
async function getUserData(){ try{ let user = await Promise.resolve( "Kamraan" ); console.log(user); } catch(error){ console.log(error); }}
\`\`\`
...
\`\`\`js
async function add(){ return 10 + 20;}
\`\`\`
...
\`\`\`js
add().then(function(result){ console.log(result);});
\`\`\`
...
\`\`\`js
async function test(){ let data = await getData();}
\`\`\`

### Process:

Call Async Function↓Create Promise↓Execute Function↓Reach await↓Pause Function↓Wait For Promise↓Resume Function↓Continue Execution
...
\`\`\`js
async function load(){ let data = await getData();}
\`\`\`
...
### await PausesOnly The Current Async Function
...
\`\`\`js
async function test(){ let result = await Promise.resolve( "Hello" ); console.log(result);}test();
\`\`\`
...
### Send Login Request↓Wait For Server↓Receive Response↓Load Dashboard
...
### await is only validinside async functions

### Solution:

\`\`\`js
async function load(){ await getData();}
\`\`\`
...
- Modern JavaScript development heavily uses Async/Await.`,
    ...
    {
      slug: "chapter-36-error-handling",
      title: "Error Handling",
      summary: "No matter how carefully we write code, errors will happen. Examples: Output: ReferenceError:userName is not defined Output: TypeError:num.toUpperCase is not a function Output: SyntaxError:Unexpected end of JSON input Errors are a normal part of programming.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 35,
...
Detect Errors↓Handle Errors↓Recover Gracefully

JavaScript provides special tools for this:

trycatchthrowfinallyCustom Errors
...
### Transfer Request↓Network Failure↓Application Crashes

Bad experience.

### Instead:

### Transfer Request↓Network Failure↓Error Handled↓User Sees Friendly Message
...
### Invalid VariableInvalid SyntaxInvalid DataNetwork FailureMissing FileAPI Failure

## Visual Diagram

### Program Running↓Error Occurs↓Error Detected↓Handle Error↓Program Continues

## Types of JavaScript Errors

### Common error types:

### SyntaxErrorReferenceErrorTypeErrorRangeErrorCustom Error
...
### try↓Error Occurs↓catch↓Handle Error
...
### try↓ReferenceError↓catch↓Display Message
...
\`\`\`js
try { console.log(userName);}catch(error){ console.log(error);}
\`\`\`
...
### Error NameError MessageStack Trace
...
\`\`\`js
try { console.log(userName);}catch(error){ console.log(error.name);}
\`\`\`
...
\`\`\`js
try { console.log(userName);}catch(error){ console.log(error.message);}
\`\`\`
...
\`\`\`js
try { console.log("Running");}catch(error){ console.log(error);}finally { console.log("Finished");}
\`\`\`
...
### Closing FilesDisconnecting DatabasesStopping LoadersCleaning Resources

## Visual Diagram

### try↓Success OR Error↓finally↓Cleanup
...
\`\`\`js
let age = 15;if(age < 18){ throw "Age Must Be 18+";}
\`\`\`
...
\`\`\`js
try { let age = 15; if(age < 18){ throw "Age Must Be 18+"; }}catch(error){ console.log(error);}
\`\`\`
...
### Condition Checked↓Invalid↓throw↓catch↓Display Error
...
### NameMessageStack Trace

## Example

\`\`\`js
try { throw new Error( "Login Failed" );}catch(error){ console.log( error.message );}
\`\`\`
...
\`\`\`js
function register(age){ if(age < 18){ throw new Error( "Must Be 18 Or Older" ); } console.log( "Registration Successful" );}
\`\`\`

## Usage

\`\`\`js
try { register(15);}catch(error){ console.log( error.message );}
\`\`\`
...
### User Login↓Check Credentials↓Invalid Password?↓throw Error↓Display Message
...
\`\`\`js
async function test(){ try{ await Promise.reject( "Failed" ); } catch(error){ console.log(error); }}
\`\`\`
...
### Promise Rejected↓catch Error↓Display Error↓Program Continues
...
Run try Block↓Error Occurs↓Create Error Object↓Jump To catch↓Handle Error↓Continue Program
...
\`\`\`js
try { throw new Error( "Invalid Input" );}catch(error){ console.log( error.message );}
\`\`\`
...
Payment Request↓Payment Gateway Error↓Error Caught↓User Sees Message↓Application Continues
...
\`\`\`js
try { console.log(userName);}catch(error){ console.log( "Variable Missing" );}
\`\`\`
...
- Good error handling improves user experience and application stability.`,
    ...
    },
    {
      ...
      summary: "Chapters 37 to 48 of JavaScript.",
      order: 4,
      difficulty: "intermediate",
      estimatedMinutes: 360,
      tutorials: [
    {
      slug: "chapter-37-debugging-techniques",
      title: "Debugging Techniques",
      summary: "Writing code is only half of programming. The other half is: Finding Problems↓Understanding Problems↓Fixing Problems This process is called: Debugging Every programmer, from beginners to senior engineers, spends a significant amount of time debugging code.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 36,
...
Finding Problems↓Understanding Problems↓Fixing Problems
...
Find Mistakes↓Understand Mistakes↓Fix Mistakes Efficiently
...
### Problem Remains↓Application Broken

### With debugging:

### Find Cause↓Fix Problem↓Application Works

## What Is Debugging?

### Debugging is the process of:

### Finding Errors↓Analyzing Errors↓Fixing Errors

## Visual Diagram

### Code Written↓Bug Appears↓Debugging↓Bug Fixed↓Correct Output
...
### Syntax BugsLogic BugsRuntime BugsData Bugs
...
\`\`\`js
let price = 100;let discount = 10;let finalPrice = price + discount;
\`\`\`
...
\`\`\`js
let age = "twenty";let result = age * 2;
\`\`\`
...
### Code Doesn't Work↓Panic

### Professional developers think:

### Code Doesn't Work↓Gather Information↓Find Cause↓Fix Cause

## Step-by-Step Debugging Process

### Whenever a bug appears:

### Reproduce Problem2. Read Error Message3. Find Location4. Inspect Variables5. Test Assumptions6. Fix Problem7. Verify Solution
...
\`\`\`js
Variable↓console.log()↓Display Value↓Understand Program State
\`\`\`
...
\`\`\`js
let a = 10;let b = 20;let total = a + c;console.log(total);
\`\`\`
...
\`\`\`js
let username = "Kamraan";let age = 24;console.log(username, age);
\`\`\`
...
\`\`\`js
let score = 75;if(score > 80){ console.log("Pass");}
\`\`\`
...
\`\`\`js
function add(a,b){ console.log(a,b); return a+b;}add(10,20);
\`\`\`
...
### F12orRight Click↓Inspect

## Main DevTools Sections

### ConsoleSourcesNetworkElementsApplication
...
### Viewing LogsViewing ErrorsTesting CodeInspecting Variables
...
### Error Message↓userName is not defined
...
### VariablesFunction CallsProgram Flow

## Visual Diagram

### Program Running↓Breakpoint↓Execution Pauses↓Inspect State↓Continue

## Setting a Breakpoint

### In DevTools:

### Sources Tab↓Click Line Number↓Breakpoint Added
...
### Variable ValuesCurrent LineCall StackScope
...
\`\`\`js
let age = 24;debugger;console.log(age);
\`\`\`

### When DevTools is open:

### Execution Stops↓Debugger Activated

## Visual Diagram

### Code Runs↓debugger↓Pause↓Inspect↓Continue
...
\`\`\`js
let username = "Kamraan";let age = 24;
\`\`\`

### During a breakpoint:

### username → Kamraanage → 24
...
### Current FunctionCalling FunctionExecution Path
...
\`\`\`js
function multiply(a,b){ return a + b;}console.log( multiply(5,4));
\`\`\`
...
Reproduce Problem↓Inspect Variables↓Use Breakpoints↓Find Incorrect Calculation↓Fix Bug↓Verify Solution
...
## PART 6 — APIs and Real-World Development`,
    },
    {
      slug: "chapter-38-json",
      title: "JSON",
      summary: "Modern web applications constantly exchange data. Examples: Instagram↓Posts DataYouTube↓Video DataAmazon↓Product DataWeather App↓Weather Data But an important question arises: How Is Data Sent Between Systems? Consider: Browser↓Internet↓Server↓Database All…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 37,
      tags: "key-value-pair,json-string,json-object,json-parse,json-stringify,data-exchange,api-response,nested-json,json-array",
...
Instagram↓Posts DataYouTube↓Video DataAmazon↓Product DataWeather App↓Weather Data
...
APIsReactNode.jsDatabasesMobile AppsCloud Services

you will encounter JSON.

Understanding JSON is essential before learning:

Fetch APIREST APIsPublic APIs
...
### JSON=A Text Format Used To Store And Exchange Data

## Visual Diagram

### Application A↓JSON↓Application B

## Real-Life Analogy

Imagine a shipping label.

### NameAddressPhone NumberPackage Information
...
\`\`\`js
{ "address": { "city": "Srinagar", "country": "India" }}
\`\`\`

## Visual Diagram

### User├── name├── age├── skills└── address
...
\`\`\`js
let user = { name: "Kamraan", age: 24};let jsonData =JSON.stringify(user);console.log(jsonData);
\`\`\`
...
\`\`\`js
let jsonData ='{"name":"Kamraan","age":24}';let user =JSON.parse(jsonData);console.log(user);
\`\`\`
...
\`\`\`js
let user = { name: "Kamraan", age: 24};let json =JSON.stringify(user);let parsed =JSON.parse(json);console.log(parsed.name);
\`\`\`
...
\`\`\`js
{ "name": "Kamraan", "address": { "city": "Srinagar", "country": "India" }}
\`\`\`
...
### Object↓Convert To Text↓JSON String
...
### JSON String↓Parse Data↓Create Object
...
### Browser↓API Request↓Weather Server↓JSON Response↓JSON.parse()↓Display Weather
...
- Mastering JSON is essential for modern web development.`,
    ...
    {
      slug: "chapter-39-http-basics",
      title: "HTTP Basics",
      summary: "Every day you use websites such as: Google YouTube Amazon Facebook When you open a website, search for something, watch a video, or submit a form, data travels between your browser and a server. But how does this communication happen? The answer is: HTTP HTTP…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 38,
...
Browser Cannot Talk To ServerServer Cannot Send DataWebsites Cannot Function
...
### HTTP=A Set Of Rules That Allows BrowsersAnd Servers To Communicate
...
### Customer↓Places Order↓Restaurant↓Prepares Food↓Returns Food

### On the web:

### Browser↓Sends Request↓Server↓Processes Request↓Returns Response
...
### Web BrowserMobile AppDesktop App
...
### Web ServersAPI ServersDatabase Servers
...
### Show HomepageGet User DataSubmit Login FormUpload File
...
### HTML PageJSON DataImageError Message

## Visual Diagram

### Server↓Requested Data↓Browser
...
### Get User InformationGet Product ListGet Weather Data
...
### Register UserCreate AccountSubmit Form
...
### Update ProfileChange PasswordEdit Product
...
### Delete UserDelete ProductDelete Comment
...
### Content TypeAuthorizationLanguageCookies
...
\`\`\`js
{ "name": "Kamraan", "email": "kamraan@example.com"}
\`\`\`
...
### Request↓Server↓Status Code↓Response

## Common Status Codes

### 200201400401403404500
...
100-199 → Information200-299 → Success300-399 → Redirect400-499 → Client Error500-599 → Server Error

## Complete Request Lifecycle

### When a user opens a webpage:

Browser↓Create HTTP Request↓Send Request↓Server Receives Request↓Server Processes Request↓Server Creates Response↓Response Sent Back↓Browser Displays Result
...
Enter Credentials↓POST Request↓Server Validates User↓Status Code 200↓Dashboard Displayed
...
### Create New UserUpdate UserGet Product ListDelete Product
...
User Opens App↓GET Request Sent↓Weather Server Receives Request↓Weather Data Retrieved↓Status Code 200↓JSON Response Returned↓Weather Displayed
...
- Modern web applications use HTTP continuously for data exchange.`,
    ...
    {
      slug: "chapter-40-fetch-api",
      title: "Fetch API",
      summary: "In the previous chapter, we learned about: HTTPRequestsResponsesStatus Codes Now we know how browsers and servers communicate. But an important question remains: How Do We Send HTTP Requests Using JavaScript? The answer is: The Fetch API allows JavaScript to…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 39,
      tags: "http-request,http-response,get,post,promise,async-await,response-json,json-stringify,response-ok",
...
HTTPRequestsResponsesStatus Codes
...
Get Data From ServersSend Data To ServersUpdate DataDelete Data
...
### Browser↓Request Weather Data↓Server↓Return Weather Information
...
### Fetch API=A JavaScript Interface Used To SendHTTP Requests And Receive Responses

## Visual Diagram

### JavaScript↓Fetch API↓HTTP Request↓Server↓HTTP Response↓JavaScript
...
### fetch()↓Promise Returned↓Wait For Response↓Response Arrives

## First Fetch Example

\`\`\`js
fetch( "https://api.example.com").then(function(response){ console.log(response);});
\`\`\`

## What Happens?

### Send Request↓Wait For Response↓Receive Response↓Display Response Object

## Understanding Response Objects

### The response contains information such as:

### Status CodeHeadersResponse Data

### Example:

\`\`\`js
fetch(url).then(function(response){ console.log( response.status );});
\`\`\`
...
### Fetch↓GET Request↓Server↓User Data
...
\`\`\`js
fetch( "https://api.example.com/user").then(function(response){ return response.json();}).then(function(data){ console.log(data);});
\`\`\`

## Execution Flow

### Send Request↓Receive Response↓Convert JSON↓JavaScript Object↓Display Data

## Visual Diagram

### Server↓JSON↓response.json()↓JavaScript Object
...
### JSON Text↓response.json()↓JavaScript Object

## GET Request Example

\`\`\`js
fetch( "https://api.example.com/user").then(function(response){ return response.json();}).then(function(data){ console.log(data.name);});
\`\`\`
...
### Register UserSubmit FormCreate ProductCreate Account
...
### Browser↓POST Request↓Server↓Create Resource
...
\`\`\`js
fetch( "https://api.example.com/users", { method: "POST", body: JSON.stringify({ name: "Kamraan", age: 24 }) });
\`\`\`
...
\`\`\`js
fetch( "https://api.example.com/users", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name: "Kamraan", age: 24 }) });
\`\`\`

## Visual Diagram

### JavaScript Object↓JSON.stringify()↓POST Request↓Server
...
\`\`\`js
async function getUser(){ let response = await fetch( "https://api.example.com/user" ); let data = await response.json(); console.log(data);}
\`\`\`

## Execution Flow

### Send Request↓Wait↓Receive Response↓Convert JSON↓Display Data
...
### Internet DisconnectedServer DownWrong URLInvalid API Key

## Error Handling with try...catch

\`\`\`js
async function getData(){ try{ let response = await fetch(url); let data = await response.json(); console.log(data); } catch(error){ console.log( error ); }}
\`\`\`

## Visual Diagram

### Request↓Success?↓Yes → Display Data↓No → catch()
...
\`\`\`js
async function getData(){ try{ let response = await fetch(url); if(!response.ok){ throw new Error( "Request Failed" ); } let data = await response.json(); console.log(data); } catch(error){ console.log( error.message ); }}
\`\`\`
...
### User Opens App↓Fetch Request↓Weather Server↓JSON Response↓Display Temperature

## Real-World Example

### Movie Search App

### User Searches Movie↓Fetch Request↓Movie API↓Movie Data↓Display Results
...
Create HTTP Request↓Send Request↓Server Receives Request↓Server Sends Response↓Promise Resolved↓JavaScript Receives Data
...
\`\`\`js
body: JSON.stringify({ name: "Kamraan"})
\`\`\`
...
### Gets User DataConverts JSONDisplays User Name
...
User Opens App↓Fetch Posts↓Server Returns JSON↓Convert Data↓Render Posts On Screen
...
- Proper error handling improves application reliability.`,
    ...
    {
      slug: "chapter-41-rest-apis",
      title: "REST APIs",
      summary: "In the previous chapters, we learned: HTTPRequestsResponsesFetch API Now we are ready to understand one of the most important concepts in modern web development: Almost every modern application uses REST APIs. Examples: Facebook Instagram Netflix YouTube…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 40,
...
HTTPRequestsResponsesFetch API
...
LoginView PostsSearch VideosAdd Products To CartPlace Orders

REST APIs are often working behind the scenes.

Understanding REST APIs is essential before working with:

ReactNode.jsBackend DevelopmentFull-Stack Development
...
### BooksAuthorsCategoriesMembers

### You need a structured way to:

### Add BooksRead BooksUpdate BooksDelete Books

Similarly, applications contain data.

### Examples:

### UsersProductsOrdersPostsComments
...
### API=A Bridge That AllowsDifferent Software SystemsTo Communicate
...
### Customer↓Order↓Waiter↓Kitchen↓Food↓Waiter↓Customer
...
### REST=A Set Of RulesFor Designing Web APIs

## Why REST Is Popular

### REST provides:

### ConsistencySimplicityScalabilityFlexibility
...
### REST API=An API That FollowsREST Principles
...
### UsersProductsOrdersCommentsPosts

## Visual Diagram

### Application├── Users├── Products├── Orders└── Reviews
...
### /users/products/orders/comments

## Visual Diagram

### API├── /users├── /products├── /orders└── /comments
...
Browser↓GET /users/1↓Server↓Database↓User Data Found↓JSON Response↓Browser Displays Profile

## REST Response Example

\`\`\`js
{ "id": 1, "name": "Kamraan", "city": "Srinagar"}
\`\`\`
...
### Easy To ReadEasy To ParseLanguage Independent
...
### GET /productsPOST /ordersPUT /customers/5DELETE /reviews/3
...
### GET /postsPOST /commentsPUT /users/10DELETE /messages/8
...
\`\`\`js
async function getUsers(){ let response = await fetch( "https://api.example.com/users" ); let data = await response.json(); console.log(data);}
\`\`\`
...
Client Sends Request↓Server Receives Request↓Database Query↓JSON Created↓Response Sent↓Client Displays Data
...
### /getProducts/listUsers/createOrder
...
### Create ProductRead ProductUpdate ProductDelete Product
...
User Opens Products Page↓GET /products↓Server Returns Products↓User Adds Product↓POST /cart↓Server Updates Cart↓User Places Order↓POST /orders↓Order Created
...
- Understanding REST is essential for frontend and backend development.`,
    ...
    {
      slug: "chapter-42-working-with-public-apis",
      title: "Working with Public APIs",
      summary: "In the previous chapter, we learned about: REST APIsResourcesEndpointsCRUD Operations Now we will learn how to work with real APIs available on the internet. These APIs are called: Public APIs Public APIs allow developers to use data and services created by…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 41,
      ...
      selfAssessment: [],
      content: `# Working with Public APIs

## Chapter Introduction

In the previous chapter, we learned about:

REST APIsResourcesEndpointsCRUD Operations
...
Weather InformationMovie InformationNews ArticlesMapsCurrency Exchange RatesSports Scores
...
### TemperatureHumidityWind SpeedForecast Data

Collecting weather information from around the world would be extremely difficult.

### Instead:

### Weather Company↓Provides API↓Your App Uses API↓Displays Weather
...
### Public API=An API Available For DevelopersTo Access Over The Internet

## Visual Diagram

### Your Application↓Public API↓Server↓Data
...
### Library Stores Books↓You Borrow Books↓Use Information

### Similarly:

### API Stores Data↓Application Requests Data↓Uses Information

## Examples of Public APIs

### Popular categories:

### Weather APIsMovie APIsNews APIsSports APIsMaps APIsCurrency APIs
...
### Connecting Your Application↓To An External API

## Visual Diagram

### Your Website↓API Request↓Public API↓Response Data↓Display Result

## Example

### Movie Search Application:

### User Searches Movie↓API Request↓Movie API↓Movie Data↓Display Movies
...
Available EndpointsRequest MethodsRequired ParametersResponse FormatAuthentication Rules

## Why Documentation Matters

### Without documentation:

### You Don't KnowWhere To Send RequestsWhat Data To SendWhat Data Will Return

Documentation acts as a guide.

## Visual Diagram

### Developer↓Documentation↓Correct API Usage
...
### API Key=A Unique IdentifierUsed To Identify Applications
...
### Application↓API Key↓API Server↓Access Allowed
...
### Identify UsersTrack UsageLimit AbuseProtect Resources
...
### Application↓Request + API Key↓Accepted

## Example Request

\`\`\`js
fetch("https://api.example.com/data?apikey=123");
\`\`\`
...
### Browser↓Fetch Request↓API Server↓JSON Response↓Browser
...
\`\`\`js
async function getWeather(){ let response = await fetch( "https://api.example.com/weather" ); let data = await response.json(); console.log( data.temperature );}
\`\`\`

## Visual Diagram

### API Request↓JSON Response↓JavaScript Object↓Display Data

## Weather App Example

### Flow:

### User Opens App↓Fetch Weather Data↓Weather API↓JSON Response↓Display Temperature

## Movie Search Example

### Flow:

### User Searches Movie↓Fetch Request↓Movie API↓Movie Information↓Display Results
...
### Search TermCity NameDate Range

### Example URL:

\`\`\`js
https://api.example.com/weather?city=Srinagar
\`\`\`
...
### Base URL+Parameter↓Specific Data
...
### Wrong URLInvalid API KeyNo InternetServer Failure

## Example

\`\`\`js
try{ let response = await fetch(url);}catch(error){ console.log(error);}
\`\`\`
...
### User Action↓Fetch Request↓API Server↓Database↓JSON Response↓Display Data
...
Create Request↓Send To API↓API Processes Request↓Generate JSON↓Send Response↓Convert To Object↓Display Data
...
### Fetches Weather DataConverts JSONDisplays City NameDisplays Temperature
...
### User Enters City↓Fetch Request↓Weather API↓Weather Data↓Display Forecast
...
- Public APIs are widely used in real-world web applications.`,
    ...
    {
      slug: "chapter-43-local-storage",
      title: "Local Storage",
      summary: "Imagine you are using a website. You: Add Items To CartChange ThemeSave NotesRemember Login Settings Now imagine you refresh the page. Everything disappears. That would be frustrating. Web applications need a way to store information inside the browser.…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 42,
      tags: "setitem,getitem,removeitem,clear,json-stringify,json-parse,browser-storage,key-value-pair,persistent-storage",
...
Add Items To CartChange ThemeSave NotesRemember Login Settings
...
Page RefreshBrowser RestartComputer Restart

Many modern applications use Local Storage for:

Dark Mode SettingsShopping CartsUser PreferencesDraft NotesOffline Data
...
### Learn JavaScriptPractice ArraysBuild Projects
...
### Refresh↓Notes Still Available

## What Is Local Storage?

### Simple definition:

### Local Storage=A Browser Storage SystemUsed To Save Data Permanently

## Visual Diagram

### Website↓Local Storage↓Browser Storage
...
### Website↓Store Data↓Close Browser↓Open Browser↓Data Still Exists
...
### Browser├── Cookies├── Session Storage└── Local Storage

## Important Characteristics

### Local Storage:

Stores Data As StringsPersists After RefreshPersists After Browser RestartPersists Until Removed
...
\`\`\`js
localStorage.setItem( "name", "Kamraan");
\`\`\`
...
### Local Storage↓Find "name"↓Return Value↓Kamraan
...
\`\`\`js
let city =localStorage.getItem( "city");console.log(city);
\`\`\`
...
### Local Storage↓Remove Item↓Item Gone
...
### Local Storage├── name├── city├── theme↓clear()↓Empty Storage
...
### Number↓Convert To String↓Store
...
\`\`\`js
let user = { name: "Kamraan"};localStorage.setItem( "user", user);
\`\`\`
...
\`\`\`js
let user = { name: "Kamraan", age: 24};localStorage.setItem( "user", JSON.stringify(user));
\`\`\`
...
\`\`\`js
let user = JSON.parse( localStorage.getItem( "user" ));console.log(user.name);
\`\`\`
...
\`\`\`js
let userData =JSON.parse( localStorage.getItem( "user" ));console.log( userData.age);
\`\`\`
...
### PasswordsBank InformationSecret Tokens
...
### JavaScript↓Convert To String↓Browser Storage↓Save Data
...
### Find Key↓Read Value↓Return String
...
### Stores User NameStores User AgeRetrieves ValuesDisplays Values
...
### User Adds Task↓Store Task↓Refresh Page↓Read Local Storage↓Display Tasks Again
...
- Local Storage is widely used in modern web applications.`,
    ...
    {
      slug: "chapter-44-session-storage",
      title: "Session Storage",
      summary: "In the previous chapter, we learned about: Local Storage Local Storage keeps data even after: Page RefreshBrowser RestartComputer Restart Sometimes this behavior is useful. Sometimes it is not. Imagine an online banking website. Suppose a user closes the…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 43,
      tags: "session,setitem,getitem,removeitem,clear,json-stringify,json-parse,temporary-storage,browser-tab",
...
### After Closing The Tab↓Data Should Disappear
...
### Session Storage=A Browser Storage SystemThat Stores Data For The Current Session

## Visual Diagram

### Website↓Session Storage↓Browser Tab
...
### Session Starts↓Store Data↓Session Ends↓Data Removed

## What Is a Session?

### A session represents:

### The Time BetweenOpening A Browser TabAndClosing That Browser Tab

## Visual Diagram

### Open Tab↓Session Starts↓Use Website↓Close Tab↓Session Ends
...
### Open Website↓Store Data↓Refresh Page↓Data Still Exists↓Close Tab↓Data Deleted

## Important Characteristics

### Session Storage:

### Stores Data As StringsSurvives RefreshSurvives NavigationRemoved When Tab Closes

## Local Storage vs Session Storage

### Local Storage:

### Refresh → Data ExistsRestart Browser → Data ExistsClose Browser → Data Exists

### Session Storage:

### Refresh → Data ExistsClose Tab → Data Deleted
...
\`\`\`js
sessionStorage.setItem( "username", "Kamraan");
\`\`\`
...
### Session Storage├── username│ └── Kamraan
...
\`\`\`js
let username =sessionStorage.getItem( "username");console.log(username);
\`\`\`
...
### Session Storage↓Find username↓Return Value↓Kamraan
...
### Session Storage├── name├── theme├── city↓clear()↓Empty
...
\`\`\`js
let user = { name: "Kamraan"};sessionStorage.setItem( "user", user);
\`\`\`
...
\`\`\`js
let user = { name: "Kamraan", age: 24};sessionStorage.setItem( "user", JSON.stringify(user));
\`\`\`
...
\`\`\`js
let user = JSON.parse( sessionStorage.getItem( "user" ));console.log(user.name);
\`\`\`
...
\`\`\`js
let product = { name: "Laptop", price: 50000};sessionStorage.setItem( "product", JSON.stringify(product));
\`\`\`

### Retrieve:

\`\`\`js
let data =JSON.parse( sessionStorage.getItem( "product" ));console.log(data.price);
\`\`\`
...
### Tab 1↓Own Session Storage

### Tab 2↓Own Session Storage
...
Temporary FormsExam AnswersCheckout ProcessTemporary User DataSession-Specific Settings

## When To Use Local Storage

### Use Local Storage for:

### Theme PreferencesLanguage PreferencesShopping CartSaved NotesRemembered Settings
...
\`\`\`js
sessionStorage.setItem( "name", "Kamraan");
\`\`\`

### Process:

### JavaScript↓Convert To String↓Store In Current Session↓Data Available
...
### Session Ends↓Storage Destroyed↓Data Removed
...
### Stores User NameStores Current CourseRetrieves Both ValuesDisplays Them
...
Student Starts Exam↓Store Answers↓Refresh Page↓Answers Still Available↓Submit Exam↓Close Tab↓Session Ends↓Data Removed
...
- Understanding browser storage is essential for modern web development.`,
    ...
    {
      slug: "chapter-45-browser-apis",
      title: "Browser APIs",
      summary: "So far, we have learned about: DOMEventsStorageFetch APIREST APIs All of these are provided by the browser. But browsers provide many more powerful features. Examples: Get User LocationCopy Text To ClipboardShow NotificationsAccess CameraAccess…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 44,
...
DOMEventsStorageFetch APIREST APIs
...
Get User LocationCopy Text To ClipboardShow NotificationsAccess CameraAccess MicrophoneDetect Network Status
...
### Know User LocationCopy Text AutomaticallyShow AlertsAccess Device Features
...
Browser API=A Feature Provided By The BrowserThat Allows JavaScript To AccessBrowser Capabilities

## Visual Diagram

### JavaScript↓Browser API↓Browser Feature↓Result
...
### Room ServiceLaundryReception

Reception acts as a controlled gateway.

### Similarly:

### JavaScript↓Browser API↓Browser Feature

## Common Browser APIs

### Geolocation APIClipboard APINotification APICamera APIMedia APIStorage API
...
### MapsFood DeliveryRide SharingWeather Applications

## Visual Diagram

### Website↓Geolocation API↓User Permission↓Location Data
...
### Request Location↓Ask Permission↓User Allows↓Location Returned
...
\`\`\`js
navigator.geolocation.getCurrentPosition( successFunction, function(error){ console.log( "Location Denied" ); });
\`\`\`
...
### Get User Location↓Latitude & Longitude↓Weather API↓Weather Information

## Clipboard API

### Allows JavaScript to:

### Copy TextRead Clipboard Content

## Real-World Uses

### Copy Coupon CodesCopy Share LinksCopy PasswordsCopy Invite Links

## Visual Diagram

### Website↓Clipboard API↓System Clipboard
...
### Text↓Clipboard API↓System Clipboard↓Copied

## Complete Example

\`\`\`js
navigator.clipboard.writeText( "Copied Successfully");
\`\`\`
...
\`\`\`js
navigator.clipboard.readText().then(function(text){ console.log(text);});
\`\`\`

## Visual Diagram

### Clipboard↓Read Text↓JavaScript

## Why Clipboard API Is Useful

### Examples:

### Copy Referral LinksCopy Discount CodesCopy CommandsCopy Addresses
...
### New MessageNew EmailTask ReminderOrder Update

## Visual Diagram

### Website↓Notification API↓Notification↓User
...
### Permission Request↓User Choice├── granted├── denied└── default
...
\`\`\`js
Notification.requestPermission().then(function(permission){ if(permission === "granted"){ new Notification( "Task Completed" ); }});
\`\`\`

## Execution Flow

### Ask Permission↓Permission Granted↓Create Notification↓Display Notification

## Real-World Example

### Task Manager:

### Task Finished↓Notification API↓Show Notification↓User Informed
...
### LocationCameraMicrophoneNotifications

## Why Permissions Exist

### Without permissions:

### Websites Could AccessSensitive Information

Permissions protect users.

## Visual Diagram

### Website↓Permission Request↓User Decision↓Allow Or Deny
...
### Tracking Users SecretlyShowing Spam NotificationsReading Clipboard Without Need

## Best Practice

### Always:

### Explain Why PermissionIs Being Requested

## Real-World Example — Location-Based Weather App

### Flow:

### User Opens App↓Geolocation API↓Get Coordinates↓Weather API↓Display Weather

## Real-World Example — Copy Coupon

### Flow:

### User Clicks Button↓Clipboard API↓Coupon Copied↓User Pastes Coupon

## Real-World Example — Reminder Application

### Flow:

### Task Deadline Reached↓Notification API↓Display Notification↓User Sees Reminder
...
### JavaScript↓Browser API↓Permission Request↓User Response↓Location Data Returned
...
### Gets User LocationDisplays CoordinatesCopies Coordinates To Clipboard
...
User Opens App↓Geolocation API↓Get User Location↓Find Nearby Restaurants↓Display Results
...
## PART 7 — Professional JavaScript`,
    },
    {
      slug: "chapter-46-code-organization",
      title: "Code Organization",
      summary: "So far, we have learned: VariablesFunctionsObjectsArraysDOM ManipulationAPIsStorageAsync Programming These concepts help us write JavaScript programs. However, professional software development involves much more than simply writing code. Consider two…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 45,
      tags: "maintainability,reusability,single-responsibility-principle,code-duplication,function-design,module,business-logic,ui-logic,project-structure",
...
VariablesFunctionsObjectsArraysDOM ManipulationAPIsStorageAsync Programming
...
LinesEverything In One FileNo StructureNo Naming RulesNo Organization

Project B:

Multiple FilesClear StructureReusable FunctionsConsistent NamingEasy Maintenance
...
Easier To ReadEasier To DebugEasier To ScaleEasier To Maintain
...
### Books EverywhereNo CategoriesNo LabelsNo Sections

Finding a book becomes difficult.

### Now imagine:

### Science SectionHistory SectionTechnology SectionLiterature Section
...
### Code Organization=Structuring CodeSo It Is Easy To Read,Maintain, And Expand

## Visual Diagram

### Messy Code↓Difficult To Understand↓Difficult To Maintain

### Organized Code↓Easy To Understand↓Easy To Maintain

## Signs of Poor Organization

### Examples:

Very Long FilesVery Long FunctionsRepeated CodeConfusing NamesMixed Responsibilities

## Example of Poor Organization

\`\`\`js
let userName = "Kamraan";console.log(userName);function calculateTax(price){ return price * 0.18;}document.body.style.background ="blue";fetch(url);
\`\`\`
...
### Hard To ReadHard To DebugHard To Reuse

## Better Organization

\`\`\`js
// User Functions// Tax Functions// UI Functions// API Functions
\`\`\`
...
### User LogicAPI LogicUI LogicUtility Functions

## Visual Diagram

### Application├── UI├── Business Logic├── API└── Utilities
...
### A Function ShouldDo One Thing Well

## Bad Example

\`\`\`js
function userSystem(){ loginUser(); updateProfile(); sendEmail(); generateReport();}
\`\`\`
...
\`\`\`js
let userName;let productPrice;let totalAmount;
\`\`\`
...
### Same CodeRepeated Multiple Times

### Bad:

\`\`\`js
console.log( "Welcome Kamraan");console.log( "Welcome Ali");console.log( "Welcome Ahmed");
\`\`\`
...
\`\`\`js
welcome("Kamraan");welcome("Ali");welcome("Ahmed");
\`\`\`
...
### Reusable Function↓Easy To Maintain
...
\`\`\`js
// User Functionsfunction login(){}function logout(){}
\`\`\`

\`\`\`js
// Product Functionsfunction addProduct(){}function deleteProduct(){}
\`\`\`
...
\`\`\`js
const TAX_RATE =0.18;let tax =price * TAX_RATE;
\`\`\`

### Benefits:

### Easy To UpdateEasy To Understand
...
\`\`\`js
// Calculate taxfunction calculateTax(){}
\`\`\`
...
### project├── css├── js├── images└── assets

## Example Structure

project├── index.html├── css│ └── style.css├── js│ ├── app.js│ ├── api.js│ └── utils.js

## Why Separate Files?

### Benefits:

### Cleaner CodeBetter MaintenanceEasier Collaboration
...
\`\`\`js
document.getElementById("btn").addEventListener( "click", function(){ // 200 lines });
\`\`\`
...
### UI↓Calls Function↓Function Performs Work
...
\`\`\`js
const button =document.getElementById( "btn");const heading =document.getElementById( "heading");
\`\`\`
...
### Frontend Application├── Components├── Services├── Utilities├── Assets└── Styles
...
### Developer↓Find Code Faster↓Understand Logic Faster↓Fix Bugs Faster
...
\`\`\`js
console.log("Hello Kamraan");console.log("Hello Ali");console.log("Hello Ahmed");
\`\`\`
...
Products↓Product ModuleOrders↓Order ModulePayments↓Payment ModuleUsers↓User Module
...
# Revision Notes• Point 1• Point 2• Point 3...
...
This will keep the book looking like a professional published textbook rather than a chat conversation.`,
    ...
    {
      slug: "chapter-47-eslint",
      title: "ESLint",
      summary: "As applications grow larger, developers write thousands of lines of code. Consider the following example: At first glance, this code looks correct. However, a professional developer may notice: Missing SemicolonsInconsistent FormattingCoding Style Issues Now…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 46,
      tags: "linter,linting,rule,configuration,warning,error,code-consistency,static-analysis,auto-fix",
...
Missing SemicolonsInconsistent FormattingCoding Style Issues

Now imagine a project with:

Developers100 Files50,000 Lines Of Code

Without coding standards, every developer may write code differently.

This leads to:

Inconsistent StyleDifficult MaintenanceMore BugsPoor Readability
...
### ESLint=A Tool That Analyzes JavaScript CodeAnd Reports Potential Problems
...
### Spelling ErrorsGrammar ErrorsFormatting Issues

### Similarly:

### ESLint↓Checks JavaScript Code↓Finds Problems↓Suggests Fixes

## Visual Diagram

### Developer↓Writes Code↓ESLint↓Checks Code↓Reports Problems

## What Is Linting?

### Linting means:

### Analyzing Code↓Finding Problems↓Suggesting Improvements
...
### Grammar Checker↓Finds Errors↓Improves Quality
...
Unused VariablesMissing SemicolonsIncorrect FormattingDuplicate VariablesPotential Bugs
...
'userName' is assigned a valuebut never used.
...
Detect Errors EarlyImprove ConsistencyImprove ReadabilityReduce BugsImprove Team Collaboration

## Visual Diagram

### Write Code↓ESLint Check↓Fix Problems↓Cleaner Code
...
### Install ESLint↓Run Initialization↓Create Configuration↓Start Linting

## What Is a Configuration File?

### A configuration file tells ESLint:

### Which Rules To UseHow Strict To BeProject Preferences
...
### Semicolon RulesQuote RulesIndentation RulesVariable Rules
...
### Check File↓Find Problems↓Fix Automatically

## Visual Diagram

### Messy Code↓ESLint --fix↓Cleaner Code
...
### Live Error DetectionInstant FeedbackAutomatic Fixes

## Workflow

### Write Code↓VS Code↓ESLint Runs↓Problems Highlighted
...
### AssignmentInstead OfComparison
...
### Easier ReviewsCleaner CodebaseFewer Arguments About Style

## Real-World Example

### Professional project:

### Frontend Team↓Shared ESLint Rules↓Consistent Code↓Better Maintenance

## Internal Working

### Process:

Source Code↓ESLint Parser↓Analyze Syntax↓Apply Rules↓Generate Warnings↓Display Results
...
\`\`\`js
let name = 'Kamraan'console.log(age)
\`\`\`
...
50 Developers↓Shared ESLint Configuration↓Consistent Coding Style↓Fewer Errors↓Better Collaboration
...
- ESLint improves quality but does not replace good programming practices.`,
    ...
    {
      slug: "chapter-48-git-and-github",
      title: "Git and GitHub",
      summary: "Imagine you are building a JavaScript project. You spend three weeks creating: WebsiteFeaturesDesignFunctionality Everything works perfectly. Then you accidentally delete important code. Or you make a change that breaks the entire application. What now?…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 47,
...
WebsiteFeaturesDesignFunctionality
...
### Version Control=A System That Tracks ChangesMade To Files Over Time

## Visual Diagram

### File↓Edit↓Version 1↓Edit↓Version 2↓Edit↓Version 3

## Benefits of Version Control

### Track ChangesRestore Old VersionsCollaborate SafelyPrevent Data Loss

## What Is Git?

### Simple definition:

### Git=A Version Control SystemUsed To Track Code Changes

Git works locally on your computer.

## Visual Diagram

### Your Computer↓Git↓Track Changes
...
### GitHub=A Cloud PlatformFor Hosting Git Repositories
...
### Computer↓Git↓GitHub↓Cloud Storage
...
### Portfolio WebsiteWeather AppTo-Do ApplicationExpense Tracker

Each can have its own repository.

## Visual Diagram

### Repository├── HTML├── CSS├── JavaScript└── Assets
...
### Project Folder↓Git Initialized↓Repository Created

## Understanding Commits

### A commit is:

### A Saved SnapshotOf Your Project

## Visual Diagram

### Project↓Commit 1↓Commit 2↓Commit 3
...
### Select All ChangesFor Next Commit
...
### Edit Files↓git add↓git commit↓Snapshot Saved

## What Is GitHub Used For?

### GitHub provides:

### Cloud BackupCollaborationProject HostingPortfolio Sharing

## Uploading Code to GitHub

### Typical workflow:

### Create Repository↓Connect Local Project↓Push Code↓Store Online

## What Is Push?

### Push means:

### Send Local Changes↓GitHub
...
### An Independent LineOf Development
...
### Changes Affect Main ProjectImmediately

Risky.

### With branches:

### Create Branch↓Work Safely↓Merge Later

## Visual Diagram

### Main Branch│├── Login Branch│├── Dashboard Branch│└── Payment Branch
...
### Feature Ready↓Merge Into Main Branch
...
### Main│├── Feature Branch↓Merge↓Main Updated

## Collaboration Workflow

### Imagine:

### Developer ADeveloper BDeveloper C

working together.

### Process:

### Create Branch↓Make Changes↓Commit Changes↓Push Branch↓Review Code↓Merge Branch

## Why GitHub Is Important

### GitHub enables:

### TeamworkOpen SourcePortfolio HostingProject Sharing

## Open Source Contributions

### Many projects on GitHub allow:

### Bug FixesFeature ContributionsDocumentation Improvements
...
### Coding AbilityConsistencyProject Experience

## Typical Professional Workflow

Create Feature Branch↓Write Code↓Commit Changes↓Push To GitHub↓Code Review↓Merge Into Main
...
### Files Changed↓Git Detects Changes↓Snapshot Created↓History Updated
...
### Create RepositorySave ChangesUpload ChangesDownload ChangesDownload Repository

### with:

### git initgit commitgit pushgit pullgit clone

## Real-World Scenario

### Frontend Team Project:

### Developer A↓Navbar Feature

### Developer B↓Login Feature
...
- Git skills are required in modern software development.`,
    ...
    {
      slug: "part-5",
      title: "Part 5 — Chapters 49–54",
      summary: "Chapters 49 to 54 of JavaScript.",
      order: 5,
      difficulty: "intermediate",
      estimatedMinutes: 180,
      tutorials: [
    {
      slug: "chapter-49-project-structure",
      title: "Project Structure",
      summary: "When you first start learning JavaScript, your projects are usually small. Example: index.htmlstyle.cssscript.js Everything fits into a few files. As projects grow, things become more complicated. Imagine a project containing: 20 JavaScript Files15 CSS…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 48,
      tags: "scalability,assets,components,utilities,services,configuration,folder-organization,separation-of-concerns,maintainability",
...
20 JavaScript Files15 CSS Files100 ImagesAPI CodeAuthentication LogicComponentsUtilities
...
Easy To NavigateEasy To MaintainEasy To ScaleEasy To Collaborate On
...
### Project Structure=The Organization Of FilesAnd Folders Within A Project
...
### Books EverywhereNo CategoriesNo Labels

Finding information becomes difficult.

### Now imagine:

### Science SectionTechnology SectionHistory SectionLiterature Section
...
### Messy Project↓Difficult Navigation↓Slow Development

### Organized Project↓Easy Navigation↓Faster Development
...
### CalculatorPortfolioSimple Landing Page
...
### Login SystemAPI CallsUser DashboardTheme SystemValidation

One file becomes huge.

### Example:

### script.js↓5000 Lines
...
### project├── index.html├── css├── js├── images└── assets

## Visual Diagram

### Project├── HTML├── CSS├── JavaScript└── Assets
...
### app.jsapi.jsutils.js

## Assets

### Contains:

### ImagesIconsFontsVideos

## Visual Example

project├── index.html├── css│ ├── style.css│ └── theme.css├── js│ ├── app.js│ ├── api.js│ └── utils.js└── images ├── logo.png └── banner.jpg
...
\`\`\`js
// API Calls// UI Updates// Validation// Calculations// Storage// Events// Everything In One File
\`\`\`
...
### Application├── API├── UI├── Validation├── Storage└── Utilities

## Organizing JavaScript Files

### Professional projects often use:

### js├── app.js├── services├── utils├── components└── config
...
### API RequestsAuthenticationData Fetching
...
### utils├── formatDate.js├── calculateTax.js└── validator.js
...
### components├── navbar.js├── modal.js└── card.js
...
\`\`\`js
// Same Date FormattingRepeated Everywhere
\`\`\`
...
### components.css↓ButtonsCardsForms

### theme.css↓ColorsThemes

## Frontend Project Example

project├── index.html├── assets│ ├── images│ └── icons├── css│ ├── base.css│ ├── layout.css│ └── theme.css├── js│ ├── app.js│ ├── services│ ├── components│ └── utils└── README.md

## Scalability

### Scalability means:

### Project Can GrowWithout Becoming Messy

## Visual Diagram

### Small Project↓Add Features↓Still Organized↓Scalable Project
...
### Easy NavigationClear Responsibilities

## Real-World Example

### E-Commerce Application

### project├── products├── users├── orders├── payments└── inventory
...
### APIUIValidationStorage↓Same File
...
### Weather ApplicationAPI RequestsUser InterfaceImagesUtilitiesTheme Settings
...
### AuthenticationDashboardTransactionsReportsSettings
...
- Professional developers prioritize organization from the beginning.`,
    ...
    {
      slug: "chapter-50-performance-basics",
      title: "Performance Basics",
      summary: "Imagine you visit two websites. Website A: Loads InstantlySmooth AnimationsFast Responses Website B: Slow LoadingLaggy ScrollingDelayed Interactions Which website provides a better user experience? Most users prefer: Website A The reason is: Performance…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 49,
...
Loads InstantlySmooth AnimationsFast Responses

Website B:

Slow LoadingLaggy ScrollingDelayed Interactions
...
### Performance=How Fast And EfficientlyAn Application Runs

## Why Performance Matters

### Fast applications provide:

### Better User ExperienceHigher EngagementLower Bounce RateImproved Accessibility

### Slow applications cause:

### FrustrationLost UsersPoor Experience

## Visual Diagram

### Fast Website↓Happy Users↓More Engagement

### Slow Website↓Frustrated Users↓Users Leave
...
### Order Food↓Receive Food Quickly

### Restaurant B:

### Order Food↓Wait 45 Minutes
...
### HTML↓DOM↓CSS↓CSSOM↓Render Tree↓Layout↓Paint↓Screen

## Visual Diagram

### HTML + CSS↓Browser Processing↓Render Page↓User Sees Content
...
\`\`\`js
for(let i = 0; i < 1000; i++){ document.body.innerHTML += "<p>Hello</p>";}
\`\`\`
...
\`\`\`js
let content = "";for(let i = 0; i < 1000; i++){ content += "<p>Hello</p>";}document.body.innerHTML =content;
\`\`\`

### Benefits:

### One DOM UpdateInstead Of1000 Updates

## Visual Diagram

### Many DOM Updates↓Slower

### Single DOM Update↓Faster
...
### Layout Change↓Recalculate Layout↓Reflow

## Why Reflows Matter

### Too many reflows:

### More Work↓Slower Website
...
\`\`\`js
function calculate(){ let total = 0;}
\`\`\`
...
\`\`\`js
document.getElementById("title");document.getElementById("title");document.getElementById("title");
\`\`\`
...
### Repeated Search↓More Work

### Store Reference↓Less Work

## Lazy Loading

### Lazy loading means:

### Load ResourcesOnly When Needed
...
### User Scrolls↓Image Needed↓Load Image

## Benefits

### Faster Initial LoadLower Bandwidth Usage
...
### Search BoxesResize EventsInput Fields
...
### Scroll Event↓Hundreds Of Events
...
### Many Events↓Throttle↓Controlled Execution
...
### Faster LoadingLower Data Usage

## Minimizing JavaScript Work

### Bad:

### Run Heavy CalculationsEvery Second
...
### API RequestEvery Key Press

### Better:

### Debounced RequestAfter Typing Stops
...
### Performance TabNetwork TabMemory Tab
...
### User Clicks↓JavaScript Runs↓DOM Updates↓Browser Repaints↓User Sees Result
...
### Thousands Of ProductsLarge ImagesSearch FunctionalityFilters
...
- Performance should be measured and optimized continuously.`,
    ...
    {
      slug: "chapter-51-security-basics",
      title: "Security Basics",
      summary: "Imagine you build a website that allows users to: Register AccountsSubmit FormsPost CommentsUpload Data Everything seems to work perfectly. However, what if a malicious user tries to: Inject Harmful CodeSteal User InformationModify DataAttack Other Users This…",
      difficulty: "intermediate",
      estimatedMinutes: 69,
      order: 50,
      tags: "web-security,xss,cross-site-scripting,input-validation,output-escaping,authentication,authorization,secure-coding,sanitization,sensitive-data,dom-manipulation,event-handling,function,input,output,eval,calculator-logic,error-handling,user-interface,user-interaction,date-object,gethours,getminutes,getseconds",
      learningObjectives: ["Understand web security", "Understand common threats", "Understand XSS attacks", "Validate user input", "Write safer code", "Protect user data", "Understand authentication basics", "Follow secure coding practices", "Build a complete JavaScript application", "Handle button clicks", "Update the DOM", "Perform calculations"],
      prerequisites: [],
      whereItFits: "",
...
Register AccountsSubmit FormsPost CommentsUpload Data

Everything seems to work perfectly.

However, what if a malicious user tries to:

Inject Harmful CodeSteal User InformationModify DataAttack Other Users
...
Protecting UsersProtecting DataPreventing Attacks
...
Web Security=The Practice Of ProtectingWeb Applications, Data,And Users From Attacks
...
### Personal InformationAccount DataFinancial Information

### If security is weak:

### Data May Be StolenAccounts May Be CompromisedTrust May Be Lost

## Visual Diagram

### User↓Website↓Sensitive Data↓Must Be Protected
...
### XSSInjection AttacksWeak PasswordsData ExposureUnauthorized Access
...
### XSS=Injecting Malicious JavaScriptInto A Website
...
### User Input↓Malicious Script↓Stored On Website↓Executed In Browser

## Why XSS Is Dangerous

### An attacker may:

### Steal InformationModify ContentRedirect UsersPerform Actions
...
### Script Displayed As TextNot Executed

## Visual Diagram

### innerHTML↓May Execute HTML
...
### Checking User DataBefore Using It

## Why Validation Matters

### Users may enter:

### Incorrect DataUnexpected DataMalicious Data
...
\`\`\`js
let age = Number(userInput);if(isNaN(age)){ console.log( "Invalid Age" );}
\`\`\`
...
### Writing Code ThatReduces Security Risks

## Principles of Secure Coding

Validate InputSanitize DataAvoid Trusting User InputHandle Errors SafelyProtect Sensitive Information
...
### All User InputMay Be Incorrect
...
### Local StorageSession StorageClient-Side Code
...
### UsernamePassword↓Verify Identity
...
### Authentication↓Identity Confirmed↓Authorization↓Permissions Checked
...
### Internal DetailsShould Not Be Exposed

## Secure Form Handling

### Always validate:

### NameEmailPhone NumberPasswordComments
...
### Required FieldsPassword LengthEmail FormatAllowed Characters
...
### Never Expose Secret KeysNever Trust Client DataValidate Requests
...
### Frontend Code↓Visible To Users↓Not Safe For Secrets

## Internal Working

### Safe input flow:

### User Input↓Validation↓Sanitization↓Processing↓Display

### Unsafe flow:

### User Input↓Direct Execution↓Security Risk
...
### PostsCommentsMessagesProfile Information
...
Perform AdditionPerform SubtractionPerform MultiplicationPerform DivisionClear ResultsView Calculations Instantly

### This project combines many concepts learned earlier:

### VariablesFunctionsEventsDOM ManipulationUser InputOutput Display
...
Display NumbersAccept User InputPerform Arithmetic OperationsShow ResultsClear Input
...
### calculator-project├── index.html├── style.css└── script.js
...
### Calculator ScreenNumber ButtonsOperator ButtonsClear ButtonEqual Button
...
<!DOCTYPE html><html><head> <title>Calculator</title> <link rel="stylesheet"href="style.css"></head><body> <div class="calculator"> <input type="text" id="display" readonly> <button onclick="appendValue('7')">7</button> <button onclick="appendValue('8')">8</button> <button onclick="appendValue('9')">9</button> <button onclick="appendValue('/')">÷</button> <button onclick="appendValue('4')">4</button> <button onclick="appendValue('5')">5</button> <button onclick="appendValue('6')">6</button> <button onclick="appendValue('*')">×</button> <button onclick="appendValue('1')">1</button> <button onclick="appendValue('2')">2</button> <button onclick="appendValue('3')">3</button> <button onclick="appendValue('-')">-</button> <button onclick="appendValue('0')">0</button> <button onclick="clearDisplay()">C</button> <button onclick="calculate()">=</button> <button onclick="appendValue('+')">+</button> </div> <script src="script.js"></script></body></html>
...
\`\`\`js
body{ display:flex; justify-content:center; align-items:center; height:100vh;}.calculator{ width:250px;}button{ width:50px; height:50px; margin:5px;}#display{ width:220px; height:40px; margin-bottom:10px;}
\`\`\`
...
\`\`\`js
function calculate(){ let expression = document .getElementById("display") .value; let result = eval(expression); document .getElementById("display") .value = result;}
\`\`\`
...
User Clicks Button↓appendValue()↓Display Updated↓User Clicks "="↓calculate()↓Result Generated↓Display Updated
...
\`\`\`js
function calculate(){ try{ let result = eval( document .getElementById("display") .value ); document .getElementById("display") .value = result; } catch(error){ alert("Invalid Expression"); }}
\`\`\`

## How Error Handling Works

### Valid Input↓Calculate↓Show Result

### Invalid Input↓Catch Error↓Show Message
...
### Decimal NumbersKeyboard SupportHistory PanelDark ModeAdvanced Functions
...
### Project NameTechnologies UsedFeaturesScreenshotsGitHub LinkLive Demo

## What Recruiters See

### This project demonstrates:

### DOM ManipulationEventsFunctionsProblem SolvingJavaScript Fundamentals
...
### Display Current TimeUpdate AutomaticallyShow HoursShow MinutesShow Seconds

### This project teaches important JavaScript concepts such as:

### Date ObjectFunctionsDOM ManipulationTimerssetInterval()

### Digital clocks are commonly used in:

### DashboardsWeb ApplicationsSmart DevicesAdmin PanelsMonitoring Systems
...
### Clock DisplayCurrent TimeAutomatic Updates
...
<!DOCTYPE html><html><head> <title>Digital Clock</title> <link rel="stylesheet" href="style.css"></head><body> <div id="clock"> 00:00:00 </div> <script src="script.js"></script></body></html>
...
\`\`\`js
body{ display:flex; justify-content:center; align-items:center; height:100vh; font-size:50px;}#clock{ padding:20px; border:2px solid black;}
\`\`\`
...
\`\`\`js
function updateClock(){ const now = new Date(); let hours = now.getHours(); let minutes = now.getMinutes(); let seconds = now.getSeconds(); document .getElementById("clock") .textContent = hours + ":" + minutes + ":" + seconds;}
\`\`\`
...
### setInterval()=Run Code RepeatedlyAfter A Fixed Time Interval
...
\`\`\`js
function updateClock(){ const now = new Date(); let hours = now.getHours(); let minutes = now.getMinutes(); let seconds = now.getSeconds(); document .getElementById("clock") .textContent = hours + ":" + minutes + ":" + seconds;}updateClock();setInterval( updateClock, 1000);
\`\`\`
...
Page Loads↓updateClock()↓Current Time Displayed↓setInterval()↓Run Every Second↓Display Updated
...
\`\`\`js
function formatTime(value){ if(value < 10){ return "0" + value; } return value;}
\`\`\`
...
\`\`\`js
function updateClock(){ const now = new Date(); let hours = formatTime( now.getHours() ); let minutes = formatTime( now.getMinutes() ); let seconds = formatTime( now.getSeconds() ); document .getElementById("clock") .textContent = hours + ":" + minutes + ":" + seconds;}
\`\`\`
...
\`\`\`js
let period = "AM";if(hours >= 12){ period = "PM";}
\`\`\`
...
### Dashboard SystemsAttendance SystemsAdmin PanelsMonitoring ToolsSmart Displays
...
### Current DateAM/PM FormatDark ModeTime Zone SelectionWorld Clock
...
### Project DescriptionTechnologies UsedScreenshotsGitHub RepositoryLive Demo Link

## What Recruiters Learn

### This project demonstrates:

### Date Object KnowledgeDOM ManipulationFunctionsTimersReal-Time Updates
...
### Add TasksView TasksDelete TasksManage Daily Activities

### Examples:

### Study JavaScriptComplete AssignmentGo To GymBuy Groceries

### This project combines many important concepts:

### DOM ManipulationFunctionsArraysEventsLocal StorageDynamic UI Updates
...
### Add TasksDelete TasksSave TasksReload Page Without Losing Tasks

## Visual Layout

---------------------------------| Enter Task [Add] | ---------------------------------| ✓ Learn JavaScript [X] || ✓ Build Project [X] || ✓ Practice Coding [X] | ---------------------------------
...
### Input FieldAdd ButtonTask ListDelete ButtonStorage System

## Step 1 — Create HTML Structure

## index.html

<!DOCTYPE html><html><head> <title>To-Do List</title> <link rel="stylesheet" href="style.css"></head><body> <h1>To-Do List</h1> <input type="text" id="taskInput" placeholder="Enter Task"> <button onclick="addTask()"> Add </button> <ul id="taskList"> </ul> <script src="script.js"></script></body></html>
...
\`\`\`js
body{ text-align:center; margin-top:50px;}input{ width:250px; padding:10px;}button{ padding:10px;}li{ margin:10px;}
\`\`\`
...
\`\`\`js
function addTask(){ let taskInput = document .getElementById( "taskInput" ); let task = taskInput.value; tasks.push(task); taskInput.value = "";}
\`\`\`
...
\`\`\`js
function displayTasks(){ let taskList = document .getElementById( "taskList" ); taskList.innerHTML = ""; for( let i = 0; i < tasks.length; i++ ){ let li = document .createElement("li"); li.textContent = tasks[i]; taskList.appendChild(li); }}
\`\`\`
...
### Array↓Loop↓Create LI↓Add Text↓Display

## Update addTask()

\`\`\`js
function addTask(){ let task = document .getElementById( "taskInput" ).value; tasks.push(task); displayTasks();}
\`\`\`
...
\`\`\`js
function deleteTask(index){ tasks.splice( index, 1 ); displayTasks();}
\`\`\`
...
\`\`\`js
function displayTasks(){ let taskList = document .getElementById( "taskList" ); taskList.innerHTML = ""; for( let i = 0; i < tasks.length; i++ ){ let li = document .createElement( "li" ); li.textContent = tasks[i]; let deleteButton = document .createElement( "button" ); deleteButton .textContent = "Delete"; deleteButton.onclick = function(){ deleteTask(i); }; li.appendChild( deleteButton ); taskList.appendChild( li ); }}
\`\`\`
...
\`\`\`js
function loadTasks(){ let savedTasks = localStorage.getItem( "tasks" ); if(savedTasks){ tasks = JSON.parse( savedTasks ); displayTasks(); }}
\`\`\`
...
\`\`\`js
tasks.push(task);saveTasks();displayTasks();
\`\`\`

## Update deleteTask()

\`\`\`js
tasks.splice(index,1);saveTasks();displayTasks();
\`\`\`
...
### User Adds Task↓Array Updated↓Save To Local Storage↓Display Updated

### Page Refresh:

### Load Tasks↓Read Local Storage↓Display Tasks
...
### Array UpdatedBut UI Not Updated
...
### Task CompletionDue DatesTask CategoriesDark ModeSearch TasksTask Filtering

## Portfolio Tips

### This project demonstrates:

### DOM ManipulationArraysFunctionsLocal StorageCRUD Operations
...
### JavaScript FundamentalsState ManagementStorage HandlingUI UpdatesProblem Solving
...
Online Learning PlatformsCertification WebsitesEducational PortalsTraining SystemsInterview Preparation Platforms

### In this project, users will:

### Answer QuestionsSelect OptionsSubmit AnswersView ScoreReceive Results

### This project teaches several important JavaScript concepts:

ObjectsArraysFunctionsDOM ManipulationEventsConditional LogicApplication State Management
...
### View QuestionsSelect AnswersMove Through QuizCalculate ScoreSee Final Result

## Visual Layout

--------------------------------Question 1 of 3What is JavaScript?( ) Programming Language( ) Database( ) Browser( ) Operating System[Next]--------------------------------
...
### Question DisplayAnswer OptionsNext ButtonScore SystemResult Screen

## Step 1 — Create HTML Structure

## index.html

<!DOCTYPE html><html><head> <title>Quiz App</title> <link rel="stylesheet" href="style.css"></head><body> <div id="quizContainer"> <h2 id="question"> </h2> <div id="options"> </div> <button id="nextButton"> Next </button> </div> <script src="script.js"> </script></body></html>
...
\`\`\`js
body{ font-family:Arial; text-align:center; margin-top:50px;}button{ margin:10px; padding:10px;}
\`\`\`
...
\`\`\`js
const quizData = [ { question: "What is JavaScript?", options: [ "Programming Language", "Database", "Browser", "Operating System" ], answer: "Programming Language" }, { question: "Which keyword declares a variable?", options: [ "let", "html", "css", "image" ], answer: "let" }, { question: "Which method displays text in console?", options: [ "console.log", "alertBox", "showText", "display" ], answer: "console.log" }];
\`\`\`
...
### Quiz Data├── Question 1├── Question 2└── Question 3
...
\`\`\`js
function loadQuestion(){ let questionElement = document .getElementById( "question" ); let optionsElement = document .getElementById( "options" ); questionElement.textContent = quizData[ currentQuestion ].question; optionsElement.innerHTML = "";}
\`\`\`
...
\`\`\`js
let button =document.createElement("button");button.textContent =option;
\`\`\`
...
\`\`\`js
function loadQuestion(){ let questionElement = document .getElementById( "question" ); let optionsElement = document .getElementById( "options" ); questionElement.textContent = quizData[ currentQuestion ].question; optionsElement.innerHTML = ""; quizData[ currentQuestion ].options.forEach( function(option){ let button = document .createElement( "button" ); button.textContent = option; button.onclick = function(){ checkAnswer( option ); }; optionsElement .appendChild( button ); });}
\`\`\`

## Execution Flow

### Load Question↓Generate Buttons↓Display Options↓Wait For User

## Step 5 — Check Answers

\`\`\`js
function checkAnswer(selectedOption){ if( selectedOption === quizData[ currentQuestion ].answer ){ score++; }}
\`\`\`
...
\`\`\`js
document.getElementById("nextButton").onclick =function(){ currentQuestion++;};
\`\`\`
...
\`\`\`js
document.getElementById("nextButton").onclick =function(){ currentQuestion++; loadQuestion();};
\`\`\`
...
\`\`\`js
function showResult(){ document .getElementById( "quizContainer" ) .innerHTML = "<h2>Your Score: " + score + "</h2>";}
\`\`\`
...
\`\`\`js
document.getElementById("nextButton").onclick =function(){ currentQuestion++; if( currentQuestion < quizData.length ){ loadQuestion(); } else{ showResult(); }};
\`\`\`
...
Page Loads↓Question Appears↓User Selects Answer↓Score Updated↓Next Question↓Repeat↓Show Result
...
TimerQuestion ImagesProgress BarRandom QuestionsDifficulty LevelsMultiple CategoriesLeaderboard

## Portfolio Tips

### Quiz applications demonstrate:

### Application LogicState ManagementDOM ManipulationEvent HandlingProblem Solving
...
Working With ObjectsWorking With ArraysUI UpdatesConditional LogicApplication Flow Control
...
Connect To An External APIFetch Real DataDisplay Dynamic InformationHandle Asynchronous Operations

### This project introduces concepts used in real-world applications such as:

### APIsHTTP RequestsFetch APIJSONAsync ProgrammingError Handling

Many modern applications rely heavily on APIs.

### Examples:

Weather AppsFood Delivery AppsE-Commerce PlatformsSocial Media ApplicationsBanking Applications
...
Enter City NameSearch WeatherView TemperatureView Weather ConditionView HumidityView Wind Speed

## Example Output

City: SrinagarTemperature: 25°CCondition: Clear SkyHumidity: 45%Wind Speed: 12 km/h
...
### Search InputSearch ButtonAPI ConnectionWeather DisplayError Messages

## Visual Layout

---------------------------------Enter City[ Srinagar ][ Search ]---------------------------------Temperature: 25°CCondition: Clear SkyHumidity: 45%Wind Speed: 12 km/h---------------------------------

## Step 1 — Create HTML Structure

## index.html

<!DOCTYPE html><html><head> <title>Weather App</title> <link rel="stylesheet" href="style.css"></head><body> <h1>Weather App</h1> <input type="text" id="cityInput" placeholder="Enter City"> <button onclick="getWeather()"> Search </button> <div id="weatherResult"> </div> <script src="script.js"> </script></body></html>
...
\`\`\`js
body{ text-align:center; font-family:Arial; margin-top:50px;}input{ padding:10px; width:250px;}button{ padding:10px; margin-left:10px;}#weatherResult{ margin-top:20px;}
\`\`\`
...
### API=A Way For Two ApplicationsTo Communicate
...
### Browser↓API Request↓Weather Server↓Weather Data↓Browser
...
\`\`\`js
{ "temperature": 25, "humidity": 45, "condition": "Clear Sky"}
\`\`\`
...
### Server↓JSON Data↓JavaScript Object
...
### Send Request↓Wait↓Receive Data↓Display Data
...
### JavaScript↓fetch()↓API Server↓Response
...
\`\`\`js
document.getElementById("weatherResult").innerHTML =\`<h2>\${city}</h2><p>Temperature:\${data.temperature}°C</p><p>Humidity:\${data.humidity}%</p><p>Condition:\${data.condition}</p>\`;
\`\`\`
...
\`\`\`js
async function getWeather(){ let city = document .getElementById( "cityInput" ).value; let url = "https://api.example.com/weather?city=" + city; let response = await fetch(url); let data = await response.json(); document .getElementById( "weatherResult" ) .innerHTML = \` <h2>\${city}</h2> <p> Temperature: \${data.temperature} °C </p> <p> Humidity: \${data.humidity} % </p> <p> Condition: \${data.condition} </p> \`;}
\`\`\`

## Execution Flow

User Enters City↓Click Search↓getWeather()↓API Request↓Receive Data↓Display Weather

## Error Handling

### Problems may occur:

### No InternetInvalid CityServer Error

## Add try-catch

\`\`\`js
async function getWeather(){ try{ // Weather Logic } catch(error){ document .getElementById( "weatherResult" ) .textContent = "Weather Data Not Available"; }}
\`\`\`

## Visual Diagram

### API Success↓Display Weather
...
### User↓Search↓HTTP Request↓Weather Server↓Response↓Display Weather
...
Weather Icons5-Day ForecastTemperature ConversionDark ModeLocation DetectionRecent Searches
...
### Live DemoGitHub LinkAPI UsedFeatures AddedScreenshots

## What Recruiters Learn

### This project demonstrates:

### API IntegrationAsync ProgrammingFetch APIError HandlingReal Data Processing
...
### SalaryFreelance IncomeFood ExpensesTransportationShoppingBills

This project is very useful because it resembles real financial applications.

### Examples of similar applications:

Personal Finance AppsBudget Management SystemsAccounting SoftwareBusiness Expense Trackers

### In this project, users will be able to:

Add TransactionsTrack ExpensesTrack IncomeView Total BalanceDelete TransactionsStore Data Permanently
...
### Add IncomeAdd ExpensesView BalanceDelete TransactionsSave Data After Refresh

## Example

IncomeSalary +50000Freelancing +10000ExpensesFood -5000Travel -2000-----------------Balance53000
...
Description InputAmount InputAdd ButtonTransaction ListBalance DisplayDelete FunctionalityLocal Storage

## Visual Layout

--------------------------------Current Balance53000--------------------------------Description: [Salary]Amount: [50000][Add Transaction]--------------------------------Salary 50000 [Delete]Food -5000 [Delete]Travel -2000 [Delete]--------------------------------

## Step 1 — Create HTML Structure

## index.html

<!DOCTYPE html><html><head> <title>Expense Tracker</title> <link rel="stylesheet" href="style.css"></head><body> <h1>Expense Tracker</h1> <h2 id="balance"> Balance: ₹0 </h2> <input type="text" id="description" placeholder="Description"> <input type="number" id="amount" placeholder="Amount"> <button onclick="addTransaction()"> Add Transaction </button> <ul id="transactionList"> </ul> <script src="script.js"> </script></body></html>
...
\`\`\`js
body{ font-family:Arial; text-align:center; margin-top:50px;}input{ padding:10px; margin:5px;}button{ padding:10px;}li{ margin:10px;}
\`\`\`
...
\`\`\`js
[ { description:"Salary", amount:50000 }, { description:"Food", amount:-5000 }]
\`\`\`
...
### transactions├── Salary│ 50000├── Food│ -5000└── Travel│ -2000

## Step 4 — Add Transaction

\`\`\`js
function addTransaction(){ let description = document .getElementById( "description" ).value; let amount = Number( document .getElementById( "amount" ).value ); let transaction = { description: description, amount: amount }; transactions.push( transaction );}
\`\`\`
...
### transactions├── Salary│ 50000

## Step 5 — Display Transactions

\`\`\`js
function displayTransactions(){ let list = document .getElementById( "transactionList" ); list.innerHTML = ""; transactions.forEach( function(transaction){ let li = document .createElement( "li" ); li.textContent = transaction.description + " : ₹" + transaction.amount; list.appendChild(li); });}
\`\`\`

## Execution Flow

### Array↓Loop↓Create List Item↓Display Transaction

## Example Output

### Salary : ₹50000Food : ₹-5000

## Update addTransaction()

\`\`\`js
transactions.push(transaction);displayTransactions();
\`\`\`
...
\`\`\`js
function updateBalance(){ let balance = 0; transactions.forEach( function(transaction){ balance += transaction.amount; }); document .getElementById( "balance" ) .textContent = "Balance: ₹" + balance;}
\`\`\`
...
### Salary50000Food-5000Travel-2000

### Calculation:

### 50000-5000-2000=43000
...
\`\`\`js
transactions.push(transaction);displayTransactions();updateBalance();
\`\`\`
...
\`\`\`js
deleteButton.onclick =function(){ deleteTransaction( index );};
\`\`\`

## Create Delete Function

\`\`\`js
function deleteTransaction(index){ transactions.splice( index, 1 ); displayTransactions(); updateBalance();}
\`\`\`
...
\`\`\`js
function loadTransactions(){ let data = localStorage.getItem( "transactions" ); if(data){ transactions = JSON.parse(data); displayTransactions(); updateBalance(); }}
\`\`\`

## Update addTransaction()

\`\`\`js
transactions.push(transaction);saveTransactions();displayTransactions();updateBalance();
\`\`\`

## Update deleteTransaction()

\`\`\`js
transactions.splice(index,1);saveTransactions();displayTransactions();updateBalance();
\`\`\`
...
### Add Transaction↓Save To Storage↓Refresh Page↓Load From Storage↓Display Data
...
Expense CategoriesIncome CategoriesChartsMonthly ReportsDark ModeSearch TransactionsTransaction FiltersExport To PDF
...
CRUD OperationsState ManagementLocal StorageDOM ManipulationFinancial Calculations

## What Recruiters Learn

### This project shows:

### Working With ObjectsData ManagementBusiness LogicUI UpdatesPersistent Storage
...
## Project 7 — Movie Search Application
...
### NetflixIMDbYouTubeSpotifyGoogle Maps

These services provide data through APIs.

### In this project, users will:

Search MoviesView Movie PostersView Movie TitlesView Release YearsView Movie Information
...
### Search MoviesView PostersView TitlesView Release YearsSee Multiple Results
...
### Batman Begins (2005)The Batman (2022)Batman Returns (1992)

with movie posters.

## Project Folder Structure

### movie-search-app├── index.html├── style.css└── script.js

## Project Planning

### We need:

### Search InputSearch ButtonAPI RequestMovie ResultsError Handling

## Visual Layout

---------------------------------Search Movie[ Batman ][ Search ]---------------------------------[Poster]Batman Begins2005---------------------------------[Poster]The Batman2022---------------------------------

## Step 1 — Create HTML Structure

## index.html

<!DOCTYPE html><html><head> <title> Movie Search </title> <link rel="stylesheet" href="style.css"></head><body> <h1> Movie Search App </h1> <input type="text" id="movieInput" placeholder= "Enter Movie Name"> <button onclick="searchMovies()"> Search </button> <div id="movieResults"> </div> <script src="script.js"> </script></body></html>
...
\`\`\`js
body{ font-family:Arial; text-align:center; margin-top:40px;}input{ padding:10px; width:250px;}button{ padding:10px;}.movie{ border:1px solid gray; margin:15px; padding:15px;}
\`\`\`
...
\`\`\`js
{ "Title":"Batman Begins", "Year":"2005", "Poster":"poster-url"}
\`\`\`

## Visual Diagram

### User Search↓API Request↓Movie Server↓JSON Response↓Display Results
...
\`\`\`js
let url ="https://api.example.com/movie?s="+ movieName;
\`\`\`
...
\`\`\`js
https://api.example.com/movie?s=Batman
\`\`\`
...
\`\`\`js
[ { Title:"Batman Begins", Year:"2005" }, { Title:"The Batman", Year:"2022" }]
\`\`\`

## Clear Previous Results

\`\`\`js
let resultsContainer =document.getElementById("movieResults");resultsContainer.innerHTML = "";
\`\`\`
...
\`\`\`js
let movieCard =document.createElement("div");movieCard.className ="movie";
\`\`\`

## Add Movie Information

\`\`\`js
movieCard.innerHTML =\`<h2>\${movie.Title}</h2><p>Year:\${movie.Year}</p>\`;
\`\`\`
...
\`\`\`js
async function searchMovies(){ let movieName = document .getElementById( "movieInput" ).value; let url = "https://api.example.com/movie?s=" + movieName; let response = await fetch(url); let data = await response.json(); let resultsContainer = document .getElementById( "movieResults" ); resultsContainer .innerHTML = ""; data.Search.forEach( function(movie){ let movieCard = document .createElement( "div" ); movieCard.className = "movie"; movieCard.innerHTML = \` <h2> \${movie.Title} </h2> <p> Year: \${movie.Year} </p> \`; resultsContainer .appendChild( movieCard ); });}
\`\`\`

## Execution Flow

User Enters Movie↓Search Button↓API Request↓JSON Response↓Loop Through Results↓Create Movie Cards↓Display Results
...
\`\`\`js
movieCard.innerHTML =\`<imgsrc="\${movie.Poster}"><h2>\${movie.Title}</h2><p>\${movie.Year}</p>\`;
\`\`\`
...
\`\`\`js
resultsContainer.innerHTML ="<h2>No Movies Found</h2>";
\`\`\`

## Visual Diagram

### Search↓Movies Found?├── Yes│ Display Results└── No Show Message
...
\`\`\`js
try{ // API Logic}catch(error){ document .getElementById( "movieResults" ) .innerHTML = "<h2>Error Loading Movies</h2>";}
\`\`\`

## Complete Flow

### Search↓Request API↓Success?├── Yes│ Display Movies└── No Show Error
...
Movie RatingsMovie PlotGenreActorsMovie Details PageFavorites SystemDark ModeInfinite Scrolling

## Portfolio Tips

### Movie Search Apps are excellent portfolio projects because they demonstrate:

API IntegrationAsync ProgrammingDynamic RenderingSearch FunctionalityUser Interaction

## What Recruiters Learn

### This project shows:

Working With APIsHandling JSONDOM ManipulationError HandlingDynamic Content Rendering
...
### Study NotesMeeting NotesShopping ListsIdeasRemindersDaily Tasks

### This project combines many important JavaScript concepts:

### DOM ManipulationArraysObjectsLocal StorageCRUD OperationsEvent Handling

### The Notes Application resembles many real-world products:

### Google KeepMicrosoft OneNoteApple NotesEvernote
...
### Create NotesSave NotesEdit NotesDelete NotesPersist Notes After Refresh

## Visual Layout

--------------------------------[ Enter Note Here ][ Save Note ]--------------------------------JavaScript Study Plan[Edit] [Delete]--------------------------------Buy Groceries[Edit] [Delete]--------------------------------

## Project Folder Structure

### notes-app├── index.html├── style.css└── script.js

## Project Planning

### We need:

### Note InputSave ButtonNotes ListEdit ButtonDelete ButtonLocal Storage

## Step 1 — Create HTML Structure

## index.html

<!DOCTYPE html><html><head> <title>Notes App</title> <link rel="stylesheet" href="style.css"></head><body> <h1>Notes App</h1> <textarea id="noteInput" placeholder= "Enter Note"> </textarea> <br> <button onclick="addNote()"> Save Note </button> <div id="notesContainer"> </div> <script src="script.js"> </script></body></html>
...
\`\`\`js
body{ text-align:center; font-family:Arial;}textarea{ width:300px; height:100px;}.note{ border:1px solid gray; margin:10px; padding:10px;}
\`\`\`
...
### [ "Study JavaScript", "Buy Groceries", "Complete Project"]
...
\`\`\`js
[ { text: "Study JavaScript" }, { text: "Buy Groceries" }]
\`\`\`
...
\`\`\`js
function addNote(){ let text = document .getElementById( "noteInput" ).value; let note = { text:text }; notes.push(note);}
\`\`\`
...
### notes└── Study JavaScript

## Step 5 — Display Notes

\`\`\`js
function displayNotes(){ let container = document .getElementById( "notesContainer" ); container.innerHTML = ""; notes.forEach( function(note){ let noteDiv = document .createElement( "div" ); noteDiv.className = "note"; noteDiv.textContent = note.text; container.appendChild( noteDiv ); });}
\`\`\`

## Execution Flow

### Array↓Loop↓Create Note Element↓Display Note

## Update addNote()

\`\`\`js
notes.push(note);displayNotes();
\`\`\`
...
### Study JavaScriptBuy GroceriesComplete Project
...
\`\`\`js
function deleteNote(index){ notes.splice( index, 1 ); displayNotes();}
\`\`\`
...
\`\`\`js
let editButton =document.createElement("button");editButton.textContent ="Edit";
\`\`\`

### Add click event:

\`\`\`js
editButton.onclick =function(){ editNote(index);};
\`\`\`

## Create editNote()

\`\`\`js
function editNote(index){ let updatedText = prompt( "Edit Note", notes[index].text ); if(updatedText){ notes[index].text = updatedText; displayNotes(); }}
\`\`\`
...
### Old Note↓Edit↓New Note↓Update Display

## Step 8 — Save Notes

### Without Local Storage:

### Refresh Page↓Notes Lost
...
\`\`\`js
function loadNotes(){ let savedNotes = localStorage.getItem( "notes" ); if(savedNotes){ notes = JSON.parse( savedNotes ); displayNotes(); }}
\`\`\`

## Update addNote()

\`\`\`js
notes.push(note);saveNotes();displayNotes();
\`\`\`

## Update deleteNote()

\`\`\`js
notes.splice(index,1);saveNotes();displayNotes();
\`\`\`

## Update editNote()

\`\`\`js
notes[index].text =updatedText;saveNotes();displayNotes();
\`\`\`
...
### Create Note↓Save To Storage↓Refresh↓Load Notes↓Display Notes
...
### Data UpdatesUI Does Not Update
...
### CategoriesColorsSearchTagsDark ModePin NotesArchive NotesRich Text Formatting

## Portfolio Tips

### Notes applications are strong portfolio projects because they demonstrate:

### CRUD OperationsState ManagementStorageUI UpdatesUser Interaction

## What Recruiters Learn

### This project shows:

### DOM ManipulationObjectsArraysLocal StorageProblem Solving
...
## Project 9 — Portfolio Website Interactivity
...
### InternshipsJobsFreelance ProjectsRemote Opportunities
...
### SkillsProjectsExperienceContact Information
...
Navigate SectionsOpen Mobile MenuView Project DetailsSwitch ThemesUse Contact FormSmooth Scroll Through Page
...
--------------------------------HomeAboutProjectsContact--------------------------------Hero Section--------------------------------Projects Section--------------------------------Contact Section--------------------------------
...
Navigation MenuSmooth ScrollingTheme SwitcherProject FilteringContact FormScroll Effects
...
\`\`\`js
let target =document.querySelector(this.getAttribute("href"));target.scrollIntoView({ behavior:"smooth"});
\`\`\`

## Visual Diagram

### User Clicks Link↓Find Section↓Smooth Scroll↓Arrive At Section
...
\`\`\`html
<button id="menuButton">☰</button><ul id="menu"></ul>
\`\`\`

## JavaScript

\`\`\`js
let menu =document.getElementById("menu");let button =document.getElementById("menuButton");button.addEventListener("click",function(){menu.classList.toggle("active");});
\`\`\`
...
### Web ProjectsData ProjectsJavaScript Projects
...
\`\`\`html
<buttononclick="filterProjects('web')">Web</button>
\`\`\`

## Project Example

\`\`\`html
<divclass="project web">Website</div>
\`\`\`

## JavaScript

\`\`\`js
function filterProjects(category){let projects =document.querySelectorAll(".project");projects.forEach(function(project){});}
\`\`\`

## Filtering Logic

\`\`\`js
if(project.classList.contains(category)){project.style.display ="block";}
\`\`\`
...
### Click Category↓Check Projects↓Show Matching↓Hide Others
...
\`\`\`html
<form id="contactForm"><input id="name"><input id="email"><textarea id="message"></textarea></form>
\`\`\`

## JavaScript Validation

\`\`\`js
function validateForm(){let name =document.getElementById("name").value;if(name === ""){alert("Enter Name");return false;}}
\`\`\`

## Visual Diagram

### Submit Form↓Validate├── Valid│ Submit└── Invalid Show Error

## Feature 6 — Scroll Animation

### As users scroll:

### Projects AppearSkills Fade InSections Animate
...
### AnimationsProgress BarsSticky NavigationLazy Loading
...
\`\`\`js
document.getElementById("topButton").addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"});});
\`\`\`

## Visual Diagram

### Bottom Of Page↓Click Top↓Smooth Scroll↓Top Of Page
...
### Page Loads↓JavaScript Runs↓Current Year Displayed
...
AnimationsProject ModalsBlog SectionTestimonialsSkill Progress BarsLanguage SwitcherResume DownloadProject Search

## Portfolio Tips

### Your portfolio should include:

Professional PhotoAbout SectionProjectsSkillsContact InformationGitHub ProfileLinkedIn Profile

## What Recruiters Learn

### This project demonstrates:

DOM ManipulationEvent HandlingUI DesignJavaScript InteractivityFrontend Development Skills
...
## Project 10 — Complete Frontend Capstone Project
...
VariablesData TypesFunctionsArraysObjectsDOM ManipulationEventsLocal StorageAPIsAsync JavaScriptProject Development
...
### A Complete ApplicationBuilt Using Multiple ConceptsTo Demonstrate Your Skills

Employers often care more about projects than certificates.

### A strong capstone project shows that you can:

Build Real ApplicationsSolve ProblemsOrganize CodeCreate User InterfacesWork Independently
...
DashboardTo-Do ManagerNotes ManagerExpense TrackerWeather WidgetDark ModeProfile SectionData PersistenceResponsive Design

## Final Application Layout

------------------------------------------------Navigation Bar------------------------------------------------Dashboard Overview------------------------------------------------To-Do Section------------------------------------------------Notes Section------------------------------------------------Expense Tracker------------------------------------------------Weather Widget------------------------------------------------Profile Section------------------------------------------------

## Skills Used

### This project combines:

HTMLCSSJavaScriptDOM ManipulationLocal StorageAPI IntegrationFunctionsArraysObjectsEventsResponsive Design
...
### Overview StatisticsQuick SummaryRecent Activity

### To-Do Manager

### Add TasksDelete TasksComplete TasksSave Tasks

### Notes Manager

### Create NotesEdit NotesDelete NotesSave Notes

### Expense Tracker

### IncomeExpensesBalanceHistory

### Weather Widget

### Current WeatherTemperatureConditions

### Profile Section

### User NameProfile PictureBio

### Dark Mode

### Light ThemeDark ThemeTheme Persistence

## Step 2 — Project Folder Structure

Professional projects should be organized.

capstone-project├── index.html├── css│ └── style.css├── js│ ├── app.js│ ├── todo.js│ ├── notes.js│ ├── expense.js│ ├── weather.js│ └── profile.js├── assets│ ├── images│ └── icons└── README.md

## Why Organize Files?

### Benefits:

### Easy MaintenanceEasy NavigationScalabilityProfessional Structure

## Step 3 — Create HTML Layout

## index.html

<!DOCTYPE html><html><head> <title> Productivity Dashboard </title> <link rel="stylesheet" href="css/style.css"></head><body> <nav> Productivity Dashboard </nav> <section id="dashboard"> </section> <section id="todo"> </section> <section id="notes"> </section> <section id="expenses"> </section> <section id="weather"> </section> <section id="profile"> </section> <script src="js/app.js"> </script></body></html>

## Application Architecture

### User↓Interface↓JavaScript Logic↓Data Storage↓Display Updated Results
...
### Total TasksCompleted TasksTotal NotesCurrent Balance

## Example

### Tasks: 12Completed: 8Notes: 15Balance: ₹25000

## Dashboard Data Flow

### Todo Data↓Dashboard↓Display Statistics

### Expense Data↓Dashboard↓Display Balance
...
\`\`\`js
let tasks = [ { text:"Study JavaScript", completed:false }];
\`\`\`
...
### Task TextCompletion Status

## Features

### Add TaskDelete TaskMark CompleteSave Tasks
...
\`\`\`js
let notes = [ { text:"Complete project" }];
\`\`\`

## Features

### Create NotesEdit NotesDelete NotesStore Notes

## Notes Flow

### User Writes Note↓Save Note↓Display Note↓Store In Local Storage
...
\`\`\`js
let transactions = [ { description:"Salary", amount:50000 }];
\`\`\`

## Features

### Add IncomeAdd ExpenseDelete TransactionCalculate Balance
...
### Salary50000Food-5000Travel-2000Balance43000
...
### City↓API Request↓Weather Server↓Response↓Display Weather

## Example

### CitySrinagarTemperature24°CConditionClear Sky
...
### NameProfile ImageBioContact Information

## Example

### NameKamraanBioFrontend DeveloperLearning JavaScript
...
### Light Theme↓Click Button↓Dark Theme
...
### TasksNotesTransactionsTheme

## Storage Architecture

### Application Data↓JSON.stringify()↓Local Storage↓JSON.parse()↓Application Data
...
### Empty TaskInvalid ExpenseAPI FailureNetwork Problems

## Error Flow

### Problem Occurs↓Catch Error↓Show Friendly Message

## Step 14 — Performance Optimization

### Avoid:

### Repeated DOM UpdatesUnnecessary LoopsLarge Images

### Use:

### Efficient RenderingReusable FunctionsOptimized Assets
...
### Add TaskDelete TaskComplete Task

## Notes Tests

### Create NoteEdit NoteDelete Note

## Expense Tests

### Add IncomeAdd ExpenseCalculate Balance

## Weather Tests

### Valid CityInvalid CityNo Internet

## Dark Mode Tests

### Toggle ThemeRefresh PageTheme Persists
...
### Project NameFeaturesTechnologies UsedInstallation StepsScreenshotsLive Demo Link

## What Recruiters Look For

### A capstone project should demonstrate:

Clean CodeProblem SolvingUI DesignJavaScript SkillsProject OrganizationAttention To Detail

## Portfolio Presentation

### Include:

### Project DescriptionScreenshotsSource CodeLive DemoFeature ListTechnical Details
...
Task SearchExpense CategoriesNotes SearchWeather ForecastProfile EditingNotification System

## Real-World Extensions

### Convert the application into:

Student DashboardEmployee DashboardProject Management ToolBusiness TrackerPersonal CRM

## Interview Discussion Points

### Be prepared to explain:

Project ArchitectureData FlowState ManagementAPI IntegrationStorage StrategyChallenges FacedSolutions Implemented
...
## PART 9 — Career Preparation`,
    },
    {
      slug: "chapter-52-javascript-interview-questions",
      title: "JavaScript Interview Questions",
      summary: "Learning JavaScript is only one part of becoming a developer. The next step is: Getting InterviewsPassing InterviewsLanding Your First Job Most JavaScript interviews test: Core ConceptsProblem SolvingDOM KnowledgeES6 FeaturesAsynchronous…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 51,
      tags: "javascript",
...
Getting InterviewsPassing InterviewsLanding Your First Job

Most JavaScript interviews test:

Core ConceptsProblem SolvingDOM KnowledgeES6 FeaturesAsynchronous JavaScriptProjectsCommunication Skills
...
### HTML → StructureCSS → StylingJavaScript → Functionality
...
\`\`\`js
let person = { name:"Kamraan", age:24};
\`\`\`
...
\`\`\`js
const person = { name:"John", age:25};const { name, age} = person;
\`\`\`
...
### Global ContextFunction Context
...
### Call Stack Empty?↓Yes↓Move Callback To Stack↓Execute Callback
...
\`\`\`js
function largest(arr){ return Math.max(...arr);}
\`\`\`
...
\`\`\`js
function countVowels(str){ let count = 0; let vowels = "aeiouAEIOU"; for(let char of str){ if( vowels.includes(char) ){ count++; } } return count;}
\`\`\`
...
\`\`\`js
function missing(arr){ let n = arr.length + 1; let total = (n*(n+1))/2; let sum = arr.reduce( (a,b)=>a+b, 0 ); return total - sum;}
\`\`\`
...
## Chapter Summary`,
    ...
    {
      slug: "chapter-53-javascript-developer-roadmap",
      title: "JavaScript Developer Roadmap",
      summary: "After learning JavaScript, many beginners ask: What Should I Learn Next?Which Career Path Should I Choose?How Do I Become Job-Ready? JavaScript is one of the most versatile programming languages. With JavaScript, you can become: Frontend DeveloperReact…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 52,
      tags: "javascript",
      ...
      selfAssessment: [],
      content: `# JavaScript Developer Roadmap

## Chapter Introduction

After learning JavaScript, many beginners ask:

What Should I Learn Next?Which Career Path Should I Choose?How Do I Become Job-Ready?

JavaScript is one of the most versatile programming languages.

With JavaScript, you can become:

Frontend DeveloperReact DeveloperBackend DeveloperFull-Stack DeveloperMobile DeveloperDesktop Application Developer
...
### Jump Between TechnologiesWatch Random TutorialsFeel OverwhelmedWaste Time

### A roadmap provides:

### Clear DirectionLearning SequenceCareer FocusSkill Development Plan
...
### User InterfaceUser ExperienceVisual DesignBrowser-Based Applications

Everything users see and interact with belongs to the frontend.

## Frontend Developer Roadmap

HTML↓CSS↓Responsive Design↓JavaScript↓DOM Manipulation↓ES6+↓Git & GitHub↓Projects↓Frontend Framework↓Frontend Developer

## Step 1 — Master HTML

### Learn:

### Semantic HTMLFormsTablesMedia ElementsAccessibility

## Step 2 — Master CSS

### Learn:

### SelectorsBox ModelFlexboxGridAnimationsResponsive Design

## Step 3 — Master JavaScript

### Learn:

### FunctionsArraysObjectsDOMEventsAPIsAsync/Await
...
### RepositoriesCommitsBranchesMergePull Requests
...
CalculatorTo-Do AppWeather AppExpense TrackerPortfolio WebsiteDashboard Application
...
JavaScript↓ES6+↓React Basics↓Components↓Props↓State↓Hooks↓Routing↓API Integration↓Projects↓React Developer

## React Fundamentals

### Learn:

### JSXComponentsPropsStateEvents

## React Hooks

### Important hooks:

### useStateuseEffectuseRefuseMemouseContext
...
### Task ManagerWeather AppMovie AppDashboardE-Commerce StoreBlog Platform
...
### ServersDatabasesBusiness LogicAuthenticationAPIs

Users cannot directly see backend code.

## Backend Roadmap

JavaScript↓Node.js↓Express.js↓REST APIs↓Databases↓Authentication↓Deployment↓Backend Developer
...
### Login SystemsRegistrationPassword HashingJWT AuthenticationAuthorization

## Backend Projects

### Build:

REST APIBlog BackendAuthentication SystemInventory SystemStudent Management System
...
HTML↓CSS↓JavaScript↓React↓Node.js↓Express.js↓Database↓Authentication↓Deployment↓Full-Stack Developer
...
E-Commerce WebsiteLearning Management SystemJob PortalSocial Media PlatformProject Management Tool
...
### You Enjoy UI DesignYou Like Visual WorkYou Prefer Browser Applications

### Choose React if:

You Want Frontend JobsYou Enjoy Component-Based DevelopmentYou Like Modern Web Apps

### Choose Backend if:

### You Enjoy LogicYou Like DatabasesYou Prefer Server Development

### Choose Full-Stack if:

You Want End-To-End SkillsYou Like Building Complete ApplicationsYou Want Startup Flexibility

## Recommended Learning Sequence

### For most beginners:

### HTML↓CSS↓JavaScript↓Git & GitHub↓Projects↓React↓Backend↓Full-Stack Projects

## Job Preparation Milestones

## Milestone 1

### HTMLCSSJavaScript3 Projects

### Apply for:

### InternshipsTrainee Roles

## Milestone 2

### React5+ ProjectsGitHub Portfolio
...
### BackendDatabaseAuthenticationDeployment
...
Learn Fundamentals↓Build Projects↓Create Portfolio↓Apply For Internships↓Get Experience↓Junior Developer↓Mid-Level Developer↓Senior Developer

## Chapter Summary`,
    },
    {
      slug: "chapter-54-becoming-a-professional-developer",
      title: "Becoming a Professional Developer",
      summary: "Learning JavaScript is only the beginning. The real goal is to become a professional developer who can: Build Real ApplicationsSolve ProblemsWork With TeamsEarn IncomeGrow A Career Many beginners believe: Learn JavaScript↓Get Job In reality, the journey looks…",
      difficulty: "intermediate",
      estimatedMinutes: 10,
      order: 53,
      tags: "javascript",
      ...
      selfAssessment: [],
      content: `# Becoming a Professional Developer
...
Build Real ApplicationsSolve ProblemsWork With TeamsEarn IncomeGrow A Career

Many beginners believe:

Learn JavaScript↓Get Job

In reality, the journey looks like:

Learn Skills↓Build Projects↓Create Portfolio↓Prepare Resume↓Apply For Jobs↓Pass Interviews↓Get Hired
...
### Technical SkillsProblem SolvingProject ExperienceCreativityConsistency

## Portfolio Structure

### A professional portfolio should include:

### HomeAboutSkillsProjectsResumeContact

## Home Section

### Include:

### NameRoleShort IntroductionProfessional Photo

### Example:

### KamraanJavaScript DeveloperBuilding Modern Web Applications

## About Section

### Explain:

### Who You AreWhat You LearnWhat You BuildCareer Goals
...
### HTMLCSSJavaScriptReactGitGitHubNode.js
...
Portfolio WebsiteTo-Do ApplicationWeather AppExpense TrackerMovie Search AppCapstone Project

## For Each Project Include

### Project TitleDescriptionTechnologies UsedGitHub LinkLive Demo LinkScreenshots
...
### SkillsProjectsEducationExperienceAchievements

## Resume Structure

HeaderProfessional SummarySkillsProjectsEducationCertificationsContact Information

## Header

### Include:

### Full NameEmailPhone NumberGitHubLinkedIn
...
### FrontendHTMLCSSJavaScriptReact

### ToolsGitGitHubVS Code
...
Expense TrackerBuilt using HTML, CSS, and JavaScript.Implemented CRUD functionality and Local Storage support.

## Resume Mistakes

### Avoid:

### Spelling ErrorsFake SkillsLong ParagraphsPoor Formatting
...
### ProfessionalClearFriendlyHigh Quality
...
### Current LearningSkillsProjectsCareer Goals

## Featured Section

### Add:

### PortfolioGitHubProjectsCertificates

## Skills Section

### Add skills such as:

### JavaScriptHTMLCSSReactGitGitHub

## Posting Content

### Share:

### ProjectsLearning JourneyTechnical ArticlesAchievements
...
### Flexible ScheduleRemote WorkMultiple ClientsIncome Potential
...
### Portfolio WebsitesLanding PagesBug FixesWebsite MaintenanceFrontend Development

## Getting First Clients

Create PortfolioCreate Freelance ProfilesBuild SamplesSend ProposalsCollect Reviews

## Freelancing Mistakes

### Avoid:

### OverpromisingUnderpricingMissing DeadlinesPoor Communication
...
### Work From HomeGlobal OpportunitiesFlexible Lifestyle
...
### CommunicationTechnical SkillsSelf DisciplineTime Management
...
### Real ExperienceNetworkingLearningPortfolio Growth
...
### DocumentationBug FixesUI ImprovementsTestingSmall Features

## Contribution Process

### Find Project↓Fork Repository↓Make Changes↓Commit Changes↓Create Pull Request
...
### Learn↓Practice↓Build↓Teach↓Repeat

## The 70-20-10 Rule

### Learn through:

### 70% Building Projects20% Reading & Courses10% Community Learning

## Monthly Growth Plan

### Every month:

Build One ProjectLearn One New ConceptImprove PortfolioUpdate ResumePractice Interviews

## Staying Updated

### Follow:

### Official DocumentationDeveloper BlogsTechnical CommunitiesIndustry News

## Professional Developer Mindset

### Focus on:

### ConsistencyProblem SolvingLearningCommunicationProfessionalism
...
Learn HTML↓Learn CSS↓Learn JavaScript↓Build Projects↓Create Portfolio↓Learn React↓Improve Resume↓Optimize LinkedIn↓Apply For Jobs↓Pass Interviews↓Become A Professional Developer
...
const pathSteps: { part: string; title: string; subtitle: string; order: number; tutorialSlug: string }[] = [
  { part: "Part 1 — Chapters 1–12", title: "What Is Programming?", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 0, tutorialSlug: "chapter-1-what-is-programming" },
  { part: "Part 1 — Chapters 1–12", title: "Introduction to JavaScript", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 1, tutorialSlug: "chapter-2-introduction-to-javascript" },
  { part: "Part 1 — Chapters 1–12", title: "Setting Up the Development Environment", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 2, tutorialSlug: "chapter-3-setting-up-the-development-environment" },
  { part: "Part 1 — Chapters 1–12", title: "Variables", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 3, tutorialSlug: "chapter-4-variables" },
  { part: "Part 1 — Chapters 1–12", title: "Data Types", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 4, tutorialSlug: "chapter-5-data-types" },
  { part: "Part 1 — Chapters 1–12", title: "Operators", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 5, tutorialSlug: "chapter-6-operators" },
  { part: "Part 1 — Chapters 1–12", title: "User Input and Output", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 6, tutorialSlug: "chapter-7-user-input-and-output" },
  { part: "Part 1 — Chapters 1–12", title: "Conditional Statements", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 7, tutorialSlug: "chapter-8-conditional-statements" },
  { part: "Part 1 — Chapters 1–12", title: "Scope", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 8, tutorialSlug: "chapter-9-scope" },
  { part: "Part 1 — Chapters 1–12", title: "Arrays", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 9, tutorialSlug: "chapter-10-arrays" },
  { part: "Part 1 — Chapters 1–12", title: "Objects", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 10, tutorialSlug: "chapter-11-objects" },
  { part: "Part 1 — Chapters 1–12", title: "Template Literals", subtitle: "Part of Part 1 — Chapters 1–12 · Intermediate", order: 11, tutorialSlug: "chapter-12-template-literals" },
  { part: "Part 2 — Chapters 13–24", title: "Destructuring", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 12, tutorialSlug: "chapter-13-destructuring" },
  { part: "Part 2 — Chapters 13–24", title: "Spread Operator", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 13, tutorialSlug: "chapter-14-spread-operator" },
  { part: "Part 2 — Chapters 13–24", title: "Rest Parameters", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 14, tutorialSlug: "chapter-15-rest-parameters" },
  { part: "Part 2 — Chapters 13–24", title: "Arrow Functions", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 15, tutorialSlug: "chapter-16-arrow-functions" },
  { part: "Part 2 — Chapters 13–24", title: "Default Parameters", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 16, tutorialSlug: "chapter-17-default-parameters" },
  { part: "Part 2 — Chapters 13–24", title: "Modules", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 17, tutorialSlug: "chapter-18-modules" },
  { part: "Part 2 — Chapters 13–24", title: "Classes and OOP", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 18, tutorialSlug: "chapter-19-classes-and-oop" },
  { part: "Part 2 — Chapters 13–24", title: "Understanding the DOM", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 19, tutorialSlug: "chapter-20-understanding-the-dom" },
  { part: "Part 2 — Chapters 13–24", title: "Selecting Elements", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 20, tutorialSlug: "chapter-21-selecting-elements" },
  { part: "Part 2 — Chapters 13–24", title: "Changing Content", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 21, tutorialSlug: "chapter-22-changing-content" },
  { part: "Part 2 — Chapters 13–24", title: "Modifying Styles", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 22, tutorialSlug: "chapter-23-modifying-styles" },
  { part: "Part 2 — Chapters 13–24", title: "Creating Elements", subtitle: "Part of Part 2 — Chapters 13–24 · Intermediate", order: 23, tutorialSlug: "chapter-24-creating-elements" },
  { part: "Part 3 — Chapters 25–36", title: "Removing Elements", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 24, tutorialSlug: "chapter-25-removing-elements" },
  { part: "Part 3 — Chapters 25–36", title: "Event Handling", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 25, tutorialSlug: "chapter-26-event-handling" },
  { part: "Part 3 — Chapters 25–36", title: "Forms and Validation", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 26, tutorialSlug: "chapter-27-forms-and-validation" },
  { part: "Part 3 — Chapters 25–36", title: "Execution Context", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 27, tutorialSlug: "chapter-28-execution-context" },
  { part: "Part 3 — Chapters 25–36", title: "Call Stack", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 28, tutorialSlug: "chapter-29-call-stack" },
  { part: "Part 3 — Chapters 25–36", title: "Hoisting", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 29, tutorialSlug: "chapter-30-hoisting" },
  { part: "Part 3 — Chapters 25–36", title: "Closures", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 30, tutorialSlug: "chapter-31-closures" },
  { part: "Part 3 — Chapters 25–36", title: "Higher Order Functions", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 31, tutorialSlug: "chapter-32-higher-order-functions" },
  { part: "Part 3 — Chapters 25–36", title: "Callbacks", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 32, tutorialSlug: "chapter-33-callbacks" },
  { part: "Part 3 — Chapters 25–36", title: "Promises", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 33, tutorialSlug: "chapter-34-promises" },
  { part: "Part 3 — Chapters 25–36", title: "Async/Await", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 34, tutorialSlug: "chapter-35-async-await" },
  { part: "Part 3 — Chapters 25–36", title: "Error Handling", subtitle: "Part of Part 3 — Chapters 25–36 · Intermediate", order: 35, tutorialSlug: "chapter-36-error-handling" },
  { part: "Part 4 — Chapters 37–48", title: "Debugging Techniques", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 36, tutorialSlug: "chapter-37-debugging-techniques" },
  { part: "Part 4 — Chapters 37–48", title: "JSON", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 37, tutorialSlug: "chapter-38-json" },
  { part: "Part 4 — Chapters 37–48", title: "HTTP Basics", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 38, tutorialSlug: "chapter-39-http-basics" },
  { part: "Part 4 — Chapters 37–48", title: "Fetch API", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 39, tutorialSlug: "chapter-40-fetch-api" },
  { part: "Part 4 — Chapters 37–48", title: "REST APIs", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 40, tutorialSlug: "chapter-41-rest-apis" },
  { part: "Part 4 — Chapters 37–48", title: "Working with Public APIs", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 41, tutorialSlug: "chapter-42-working-with-public-apis" },
  { part: "Part 4 — Chapters 37–48", title: "Local Storage", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 42, tutorialSlug: "chapter-43-local-storage" },
  { part: "Part 4 — Chapters 37–48", title: "Session Storage", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 43, tutorialSlug: "chapter-44-session-storage" },
  { part: "Part 4 — Chapters 37–48", title: "Browser APIs", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 44, tutorialSlug: "chapter-45-browser-apis" },
  { part: "Part 4 — Chapters 37–48", title: "Code Organization", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 45, tutorialSlug: "chapter-46-code-organization" },
  { part: "Part 4 — Chapters 37–48", title: "ESLint", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 46, tutorialSlug: "chapter-47-eslint" },
  { part: "Part 4 — Chapters 37–48", title: "Git and GitHub", subtitle: "Part of Part 4 — Chapters 37–48 · Intermediate", order: 47, tutorialSlug: "chapter-48-git-and-github" },
  { part: "Part 5 — Chapters 49–54", title: "Project Structure", subtitle: "Part of Part 5 — Chapters 49–54 · Intermediate", order: 48, tutorialSlug: "chapter-49-project-structure" },
  { part: "Part 5 — Chapters 49–54", title: "Performance Basics", subtitle: "Part of Part 5 — Chapters 49–54 · Intermediate", order: 49, tutorialSlug: "chapter-50-performance-basics" },
  { part: "Part 5 — Chapters 49–54", title: "Security Basics", subtitle: "Part of Part 5 — Chapters 49–54 · Intermediate", order: 50, tutorialSlug: "chapter-51-security-basics" },
  { part: "Part 5 — Chapters 49–54", title: "JavaScript Interview Questions", subtitle: "Part of Part 5 — Chapters 49–54 · Intermediate", order: 51, tutorialSlug: "chapter-52-javascript-interview-questions" },
  { part: "Part 5 — Chapters 49–54", title: "JavaScript Developer Roadmap", subtitle: "Part of Part 5 — Chapters 49–54 · Intermediate", order: 52, tutorialSlug: "chapter-53-javascript-developer-roadmap" },
  { part: "Part 5 — Chapters 49–54", title: "Becoming a Professional Developer", subtitle: "Part of Part 5 — Chapters 49–54 · Intermediate", order: 53, tutorialSlug: "chapter-54-becoming-a-professional-developer" },
]
...
async function main() {
  ...
  const path = await db.learningPath.upsert({
    where: { slug: "javascript-mastery-path" },
    create: { slug: "javascript-mastery-path", title: "JavaScript Roadmap", tagline: "The complete roadmap for JavaScript - all parts in order.", description: "The complete roadmap for JavaScript - all parts in order.", icon: "Globe", color: "oklch(0.68 0.17 240)", difficulty: 'intermediate', estimatedHours: 10, published: true },
    update: { title: "JavaScript Roadmap", tagline: "The complete roadmap for JavaScript - all parts in order.", description: "The complete roadmap for JavaScript - all parts in order.", icon: "Globe", color: "oklch(0.68 0.17 240)", difficulty: 'intermediate', estimatedHours: 10 },
  })
