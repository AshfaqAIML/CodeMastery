...
// ============================================================
// COMPUTER SCIENCE FOUNDATIONS - imported from the full book
// (Course Guide + Parts 1-29). Idempotent via upsert.
// ============================================================
...
const subject = {
  ...
  modules: [
      ...
      tutorials: [
    {
      ...
      learningObjectives: ['Explain what Computer Science is and how it differs from', 'Describe how a computer works: input → processing → output.', 'Convert numbers between binary, decimal, octal, and', 'Explain bits, bytes, and how text, images, audio, and', 'Describe the CPU, memory hierarchy, storage, and the', 'Explain the boot process from power button to login.', 'Explain the difference between system software, application', 'Explain how source code becomes a running program, including', 'Define algorithms and data structures and explain Big O', 'Explain what an operating system does and how files,', 'Explain networking basics: IP addresses, DNS, packets,', 'Explain what databases are and why SQL and NoSQL exist.', 'Explain security fundamentals: authentication, authorization,', 'Explain software engineering practices: version control,', 'Explain APIs, cloud computing, virtualization, containers,', 'Explain the relationships: AI → ML → Deep Learning →', 'Connect every foundation topic to the advanced subjects'],
      prerequisites: [{ label: 'Basic reading and arithmetic' }, { label: '(addition, subtraction, multiplication, division)' }, { label: 'Tags: computer-science, foundations, beginner,' }, { label: 'hardware, software, algorithms, networking,' }, { label: 'databases, ai, ml, llm, engineering-basics' }],
...
1. Part 35 — How Everything Connects: the complete knowledge map · hardware → OS → programming → algorithms → software engineering → backend → system design → cloud → AI → LLMs → RAG → agents · final checklist · interview preparation · mini-projects`,
    },
    {
      ...
      prerequisites: [{ label: 'Basic reading and arithmetic' }, { label: '(addition, subtraction, multiplication, division)' }, { label: 'Tags: computer-science, foundations, beginner,' }, { label: 'hardware, software, algorithms, networking,' }, { label: 'databases, ai, ml, llm, engineering-basics' }],
      whereItFits: '- Every later part of this course — the input → process → output model reappears in CPU, OS, and networking parts. - C and C++ — understanding hardware/software separation explains why these languages behave the way they do. - Algorithms and DSA — the concept of an algorithm introduced here is the core of that entire subject. - AI and LLMs — knowing what computers can and cannot do keeps your ment',
...
- The areas of CS stack on each other: theory → algorithms → programming → systems → applications.`,
      ...
      tutorials: [
    {
      ...
      whereItFits: '- Parts 7–8 (hardware and CPU) — transistors and integrated circuits are exactly what the CPU is made of. - Computer architecture courses — the stored-program (von Neumann) concept is the foundation of that subject. - Networking and cloud (Parts 22, 29) — understanding why connection and on-demand resources changed the industry. - AI, ML, LLMs, and agents (Parts 33–34) — knowing how AI emerged fro',
...
- Machine learning let software learn from data; LLMs and generative AI made language the new interface to computing.`,
    },
    {
      ...
      whereItFits: '- System Design & Backend Engineering: When designing large applications, engineers draw boxes representing "microservices." Every single box is just an Input → Process → Output model. - Hardware & Computer Architecture (Parts 7-11): Understanding the difference between Memory (temporary) and Storage (permanent) is the most critical concept in understanding how physical computer parts are designed',
...
- A program is simply a long sequence of basic instructions that tell the processor how to transform data into information.`,
    },
    {
      ...
      whereItFits: '- Part 5 and Part 6 — number systems and bit-level representation build directly on "everything is numbers." - Databases (Part 24) — relational databases are systems for structured data. - Files and file systems (Part 21) — metadata is how your computer tracks files. - Data Science and ML (Parts 33–34) — model quality depends entirely on data quality: cleaning, structure, and relevance. - Backend ',
...
- Everything inside a computer is stored as numbers, because transistors are two-state switches and numbers can encode anything.`,
    },
    {
      ...
      whereItFits: '- Part 6 — Data Representation — text, images, and audio are encoded using exactly these binary patterns. - Parts 8–9 — CPU and Memory — memory addresses are written in hexadecimal. - Networking (Part 22) — IP addresses and subnet masks are binary underneath. - Web development — colors are hex codes. - C and C++ — bitwise operations work directly on binary. - Interviews — base conversion is a clas',
...
- Hex and octal are human-friendly shorthand for the same binary values.`,
    },
    {
      ...
      whereItFits: '- C and C++ — data types like int, char, and float are exactly these encodings; overflow and precision bugs are classic C pitfalls. - Parts 8–9 — CPU and Memory — word size, registers, and memory addresses build on bits and bytes. - Databases (Part 24) — every column type (integer, decimal, text) maps to one of these encodings. - Networking (Part 22) — data moves over networks as bytes; speeds are',
...
- Bits have no inherent meaning — context decides what a pattern represents.`,
      ...
      tutorials: [
    {
      ...
      whereItFits: '- Parts 8–11 — each of these components gets a dedicated deep dive. - C and C++ — understanding memory and the CPU explains pointers, performance, and low-level behavior. - Operating Systems (Part 20) — the OS exists to manage exactly this hardware. - Cloud computing (Part 29) — "renting compute" means renting CPUs, RAM, and storage like these, in someone else\'s data center. - Deep Learning (Part ',
...
- The NIC connects the machine to networks; peripherals handle input and output; cooling keeps heat under control.`,
    },
    {
      ...
      whereItFits: '- Part 9 — Memory — the cache discussion grows into the full memory hierarchy. - Part 20 — Operating Systems — the OS decides which threads run on which cores. - Part 31 — Concurrency — cores and threads are the physical basis of parallel execution. - C and C++ — performance work is largely about cache behavior and instruction efficiency. - Interviews — "explain the fetch-decode-execute cycle" and',
...
- Every program runs as repeated fetch-decode-execute cycles, guided by the program counter.`,
    },
    {
      ...
      whereItFits: '- C and C++ — Understanding the Stack vs. Heap is the absolute prerequisite for understanding pointers and manual memory management. - Java, Python, C# — These languages use "Garbage Collection" to automatically clean up the Heap. You need to know what the Heap is to understand what the Garbage Collector does. - Operating Systems (Part 20) — The OS is essentially the manager of the Memory Hierarch',
...
- Heavy reliance on Virtual Memory causes "thrashing," which severely degrades performance.`,
    },
    {
      ...
      whereItFits: '- Databases (Part 24): Database engines spend massive amounts of engineering effort optimizing how they write to blocks to avoid the random-access penalty of HDDs. - Operating Systems (Part 20): The OS is the creator and manager of the File System. - Cybersecurity (Part 25): Understanding that "deleting" a file only deletes the file system map (not the blocks) is the foundation of digital forensic',
...
- Deleting a file usually just removes it from the File System map; the physical data remains until overwritten.`,
    },
    {
      ...
      whereItFits: '- Part 12 — Boot Process — BIOS/UEFI takes center stage. - Part 20 — Operating Systems — interrupts, DMA, and device drivers are core OS responsibilities. - Part 22 — Networking — network cards connect via PCIe and raise interrupts exactly like the SSD example above. - Cloud computing (Part 29) — virtual machines are given "virtual" devices; understanding the real ones makes that abstraction meani',
...
- Interrupts let devices demand attention; DMA lets devices move data without burdening the CPU.`,
    },
    {
      ...
      whereItFits: '- Operating Systems (Part 20): The Kernel\'s job (memory management, scheduling, drivers) is the entire focus of OS theory. - System Administration / IT: Fixing a computer that "won\'t boot" requires knowing exactly which step of this chain is failing (e.g., beep codes mean POST failed; a blinking cursor means the bootloader failed). - Cybersecurity (Part 25): "Bootkits" are advanced malware that in',
...
- The Kernel launches User Space services, resulting in the graphical login screen.`,
      ...
      tutorials: [
    {
      ...
      whereItFits: '- Part 14 (Programming) & Beyond: Understanding Libraries and Frameworks is mandatory before you start learning languages like Python, Java, or JavaScript. - Part 20 (Operating Systems): The OS layer of the stack is dissected completely. - Part 28 (APIs): APIs (Application Programming Interfaces) are the formal contracts that allow different layers of the software stack to talk to each other. - IT',
...
- The Software Stack enforces a strict hierarchy: Applications rely on Libraries, which rely on the OS, which relies on Drivers, which control the Hardware.`,
    },
    {
      ...
      whereItFits: '- Part 15 — how source code becomes machine code: compilers, interpreters, and runtimes. - C, C++, Python, Java courses — everything here reappears with real syntax. - DSA (algorithms and data structures) — loops, conditions, and functions are the tools every algorithm is built from. - Part 17 — Computational Thinking — decomposition, the thinking behind functions. - Every engineering role — readi',
...
- Errors come in three kinds: syntax, runtime, and logic.`,
    },
    {
      ...
      whereItFits: '- C and C++ courses — compilation, linking, and manual memory management are daily reality there. - Java and Python courses — JVM tuning and Python\'s runtime behavior affect real performance work. - Operating Systems (Part 20) — the loader, executable formats, and process creation live here. - Cloud and containers (Parts 29–30) — "works on my machine" problems are runtime-environment problems. - I',
...
- Runtime systems support programs during execution and, in Java/Python/JavaScript, manage memory through garbage collection.`,
      ...
      tutorials: [
    {
      ...
      whereItFits: '- Part 17 — Computational Thinking — the mindset behind algorithm design. - Part 18 — Complexity — Big O formalizes the step-counting you just practiced. - Part 19 — Data Structures — structures and algorithms are partners; trees and hash tables exist to make searching faster. - DSA in C++ — the dedicated course that builds directly on this part. - Databases (Part 24) — indexes are search structur',
...
- Optimization trades resources — most famously, space for time.`,
    },
    {
      ...
      whereItFits: '- Part 18 — Complexity — reasoning about how step counts grow is logical reasoning applied to algorithms. - Part 19 — Data Structures — choosing a structure is choosing an abstraction for your data. - Object-oriented programming — objects, interfaces, and encapsulation are abstraction and decomposition formalized. - System design (Parts 28, 32) — designing large systems is decomposition at the big',
...
- The workflow — define, decompose, pattern, abstract, design, test, refine — applies to code and to life.`,
    },
    {
      ...
      whereItFits: '- Part 19 — Data Structures — every structure is advertised by its operation complexities. - DSA in C++ — complexity analysis is the daily language of that entire subject. - Databases (Part 24) — index design is applied O(log n). - System design (Part 32 onward) — capacity planning asks "what happens when n grows 100×?" — exactly the Big O question. - Interviews — state the complexity of every sol',
...
- Time and space trade against each other; engineers choose based on what is scarce.`,
    },
    {
      ...
      whereItFits: "- DSA in C++ — this part's map becomes the territory: implementations, balancing, graph algorithms. - Databases (Part 24) — indexes are trees (B-trees) and hashes in disguise. - Operating Systems (Part 20) — queues schedule processes; trees organize file systems. - Networking and the Web — routing is graph traversal; DNS is a giant tree. - Distributed systems (Part 32) — message queues and caches ",
...
- Structure choice begins with the question "which operations dominate?"`,
      ...
      tutorials: [
    {
      ...
      whereItFits: '- Dedicated Operating Systems subject — this part is the foundation it builds on. - C and C++ — system calls, processes, and memory behavior are daily reality in systems programming. - Part 31 — Concurrency — threads, scheduling, and shared memory become the whole topic. - Part 32 — Distributed Systems — servers are OS concepts multiplied across machines. - Cloud and containers (Parts 29–30) — vir',
...
- User accounts and permissions control who may read, write, and execute — with administrator power used sparingly.`,
    },
    {
      ...
      whereItFits: '- Backend Engineering & Cloud (Parts 28-30): Servers run Linux (ext4). Understanding absolute paths and read/write permissions is mandatory to deploy web applications and configure servers. - Git and Version Control (Part 26): Git tracks changes to files. Understanding working directories and relative paths is how you navigate code repositories. - Cybersecurity (Part 25): Many malware attacks rely',
...
- Different file systems (NTFS, ext4, exFAT) are optimized for different operating systems and use cases.`,
    },
    {
      ...
      whereItFits: '- Part 23 — Internet Fundamentals — the Web layer on top of everything here: HTTP, HTTPS, URLs, TCP/IP. - Dedicated Networking subject — this part is its foundation; that course goes far deeper into every protocol. - Backend engineering (Parts 26–28) — building servers, choosing ports, configuring DNS records, and debugging requests are daily work. - Cloud computing (Part 29) — cloud platforms are',
...
- Clients request; servers respond. Every web visit is DNS lookup, connection, request, response, and rendering.`,
    },
    {
      ...
      whereItFits: '- Frontend development — HTML, CSS, and JavaScript become the full craft, starting from the roles defined here. - APIs (Part 28) — APIs are HTTP conversations in machine-to-machine form: the same methods, status codes, and headers. - Backend engineering — building web servers, handling requests, and returning correct status codes is the core of the job. - Security (Part 25) — HTTPS, certificates, ',
...
- Every page load is a multi-layer journey and usually dozens of requests, smoothed by caching.`,
      ...
      tutorials: [
    {
      ...
      whereItFits: '- Dedicated Databases / SQL Subject: This part is the foundation. That course will cover complex JOINs, indexing (how databases achieve O(log n) search speeds), and database normalization. - Backend Engineering (Parts 26-28): Designing schemas, writing queries, and using ORMs are the daily bread of backend developers. - System Design (Part 32): Choosing between SQL and NoSQL, designing database re',
...
- Backend applications connect to databases over network ports, often using ORMs to translate code into safe SQL.`,
    },
    {
      ...
      whereItFits: '- Dedicated Cybersecurity Subject: This part is the foundation. That course dives deep into penetration testing, cryptography math, and network forensics. - Backend Engineering (Parts 26-28): Implementing JWTs (JSON Web Tokens), OAuth, and secure session management are daily tasks. - Cloud Computing (Part 29): Configuring AWS/Azure Identity and Access Management (IAM) relies entirely on the Princi',
...
- Defense in Depth layers multiple security controls so no single failure leads to a total breach.`,
    },
    {
      ...
      whereItFits: "- Every programming course that follows — C, C++, Python, and Java projects all use Git, testing, and review exactly as described here. - Part 27 — Abstraction and Architecture — the design phase of the SDLC becomes the whole topic. - Part 28 — APIs — API documentation and versioning apply this part's principles directly. - Cloud and DevOps (Parts 29–30) — CI/CD pipelines run in the cloud; contain",
...
- Semantic versioning (MAJOR.MINOR.PATCH) communicates the risk of upgrading at a glance; rollbacks make releases safe.`,
    },
    {
      ...
      whereItFits: '- Object-oriented programming — objects are encapsulated units; classes and interfaces are these ideas in code. - Backend engineering (Part 28) — APIs are interfaces; backend frameworks enforce separation of concerns. - Frontend development — modern UI frameworks are component systems from top to bottom. - System design and distributed systems (Part 32) — services, boundaries, and trade-offs at pl',
...
- Architecture is the set of expensive-to-change structural decisions, and it is always about trade-offs.`,
    },
    {
      ...
      whereItFits: "- Dedicated API / FastAPI course — this part's concepts become hands-on construction: building real endpoints, validation, and docs. - Backend engineering — designing, securing, and scaling APIs is the core of the job. - Full-stack development — the frontend/backend boundary is always an API. - System design (Part 32) — services communicate through APIs; contracts define system boundaries. - AI en",
...
- The software world is a composition of APIs — including the LLM APIs that power modern AI.`,
    ...
    },
    {
      ...
      summary: 'Cloud computing and the modern computing landscape. (Parts 30-32 of this unit are not yet published.)',
      order: 8,
      difficulty: "beginner",
      estimatedMinutes: 30,
      tutorials: [
    {
      ...
      whereItFits: '- Part 30 — Virtualization and Containers — VMs, Docker, and images in depth. - Part 32 — Distributed Systems — load balancers, replication, scaling, and availability are these building blocks at scale. - Backend engineering — deploying and operating services on cloud platforms is daily work. - Data engineering and ML — training clusters, object storage for datasets, and managed ML services all li',
...
async function main() {
  ...
  console.log("🎉 CSF seed complete:", counts)
}

main()
  .catch((e) => {
    console.error("CSF seed failed:", e)
    process.exit(1)
  })
  .finally(async () => {
    await db.$disconnect()
